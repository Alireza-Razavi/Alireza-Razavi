...
Total <b>21</b> instances over <b>15</b> issues:
...
| [NC-4](#NC-4) | Custom errors should be used rather than `revert()`/`require()` | 1 |
...
| [NC-8](#NC-8) | NatSpec documentation for contract is missing | 2 |
| [NC-9](#NC-9) | NatSpec documentation for function is missing | 1 |
| [NC-10](#NC-10) | Missing NatSpec `@param` | 1 |
| [NC-11](#NC-11) | NatSpec `@return` is missing | 1 |
| [NC-12](#NC-12) | Redundant inheritance specifier | 1 |
| [NC-13](#NC-13) | Contract declarations should have NatSpec `@title` annotations | 2 |
| [NC-14](#NC-14) | Solidity compiler version is not fixed | 2 |
| [NC-15](#NC-15) | Use the latest solidity version for deployment | 2 |

## Gas Optimizations


Total <b>14</b> instances over <b>8</b> issues:
...
| [GAS-3](#GAS-3) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 1 | 3 |
| [GAS-4](#GAS-4) | Reduce gas usage by moving to Solidity 0.8.19 or later | 2 | 2000 |
| [GAS-5](#GAS-5) | Use a more recent version of solidity | 2 | - |
| [GAS-6](#GAS-6) | Use a more recent version of solidity | 1 | - |
| [GAS-7](#GAS-7) | Use Custom Errors | 1 | 50 |
| [GAS-8](#GAS-8) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 4 | 220 |
...
18: 		require(a > b, "Errorrrrrrrrrrrrrr");
...
17: 	function ttT(uint8 a, uint8 b) external returns(uint8){
...
<a name="NC-11"></a> 
### [NC-11] NatSpec `@return` is missing
...
<a name="NC-14"></a> 
### [NC-14] Solidity compiler version is not fixed
...
<a name="NC-15"></a> 
### [NC-15] Use the latest solidity version for deployment
...
<a name="GAS-3"></a> 
### [GAS-3] Operator `>=`/`<=` costs less gas than operator `>`/`<`
...
<a name="GAS-4"></a> 
### [GAS-4] Reduce gas usage by moving to Solidity 0.8.19 or later
...
<a name="GAS-5"></a> 
### [GAS-5] Use a more recent version of solidity
...
<a name="GAS-8"></a> 
### [GAS-8] Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead
