...
*Total <b>204</b> instances over <b>31</b> issues:*
...
| [GAS-17](#GAS-17) | Use local variables for emitting | 3 | 291 |
| [GAS-18](#GAS-18) | Use a more recent version of solidity | 16 | - |
| [GAS-19](#GAS-19) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 1 | 8550 |
| [GAS-20](#GAS-20) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-21](#GAS-21) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-22](#GAS-22) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 14 | - |
| [GAS-23](#GAS-23) | Use Custom Errors | 4 | 200 |
| [GAS-24](#GAS-24) | Don't initialize variables with default value | 2 | - |
| [GAS-25](#GAS-25) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 17 | 935 |
| [GAS-26](#GAS-26) | Constructors can be marked as `payable` to save deployment gas | 13 | 273 |
| [GAS-27](#GAS-27) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-28](#GAS-28) | Using `private` rather than `public` for constants, saves gas | 4 | - |
| [GAS-29](#GAS-29) | Splitting require() statements that use && saves gas | 1 | - |
| [GAS-30](#GAS-30) | Using assembly to check for zero can save gas | 24 | 144 |
| [GAS-31](#GAS-31) | `internal` functions not called by the contract should be removed | 10 | - |
...
<a name="GAS-19"></a> 
### [GAS-19] Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes
...
<a name="GAS-29"></a> 
### [GAS-29] Splitting require() statements that use && saves gas
