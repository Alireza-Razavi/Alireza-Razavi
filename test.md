...
Total <b>385</b> instances over <b>44</b> issues:
...
| [NC-5](#NC-5) | Contract uses both `require()`/`revert()` as well as custom errors | 3 |
| [NC-6](#NC-6) | Contracts should have full test coverage | 1 |
| [NC-7](#NC-7) | Events that mark critical parameter changes should contain both the old and the new value | 16 |
| [NC-8](#NC-8) | Custom errors has no error details | 15 |
| [NC-9](#NC-9) | Custom errors should be used rather than `revert()`/`require()` | 21 |
| [NC-10](#NC-10) | `else` block not required | 3 |
| [NC-11](#NC-11) | Enable IR-based code generation | 1 |
| [NC-12](#NC-12) | Names of structs, events, enums and errors should use CapWords style | 1 |
| [NC-13](#NC-13) | Events are emitted without the sender information | 14 |
| [NC-14](#NC-14) | Import declarations should import specific identifiers, rather than the whole file | 32 |
| [NC-15](#NC-15) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-16](#NC-16) | Magic numbers should be replaced with constants | 14 |
| [NC-17](#NC-17) | Missing zero address check in functions with address parameters | 23 |
| [NC-18](#NC-18) | Consider moving `msg.sender` checks to `modifier`s | 3 |
| [NC-19](#NC-19) | Named mappings are recommended | 9 |
| [NC-20](#NC-20) | NatSpec documentation for contract is missing | 3 |
| [NC-21](#NC-21) | NatSpec documentation for function is missing | 11 |
| [NC-22](#NC-22) | Modifier declarations should have NatSpec descriptions | 1 |
| [NC-23](#NC-23) | Missing NatSpec `@param` | 28 |
| [NC-24](#NC-24) | Public variable declarations should have NatSpec descriptions | 19 |
| [NC-25](#NC-25) | NatSpec `@return` is missing | 15 |
| [NC-26](#NC-26) | There is no need to initialize variables with 0 | 8 |
| [NC-27](#NC-27) | State variables should include comments | 11 |
| [NC-28](#NC-28) | Contract declarations should have NatSpec `@title` annotations | 3 |
| [NC-29](#NC-29) | Unused errors | 2 |
| [NC-30](#NC-30) | Unused named return | 3 |
| [NC-31](#NC-31) | Unused contract variables | 1 |
| [NC-32](#NC-32) | Consider using `delete` rather than assigning zero to clear values | 8 |
| [NC-33](#NC-33) | Expressions for constant values should use `immutable` rather than `constant` | 13 |
| [NC-34](#NC-34) | Use the latest solidity version for deployment | 6 |
| [NC-35](#NC-35) | Use of `override` is unnecessary | 6 |
| [NC-36](#NC-36) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-37](#NC-37) | Common functions should be refactored to a common base contract | 8 |
| [NC-38](#NC-38) | Names of `private`/`internal` functions should be prefixed with an underscore | 2 |
| [NC-39](#NC-39) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-40](#NC-40) |  `require()` / `revert()` statements should have descriptive reason strings | 1 |
| [NC-41](#NC-41) | Return values of `approve()` not checked | 6 |
| [NC-42](#NC-42) | Variables should be named in mixedCase style | 19 |
| [NC-43](#NC-43) | Event is missing `indexed` fields | 13 |
| [NC-44](#NC-44) | Functions not used internally could be marked external | 14 |
...
<a name="NC-12"></a> 
### [NC-12] Names of structs, events, enums and errors should use CapWords style
...
<a name="NC-35"></a> 
### [NC-35] Use of `override` is unnecessary
...
<a name="NC-37"></a> 
### [NC-37] Common functions should be refactored to a common base contract
...
<a name="NC-40"></a> 
### [NC-40]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-41"></a> 
### [NC-41] Return values of `approve()` not checked
...
<a name="NC-44"></a> 
### [NC-44] Functions not used internally could be marked external
