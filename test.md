...
*Total <b>65</b> instances over <b>22</b> issues:*
...
| [L-12](#L-12) | Potential Re-org Attack Vector | 1 |
| [L-13](#L-13) | Prevent re-setting a state variable with the same value | 3 |
| [L-14](#L-14) | `receive()`/`fallback()` function does not authorize requests | 1 |
| [L-15](#L-15) | Some tokens may revert when large transfers are made | 1 |
| [L-16](#L-16) | Some tokens may revert when zero value transfers are made | 1 |
| [L-17](#L-17) | Timestamp may be manipulation | 6 |
| [L-18](#L-18) | Tokens may be minted to `address(0)` | 1 |
| [L-19](#L-19) | Unsafe solidity low-level call can cause gas grief attack | 2 |
| [L-20](#L-20) | Unsafe use of ERC20 `transfer()`/`transferFrom()`/`approve()` | 1 |
| [L-21](#L-21) | Using zero as a parameter | 2 |
| [L-22](#L-22) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 1 |

## Non Critical Issues


*Total <b>420</b> instances over <b>53</b> issues:*
...
| [NC-4](#NC-4) | Avoid the use of sensitive terms | 16 |
...
| [NC-9](#NC-9) | Consider using `AccessControlDefaultAdminRules` rather than `AccessControl` | 1 |
...
| [NC-13](#NC-13) | Contract should expose an `interface` | 47 |
| [NC-14](#NC-14) | Contracts should have full test coverage | 1 |
| [NC-15](#NC-15) | Events that mark critical parameter changes should contain both the old and the new value | 17 |
| [NC-16](#NC-16) | Duplicated `require()`/`revert()` checks should be refactored | 4 |
| [NC-17](#NC-17) | Enable IR-based code generation | 1 |
| [NC-18](#NC-18) | Events are emitted without the sender information | 12 |
| [NC-19](#NC-19) | Events may be emitted out of order due to reentrancy | 4 |
| [NC-20](#NC-20) |  Function ordering does not follow the Solidity Style Guide | 10 |
| [NC-21](#NC-21) | Functions with array parameters should have length checks in place | 1 |
| [NC-22](#NC-22) | Variable names for `immutable`s should use CONSTANT_CASE | 2 |
| [NC-23](#NC-23) | Import declarations should import specific identifiers, rather than the whole file | 27 |
| [NC-24](#NC-24) | Imports could be organized more systematically | 8 |
| [NC-25](#NC-25) | Inconsistent spacing in comments | 1 |
| [NC-26](#NC-26) | Invalid NatSpec comment style | 1 |
| [NC-27](#NC-27) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-28](#NC-28) | Large multiples of ten should use scientific notation | 2 |
| [NC-29](#NC-29) | Named mappings are recommended | 7 |
| [NC-30](#NC-30) | Named imports of parent contracts are missing | 6 |
| [NC-31](#NC-31) | NatSpec documentation for function is missing | 10 |
| [NC-32](#NC-32) | Modifier declarations should have NatSpec descriptions | 2 |
| [NC-33](#NC-33) | Missing NatSpec `@param` | 32 |
| [NC-34](#NC-34) | Public variable declarations should have NatSpec descriptions | 5 |
| [NC-35](#NC-35) | NatSpec `@return` is missing | 16 |
| [NC-36](#NC-36) | Function declarations should have `@notice` tags | 19 |
| [NC-37](#NC-37) | There is no need to initialize variables with 0 | 6 |
| [NC-38](#NC-38) | Put all system-wide constants in one file | 16 |
| [NC-39](#NC-39) | State variables should include comments | 5 |
| [NC-40](#NC-40) | Lines are too long | 3 |
| [NC-41](#NC-41) | Unnecessary cast | 1 |
| [NC-42](#NC-42) | Unused contract variables | 3 |
| [NC-43](#NC-43) | Consider using `delete` rather than assigning zero/false to clear values | 1 |
| [NC-44](#NC-44) | Expressions for constant values should use `immutable` rather than `constant` | 16 |
| [NC-45](#NC-45) | Use `@inheritdoc` for overridden functions | 12 |
| [NC-46](#NC-46) | Upgrade `openzeppelin` to the Latest Version (`5.0.0`) | 16 |
| [NC-47](#NC-47) | Use the latest solidity version for deployment (`0.8.21`) | 6 |
| [NC-48](#NC-48) | Use of `override` is unnecessary | 12 |
| [NC-49](#NC-49) | Returning a struct instead of a bunch of variables is better | 1 |
| [NC-50](#NC-50) | Visibility of state variables is not explicitly defined | 1 |
| [NC-51](#NC-51) | Names of `private`/`internal` state variables should be prefixed with an underscore | 18 |
| [NC-52](#NC-52) | Variables should be named in mixedCase style | 2 |
| [NC-53](#NC-53) | Functions not used internally could be marked `external` | 6 |

## Gas Optimizations


*Total <b>218</b> instances over <b>45</b> issues:*
...
| [GAS-5](#GAS-5) | Divisions can be `unchecked` to save gas | 2 | 40 |
| [GAS-6](#GAS-6) | Don't transfer with zero amount to save gas | 1 | - |
| [GAS-7](#GAS-7) | Operator `+=` costs more gas than `<x> = <x> + <y>` for state variables | 6 | 678 |
| [GAS-8](#GAS-8) | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function to save gas | 4 | - |
| [GAS-9](#GAS-9) | Increments can be `unchecked` to save gas | 2 | 120 |
| [GAS-10](#GAS-10) | `internal` functions only called once can be inlined to save gas | 2 | 60 |
| [GAS-11](#GAS-11) | `keccak256()` hash of literals should only be computed once | 11 | 462 |
| [GAS-12](#GAS-12) | Low level `call` can be optimized with assembly | 2 | 496 |
| [GAS-13](#GAS-13) | Multiple accesses of the same mapping/array key/index should be cached | 2 | 84 |
| [GAS-14](#GAS-14) | Newer versions of solidity are more gas efficient | 6 | - |
| [GAS-15](#GAS-15) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 14 | 42 |
| [GAS-16](#GAS-16) | Optimize Gas by splitting `if() revert` statements | 8 | - |
...
| [GAS-20](#GAS-20) | The result of a function call should be cached rather than re-calling the function | 2 | 200 |
| [GAS-21](#GAS-21) | Unlimited gas consumption risk due to external call recipients | 2 | - |
| [GAS-22](#GAS-22) | Optimize External Calls with Assembly for Memory Efficiency | 5 | 1100 |
| [GAS-23](#GAS-23) | Use assembly to compute hashes to save gas | 15 | 1200 |
| [GAS-24](#GAS-24) | Use assembly to emit events | 19 | 722 |
| [GAS-25](#GAS-25) | Use assembly to write address/contract type storage values | 4 | 200 |
| [GAS-26](#GAS-26) | Using a double `if` statement instead of a logical AND (`&&`) | 3 | 90 |
| [GAS-27](#GAS-27) | Use local variables for emitting | 6 | 582 |
| [GAS-28](#GAS-28) | Use a more recent version of solidity | 6 | - |
| [GAS-29](#GAS-29) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 1 | 8550 |
| [GAS-30](#GAS-30) | Use `unchecked` block for safe subtractions | 1 | 85 |
| [GAS-31](#GAS-31) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-32](#GAS-32) | Using `constant`s directly, rather than caching the value, saves gas | 2 | - |
| [GAS-33](#GAS-33) | Using `this` to access functions results in an external call, wasting gas | 1 | 100 |
| [GAS-34](#GAS-34) | Use `selfbalance()` instead of `address(this).balance` | 1 | - |
| [GAS-35](#GAS-35) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-36](#GAS-36) | Cache array length outside of loop | 4 | - |
| [GAS-37](#GAS-37) | State variables should be cached in stack variables rather than re-reading them from storage | 3 | 291 |
| [GAS-38](#GAS-38) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 2 | - |
| [GAS-39](#GAS-39) | Don't initialize variables with default value | 6 | - |
| [GAS-40](#GAS-40) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 4 | 220 |
| [GAS-41](#GAS-41) | Constructors can be marked as `payable` to save deployment gas | 3 | 63 |
| [GAS-42](#GAS-42) | Functions guaranteed to revert when called by normal users can be marked `payable` | 20 | 420 |
| [GAS-43](#GAS-43) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-44](#GAS-44) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 3 | 12 |
| [GAS-45](#GAS-45) | Using assembly to check for zero can save gas | 23 | 138 |
<a name="M-1"></a> 
...
<a name="L-12"></a> 
### [L-12] Potential Re-org Attack Vector
...
<a name="L-20"></a> 
### [L-20] Unsafe use of ERC20 `transfer()`/`transferFrom()`/`approve()`
...
<a name="L-22"></a> 
### [L-22]  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()`
...
```
*Github:* [[27](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L27), [28](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L28), [55](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L55), [57](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L57), [102](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L102), [103](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L103), [104](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L104), [106](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L106), [108](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L108), [111](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L111), [116](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L116), [117](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L117), [118](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L118), [120](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L120), [122](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L122), [125](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L125)]
...
/// @audit consider length check for `addresses`
424:     for (uint256 i = 0; i < addresses.length; ++i) {
...
<a name="NC-9"></a> 
### [NC-9] Consider using `AccessControlDefaultAdminRules` rather than `AccessControl`
...
<a name="NC-22"></a> 
### [NC-22] Variable names for `immutable`s should use CONSTANT_CASE
...
<a name="NC-26"></a> 
### [NC-26] Invalid NatSpec comment style
...
<a name="NC-31"></a> 
### [NC-31] NatSpec documentation for function is missing
...
<a name="NC-32"></a> 
### [NC-32] Modifier declarations should have NatSpec descriptions
...
<a name="NC-34"></a> 
### [NC-34] Public variable declarations should have NatSpec descriptions
...
<a name="NC-35"></a> 
### [NC-35] NatSpec `@return` is missing
...
<a name="NC-36"></a> 
### [NC-36] Function declarations should have `@notice` tags
...
<a name="NC-39"></a> 
### [NC-39] State variables should include comments
...
<a name="NC-42"></a> 
### [NC-42] Unused contract variables
...
<a name="NC-43"></a> 
### [NC-43] Consider using `delete` rather than assigning zero/false to clear values
...
```
*Github:* [[4](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/SingleAdminAccessControl.sol#L4), [5](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/SingleAdminAccessControl.sol#L5)]
...
```
*Github:* [[4](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/USDeSilo.sol#L4), [5](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/USDeSilo.sol#L5)]
...
<a name="NC-50"></a> 
### [NC-50] Visibility of state variables is not explicitly defined
...
```
*Github:* [[103](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDeV2.sol#L103), [119](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDeV2.sol#L119)]
...
```
*Github:* [[248](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L248), [291](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L291), [299](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L299), [342](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L342), [421](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L421)]
...
```
*Github:* [[75](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L75), [210](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L210), [232](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L232)]
...
```
*Github:* [[178](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L178), [206](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/EthenaMinting.sol#L206)]
...
```
*Github:* [[96](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L96), [140](https://github.com/code-423n4/2023-10-ethena/blob/75cfa2533af38a049bbe12e929bdcb9a3df0b100/contracts/StakedUSDe.sol#L140)]
...
<a name="GAS-27"></a> 
### [GAS-27] Use local variables for emitting
...
<a name="GAS-29"></a> 
### [GAS-29] Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes
...
<a name="GAS-30"></a> 
### [GAS-30] Use `unchecked` block for safe subtractions
...
<a name="GAS-32"></a> 
### [GAS-32] Using `constant`s directly, rather than caching the value, saves gas
...
<a name="GAS-33"></a> 
### [GAS-33] Using `this` to access functions results in an external call, wasting gas
...
<a name="GAS-35"></a> 
### [GAS-35] Using bools for storage incurs overhead
...
<a name="GAS-36"></a> 
### [GAS-36] Cache array length outside of loop
...
<a name="GAS-38"></a> 
### [GAS-38] Use `calldata` instead of `memory` for function arguments that do not get mutated
...
<a name="GAS-39"></a> 
### [GAS-39] Don't initialize variables with default value
...
<a name="GAS-40"></a> 
### [GAS-40] Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead
...
<a name="GAS-41"></a> 
### [GAS-41] Constructors can be marked as `payable` to save deployment gas
...
<a name="GAS-42"></a> 
### [GAS-42] Functions guaranteed to revert when called by normal users can be marked `payable`
...
<a name="GAS-43"></a> 
### [GAS-43] `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too)
