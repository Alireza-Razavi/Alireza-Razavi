...
*Total <b>70</b> instances over <b>33</b> issues:*
...
| [NC-8](#NC-8) | Contract should expose an `interface` | 2 |
| [NC-9](#NC-9) | Contracts should each be defined in separate files | 2 |
| [NC-10](#NC-10) | Contracts should have full test coverage | 1 |
| [NC-11](#NC-11) | Events that mark critical parameter changes should contain both the old and the new value | 2 |
| [NC-12](#NC-12) | Enable IR-based code generation | 1 |
| [NC-13](#NC-13) | Events are emitted without the sender information | 1 |
| [NC-14](#NC-14) |  Function ordering does not follow the Solidity Style Guide | 1 |
| [NC-15](#NC-15) | Functions with array parameters should have length checks in place | 1 |
| [NC-16](#NC-16) | Import declarations should import specific identifiers, rather than the whole file | 4 |
| [NC-17](#NC-17) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-18](#NC-18) | Long functions should be refactored into multiple, smaller, functions | 1 |
| [NC-19](#NC-19) | Missing zero address check in functions with address parameters | 8 |
| [NC-20](#NC-20) | Event declarations should have NatSpec descriptions | 2 |
| [NC-21](#NC-21) | NatSpec documentation for function is missing | 8 |
| [NC-22](#NC-22) | Missing NatSpec `@param` | 8 |
| [NC-23](#NC-23) | Public variable declarations should have NatSpec descriptions | 1 |
| [NC-24](#NC-24) | NatSpec `@return` is missing | 3 |
| [NC-25](#NC-25) | There is no need to initialize variables with 0 | 1 |
| [NC-26](#NC-26) | Non-assembly method available | 1 |
| [NC-27](#NC-27) | Contract declarations should have NatSpec `@title` annotations | 1 |
| [NC-28](#NC-28) | Typos | 1 |
...
| [NC-32](#NC-32) | Return values of `approve()` not checked | 1 |
...
<a name="NC-9"></a> 
### [NC-9] Contracts should each be defined in separate files
...
<a name="NC-14"></a> 
### [NC-14]  Function ordering does not follow the Solidity Style Guide
...
<a name="NC-18"></a> 
### [NC-18] Long functions should be refactored into multiple, smaller, functions
...
<a name="NC-26"></a> 
### [NC-26] Non-assembly method available
...
<a name="NC-32"></a> 
### [NC-32] Return values of `approve()` not checked
Not all IERC20 implementations `revert()` when there's a failure in `approve()`. The function signature has a boolean return value and they indicate errors that way instead. By not checking the return value, operations that should have marked as failed, may potentially go through without actually approving anything
