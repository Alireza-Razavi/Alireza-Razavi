...
| [GAS-5](#GAS-5) | Reduce gas usage by moving to Solidity 0.8.19 or later | 9 | - |
| [GAS-6](#GAS-6) | Redundant state variable getters | 1 | - |
| [GAS-7](#GAS-7) | Unused named return variables without optimizer waste gas | 1 | 9 |
| [GAS-8](#GAS-8) | Use a more recent version of solidity | 9 | - |
| [GAS-9](#GAS-9) | State variables should be cached in stack variables rather than re-reading them from storage | 5 | 485 |
| [GAS-10](#GAS-10) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 2 | - |
| [GAS-11](#GAS-11) | Use Custom Errors | 25 | 1250 |
| [GAS-12](#GAS-12) | Don't use `SafeMath` once the solidity version is 0.8.0 or greater | 2 | - |
| [GAS-13](#GAS-13) | Long revert strings | 10 | - |
| [GAS-14](#GAS-14) | Constructors can be marked as `payable` to save deployment gas | 3 | 63 |
| [GAS-15](#GAS-15) | Functions guaranteed to revert when called by normal users can be marked `payable` | 11 | 231 |
| [GAS-16](#GAS-16) | Use != 0 instead of > 0 for unsigned integer comparison | 14 | - |
| [GAS-17](#GAS-17) | Using assembly to check for zero can save gas | 26 | - |
| [GAS-18](#GAS-18) | `internal` functions not called by the contract should be removed | 5 | - |
...
<a name="GAS-7"></a> 
#### [GAS-7] Unused named return variables without optimizer waste gas
...
<a name="GAS-8"></a> 
#### [GAS-8] Use a more recent version of solidity
...
<a name="GAS-12"></a> 
#### [GAS-12] Don't use `SafeMath` once the solidity version is 0.8.0 or greater
...
<a name="GAS-17"></a> 
#### [GAS-17] Using assembly to check for zero can save gas
