...
*Total <b>191</b> instances over <b>26</b> issues:*
...
| [L-19](#L-19) | Timestamp may be manipulation | 23 |
| [L-20](#L-20) | Tokens may be minted to `address(0)` | 2 |
| [L-21](#L-21) | Unsafe solidity low-level call can cause gas grief attack | 6 |
| [L-22](#L-22) | Use Ownable2Step instead of Ownable | 6 |
| [L-23](#L-23) | Consider using `ERC721A` instead of `ERC721` | 1 |
| [L-24](#L-24) | Missing zero address check in initializer | 1 |
| [L-25](#L-25) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 8 |
| [L-26](#L-26) | Empty body - Consider commenting why | 3 |

## Non Critical Issues


*Total <b>1563</b> instances over <b>76</b> issues:*
...
| [NC-57](#NC-57) | Lines are too long | 161 |
| [NC-58](#NC-58) | Typos | 7 |
| [NC-59](#NC-59) | Unused arguments should be removed or implemented | 3 |
| [NC-60](#NC-60) | Consider using `delete` rather than assigning zero/false to clear values | 6 |
| [NC-61](#NC-61) | Solidity compiler version is not fixed | 8 |
| [NC-62](#NC-62) | Use `@inheritdoc` for overridden functions | 3 |
| [NC-63](#NC-63) | Use the latest solidity version for deployment (`0.8.23`) | 8 |
| [NC-64](#NC-64) | Use of `override` is unnecessary | 3 |
| [NC-65](#NC-65) | Returning a struct instead of a bunch of variables is better | 6 |
| [NC-66](#NC-66) | Use a struct to encapsulate multiple function parameters | 9 |
| [NC-67](#NC-67) | Visibility of state variables is not explicitly defined | 6 |
| [NC-68](#NC-68) | Whitespace in Expressions | 11 |
| [NC-69](#NC-69) | Common functions should be refactored to a common base contract | 3 |
| [NC-70](#NC-70) | Names of `private`/`internal` functions should be prefixed with an underscore | 4 |
| [NC-71](#NC-71) | Names of `private`/`internal` state variables should be prefixed with an underscore | 34 |
| [NC-72](#NC-72) | `onlyOwner` is not used anywhere | 6 |
| [NC-73](#NC-73) |  `require()` / `revert()` statements should have descriptive reason strings | 10 |
| [NC-74](#NC-74) | Variables should be named in mixedCase style | 13 |
| [NC-75](#NC-75) | Event is missing `indexed` fields | 5 |
| [NC-76](#NC-76) | Functions not used internally could be marked `external` | 75 |

## Gas Optimizations


*Total <b>573</b> instances over <b>41</b> issues:*
...
| [GAS-16](#GAS-16) | Unlimited gas consumption risk due to external call recipients | 6 | - |
| [GAS-17](#GAS-17) | Optimize External Calls with Assembly for Memory Efficiency | 8 | 1760 |
| [GAS-18](#GAS-18) | Use assembly to compute hashes to save gas | 8 | 640 |
| [GAS-19](#GAS-19) | Use assembly to emit events | 12 | 456 |
| [GAS-20](#GAS-20) | Use assembly to validate `msg.sender` | 15 | - |
| [GAS-21](#GAS-21) | Use assembly to write address/contract type storage values | 14 | 700 |
| [GAS-22](#GAS-22) | Using a double `if` statement instead of a logical AND (`&&`) | 28 | 840 |
| [GAS-23](#GAS-23) | Use a more recent version of solidity | 8 | - |
| [GAS-24](#GAS-24) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 13 | 111150 |
| [GAS-25](#GAS-25) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-26](#GAS-26) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-27](#GAS-27) | Use `selfbalance()` instead of `address(this).balance` | 2 | - |
| [GAS-28](#GAS-28) | `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants) | 8 | - |
| [GAS-29](#GAS-29) | Using bools for storage incurs overhead | 13 | 1300 |
| [GAS-30](#GAS-30) | Cache array length outside of loop | 9 | - |
| [GAS-31](#GAS-31) | State variables should be cached in stack variables rather than re-reading them from storage | 31 | 3007 |
| [GAS-32](#GAS-32) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 33 | - |
| [GAS-33](#GAS-33) | Use Custom Errors | 68 | 3400 |
| [GAS-34](#GAS-34) | Don't initialize variables with default value | 11 | - |
| [GAS-35](#GAS-35) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 13 | 715 |
| [GAS-36](#GAS-36) | Constructors can be marked as `payable` to save deployment gas | 7 | 147 |
| [GAS-37](#GAS-37) | Functions guaranteed to revert when called by normal users can be marked `payable` | 1 | 21 |
| [GAS-38](#GAS-38) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 9 | 45 |
| [GAS-39](#GAS-39) | Splitting require() statements that use && saves gas | 10 | - |
| [GAS-40](#GAS-40) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 6 | 24 |
| [GAS-41](#GAS-41) | Using assembly to check for zero can save gas | 5 | 30 |
...
<a name="L-25"></a> 
### [L-25]  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()`
...
<a name="L-26"></a> 
### [L-26] Empty body - Consider commenting why
...
<a name="NC-59"></a> 
### [NC-59] Unused arguments should be removed or implemented
...
<a name="NC-63"></a> 
### [NC-63] Use the latest solidity version for deployment (`0.8.23`)
...
<a name="NC-67"></a> 
### [NC-67] Visibility of state variables is not explicitly defined
...
<a name="NC-72"></a> 
### [NC-72] `onlyOwner` is not used anywhere
...
<a name="NC-73"></a> 
### [NC-73]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-74"></a> 
### [NC-74] Variables should be named in mixedCase style
...
<a name="NC-75"></a> 
### [NC-75] Event is missing `indexed` fields
...
<a name="NC-76"></a> 
### [NC-76] Functions not used internally could be marked `external`
...
<a name="GAS-27"></a> 
### [GAS-27] Use `selfbalance()` instead of `address(this).balance`
...
<a name="GAS-34"></a> 
### [GAS-34] Don't initialize variables with default value
...
<a name="GAS-35"></a> 
### [GAS-35] Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead
...
<a name="GAS-37"></a> 
### [GAS-37] Functions guaranteed to revert when called by normal users can be marked `payable`
...
<a name="GAS-38"></a> 
### [GAS-38] `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too)
...
<a name="GAS-39"></a> 
### [GAS-39] Splitting require() statements that use && saves gas
