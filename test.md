...
*Total <b>30</b> instances over <b>9</b> issues:*

|ID|Issue|Instances|
|-|:-|:-:|
| [L-1](#L-1) | Array is `push()`ed but not `pop()`ed | 1 |
| [L-2](#L-2) | Enum values should be used instead of constant array indexes | 4 |
| [L-3](#L-3) | Consider some checks for `address(0)` when setting address state variables | 4 |
...
<a name="L-3"></a> 
### [L-3] Consider some checks for `address(0)` when setting address state variables
