...
*Total <b>112</b> instances over <b>22</b> issues:*
...
| [L-18](#L-18) | Using zero as a parameter | 17 |
| [L-19](#L-19) | Vulnerable versions of packages are being used | 1 |
| [L-20](#L-20) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 1 |
| [L-21](#L-21) | `decimals()` is not a part of the ERC-20 standard | 8 |
| [L-22](#L-22) | Empty body - Consider commenting why | 1 |
...
<a name="L-22"></a> 
### [L-22] Empty body - Consider commenting why
