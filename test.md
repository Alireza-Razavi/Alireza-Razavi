...
*Total <b>145</b> instances over <b>22</b> issues:*
...
| [L-7](#L-7) | Function may return unassigned variable | 19 |
| [L-8](#L-8) | Loss of precision in divisions | 14 |
| [L-9](#L-9) | Missing contract existence checks before low-level calls | 3 |
| [L-10](#L-10) | Missing zero address check in constructor | 2 |
| [L-11](#L-11) | Consider some checks for `address(0)` when setting address state variables | 6 |
| [L-12](#L-12) | `receive()`/`fallback()` function does not authorize requests | 1 |
| [L-13](#L-13) | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 10 |
| [L-14](#L-14) | Timestamp may be manipulation | 19 |
| [L-15](#L-15) | Unsafe solidity low-level call can cause gas grief attack | 3 |
| [L-16](#L-16) | Use of `ecrecover` is susceptible to signature malleability | 1 |
| [L-17](#L-17) | Use of `tx.origin` is unsafe in almost every context | 1 |
| [L-18](#L-18) | Consider using `ERC721A` instead of `ERC721` | 1 |
| [L-19](#L-19) | Using zero as a parameter | 18 |
| [L-20](#L-20) | Missing zero address check in initializer | 1 |
| [L-21](#L-21) | Empty body - Consider commenting why | 1 |
| [L-22](#L-22) | Initializers could be front-run | 2 |

## Non Critical Issues


*Total <b>1122</b> instances over <b>76</b> issues:*
...
| [NC-69](#NC-69) | Use the latest solidity version for deployment (`0.8.22`) | 10 |
| [NC-70](#NC-70) | Use of `override` is unnecessary | 5 |
| [NC-71](#NC-71) | Use a struct to encapsulate multiple function parameters | 2 |
| [NC-72](#NC-72) | Visibility of state variables is not explicitly defined | 2 |
| [NC-73](#NC-73) | Names of `private`/`internal` state variables should be prefixed with an underscore | 7 |
| [NC-74](#NC-74) |  `require()` / `revert()` statements should have descriptive reason strings | 2 |
| [NC-75](#NC-75) | Event is missing `indexed` fields | 21 |
| [NC-76](#NC-76) | Functions not used internally could be marked `external` | 9 |
...
<a name="L-7"></a> 
### [L-7] Function may return unassigned variable
...
/// @audit `votingPower` is unassigned
164:     function contribute(
             address delegate,
             bytes memory gateData
         ) public payable onlyDelegateCall returns (uint96 votingPower) {
...
/// @audit `proposalHash` is unassigned
...
/// @audit `totalVotes` is unassigned
...
/// @audit `proposalType` is unassigned
/// @audit `offsetProposalData` is unassigned
...
<a name="L-12"></a> 
### [L-12] `receive()`/`fallback()` function does not authorize requests
...
<a name="L-16"></a> 
### [L-16] Use of `ecrecover` is susceptible to signature malleability
...
<a name="L-17"></a> 
### [L-17] Use of `tx.origin` is unsafe in almost every context
...
<a name="L-21"></a> 
### [L-21] Empty body - Consider commenting why
...
```
*Github:* [[330](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/ETHCrowdfundBase.sol#L330), [372](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/ETHCrowdfundBase.sol#L372), [391](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/ETHCrowdfundBase.sol#L391), [392](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/ETHCrowdfundBase.sol#L392)]
...
```
*Github:* [[328](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/InitialETHCrowdfund.sol#L328), [333](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/InitialETHCrowdfund.sol#L333), [336](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/InitialETHCrowdfund.sol#L336), [339](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/InitialETHCrowdfund.sol#L339)]
...
```
*Github:* [[515](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L515), [791](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L791), [794](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L794)]
...
```
*Github:* [[422](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernanceNFT.sol#L422), [438](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernanceNFT.sol#L438)]
...
```
*Github:* [[322](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/proposals/ProposalExecutionEngine.sol#L322)]
...
<a name="NC-69"></a> 
### [NC-69] Use the latest solidity version for deployment (`0.8.22`)
...
<a name="NC-71"></a> 
### [NC-71] Use a struct to encapsulate multiple function parameters
