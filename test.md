...
*Total <b>570</b> instances over <b>49</b> issues:*
...
| [GAS-10](#GAS-10) | Inline `modifier`s that are only used once, to save gas | 5 | - |
| [GAS-11](#GAS-11) | `internal` functions only called once can be inlined to save gas | 9 | 270 |
| [GAS-12](#GAS-12) | `keccak256()` hash of literals should only be computed once | 5 | 210 |
| [GAS-13](#GAS-13) | Low level `call` can be optimized with assembly | 3 | 744 |
| [GAS-14](#GAS-14) | Multiple accesses of the same mapping/array key/index should be cached | 7 | 294 |
| [GAS-15](#GAS-15) | Newer versions of solidity are more gas efficient | 10 | - |
| [GAS-16](#GAS-16) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 45 | 135 |
| [GAS-17](#GAS-17) | Optimize Gas by splitting `if() revert` statements | 2 | - |
| [GAS-18](#GAS-18) | Optimize names to save gas | 5 | 110 |
| [GAS-19](#GAS-19) | Redundant state variable getters | 1 | - |
| [GAS-20](#GAS-20) | Remove or replace unused state variables | 3 | - |
| [GAS-21](#GAS-21) | The result of a function call should be cached rather than re-calling the function | 5 | 500 |
| [GAS-22](#GAS-22) | Unlimited gas consumption risk due to external call recipients | 3 | - |
| [GAS-23](#GAS-23) | Unused named return variables without optimizer waste gas | 14 | 126 |
| [GAS-24](#GAS-24) | Optimize External Calls with Assembly for Memory Efficiency | 2 | 440 |
| [GAS-25](#GAS-25) | Use assembly to compute hashes to save gas | 14 | 1120 |
| [GAS-26](#GAS-26) | Use assembly to emit events | 39 | 1482 |
| [GAS-27](#GAS-27) | Use assembly to validate `msg.sender` | 6 | - |
| [GAS-28](#GAS-28) | Use assembly to write address/contract type storage values | 10 | 500 |
| [GAS-29](#GAS-29) | Using a double `if` statement instead of a logical AND (`&&`) | 23 | 690 |
| [GAS-30](#GAS-30) | Use local variables for emitting | 1 | 97 |
| [GAS-31](#GAS-31) | Use a more recent version of solidity | 10 | - |
| [GAS-32](#GAS-32) | Use `storage` instead of `memory` for structs/arrays | 1 | 4200 |
| [GAS-33](#GAS-33) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 8 | 68400 |
| [GAS-34](#GAS-34) | Using bitmap to store bool states can save gas | 3 | - |
| [GAS-35](#GAS-35) | Using `constant`s directly, rather than caching the value, saves gas | 5 | - |
| [GAS-36](#GAS-36) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-37](#GAS-37) | Use `selfbalance()` instead of `address(this).balance` | 1 | - |
| [GAS-38](#GAS-38) | Using bools for storage incurs overhead | 8 | 800 |
| [GAS-39](#GAS-39) | Cache array length outside of loop | 7 | - |
| [GAS-40](#GAS-40) | State variables should be cached in stack variables rather than re-reading them from storage | 5 | 485 |
| [GAS-41](#GAS-41) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 15 | - |
| [GAS-42](#GAS-42) | Don't initialize variables with default value | 4 | - |
| [GAS-43](#GAS-43) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 140 | 7700 |
| [GAS-44](#GAS-44) | Constructors can be marked as `payable` to save deployment gas | 4 | 84 |
| [GAS-45](#GAS-45) | Functions guaranteed to revert when called by normal users can be marked `payable` | 3 | 63 |
| [GAS-46](#GAS-46) | Use shift Right/Left instead of division/multiplication if possible | 1 | - |
| [GAS-47](#GAS-47) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 10 | 40 |
| [GAS-48](#GAS-48) | Using assembly to check for zero can save gas | 62 | 372 |
| [GAS-49](#GAS-49) | `internal` functions not called by the contract should be removed | 1 | - |
...
<a name="GAS-15"></a> 
### [GAS-15] Newer versions of solidity are more gas efficient
...
<a name="GAS-19"></a> 
### [GAS-19] Redundant state variable getters
...
<a name="GAS-20"></a> 
### [GAS-20] Remove or replace unused state variables
...
<a name="GAS-25"></a> 
### [GAS-25] Use assembly to compute hashes to save gas
...
<a name="GAS-30"></a> 
### [GAS-30] Use local variables for emitting
...
<a name="GAS-32"></a> 
### [GAS-32] Use `storage` instead of `memory` for structs/arrays
...
<a name="GAS-33"></a> 
### [GAS-33] Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes
...
<a name="GAS-34"></a> 
### [GAS-34] Using bitmap to store bool states can save gas
...
<a name="GAS-35"></a> 
### [GAS-35] Using `constant`s directly, rather than caching the value, saves gas
...
<a name="GAS-36"></a> 
### [GAS-36] Using `this` to access functions results in an external call, wasting gas
...
<a name="GAS-37"></a> 
### [GAS-37] Use `selfbalance()` instead of `address(this).balance`
...
<a name="GAS-42"></a> 
### [GAS-42] Don't initialize variables with default value
...
<a name="GAS-43"></a> 
### [GAS-43] Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead
...
<a name="GAS-45"></a> 
### [GAS-45] Functions guaranteed to revert when called by normal users can be marked `payable`
...
<a name="GAS-46"></a> 
### [GAS-46] Use shift Right/Left instead of division/multiplication if possible
...
<a name="GAS-47"></a> 
### [GAS-47] Use `!= 0` instead of `> 0` for unsigned integer comparison
...
<a name="GAS-48"></a> 
### [GAS-48] Using assembly to check for zero can save gas
...
<a name="GAS-49"></a> 
### [GAS-49] `internal` functions not called by the contract should be removed
