...
*Total <b>272</b> instances over <b>15</b> issues:*
...
| [L-6](#L-6) | Code does not follow the best practice of check-effects-interaction | 4 |
| [L-7](#L-7) | External function calls within loops | 3 |
| [L-8](#L-8) | Governance functions should be controlled by time locks | 1 |
| [L-9](#L-9) | Loss of precision in divisions | 124 |
| [L-10](#L-10) | Check storage gap for upgradable contracts | 2 |
| [L-11](#L-11) | Multiplication on the result of a division | 1 |
| [L-12](#L-12) | Prevent re-setting a state variable with the same value | 1 |
| [L-13](#L-13) | Timestamp may be manipulation | 3 |
| [L-14](#L-14) | Missing zero address check in initializer | 2 |
| [L-15](#L-15) | Initializers could be front-run | 2 |

## Non Critical Issues


*Total <b>370</b> instances over <b>48</b> issues:*
...
/// @audit `.accrueTokens(..)` is called in `accrueInterest` and `accrueInterest` is called in loop
246:         for (uint256 i = 0; i < allMarkets.length; ) {

/// @audit `.accrueTokens(..)` is called in `accrueInterest` and `accrueInterest` is called in loop
625:         for (uint256 i = 0; i < _allMarkets.length; ) {

/// @audit `.updateAssetPrice(..)` is called in `_calculateScore` and `_calculateScore` is called in loop
/// @audit `.updatePrice(..)` is called in `_calculateScore` and `_calculateScore` is called in loop
625:         for (uint256 i = 0; i < _allMarkets.length; ) {

```
*Github:* [[246](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L246), [625](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L625), [625](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L625)]
