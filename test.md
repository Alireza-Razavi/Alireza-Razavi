...
*Total <b>383</b> instances over <b>58</b> issues:*
...
| [NC-51](#NC-51) | Expressions for constant values should use `immutable` rather than `constant` | 9 |
| [NC-52](#NC-52) | Use `@inheritdoc` for overridden functions | 8 |
| [NC-53](#NC-53) | Use the latest solidity version for deployment (`0.8.23`) | 9 |
| [NC-54](#NC-54) | Use of `override` is unnecessary | 8 |
| [NC-55](#NC-55) | Common functions should be refactored to a common base contract | 8 |
| [NC-56](#NC-56) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-57](#NC-57) |  `require()` / `revert()` statements should have descriptive reason strings | 3 |
| [NC-58](#NC-58) | Variables should be named in mixedCase style | 1 |
...
<a name="NC-53"></a> 
### [NC-53] Use the latest solidity version for deployment (`0.8.23`)
...
<a name="NC-56"></a> 
### [NC-56] Names of `private`/`internal` functions should be prefixed with an underscore
...
<a name="NC-57"></a> 
### [NC-57]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-58"></a> 
### [NC-58] Variables should be named in mixedCase style
