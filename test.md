...
Total <b>257</b> instances over <b>37</b> issues:

|ID|Issue|Instances|Gas|
|-|:-|:-:|:-:|
| [GAS-1](#GAS-1) | Consider activating via-ir for deploying | 1 | - |
| [GAS-2](#GAS-2) | Divisions can be `unchecked` to save gas | 12 | 240 |
| [GAS-3](#GAS-3) | Operator `+=` costs more gas than `<x> = <x> + <y>` for state variables | 4 | 452 |
| [GAS-4](#GAS-4) | Increments can be `unchecked` to save gas | 9 | 540 |
| [GAS-5](#GAS-5) | Initializers can be marked as payable to save deployment gas | 1 | 21 |
| [GAS-6](#GAS-6) | `internal` functions only called once can be inlined to save gas | 9 | 270 |
| [GAS-7](#GAS-7) | `keccak256()` hash of literals should only be computed once | 7 | 294 |
| [GAS-8](#GAS-8) | Multiple accesses of the same mapping/array key/index should be cached | 19 | 798 |
| [GAS-9](#GAS-9) | Newer versions of solidity are more gas efficient | 6 | - |
| [GAS-10](#GAS-10) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 18 | 54 |
| [GAS-11](#GAS-11) | Reduce gas usage by moving to Solidity 0.8.19 or later | 6 | 6000 |
| [GAS-12](#GAS-12) | Redundant state variable getters | 1 | - |
| [GAS-13](#GAS-13) | Remove or replace unused state variables | 1 | - |
| [GAS-14](#GAS-14) | `require()`/`revert()` strings longer than 32 bytes cost extra gas | 3 | 9 |
| [GAS-15](#GAS-15) | The result of a function call should be cached rather than re-calling the function | 13 | 1300 |
| [GAS-16](#GAS-16) | Unlimited gas consumption risk due to external call recipients | 2 | - |
| [GAS-17](#GAS-17) | Unused named return variables without optimizer waste gas | 3 | 27 |
| [GAS-18](#GAS-18) | Use assembly to compute hashes to save gas | 10 | 800 |
| [GAS-19](#GAS-19) | Use assembly to emit events | 20 | 760 |
| [GAS-20](#GAS-20) | Using a double `if` statement instead of a logical AND (`&&`) | 2 | 60 |
| [GAS-21](#GAS-21) | Use a more recent version of solidity | 6 | - |
| [GAS-22](#GAS-22) | Use `storage` instead of `memory` for structs/arrays | 8 | 33600 |
| [GAS-23](#GAS-23) | Use `unchecked` block for safe subtractions | 4 | 340 |
| [GAS-24](#GAS-24) | `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants) | 2 | - |
| [GAS-25](#GAS-25) | Using bools for storage incurs overhead | 2 | - |
| [GAS-26](#GAS-26) | Cache array length outside of loop | 5 | - |
| [GAS-27](#GAS-27) | State variables should be cached in stack variables rather than re-reading them from storage | 4 | 388 |
| [GAS-28](#GAS-28) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 1 | - |
| [GAS-29](#GAS-29) | Use Custom Errors | 21 | 1050 |
| [GAS-30](#GAS-30) | Don't initialize variables with default value | 8 | - |
| [GAS-31](#GAS-31) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 1 | 55 |
| [GAS-32](#GAS-32) | Constructors can be marked as `payable` to save deployment gas | 2 | 42 |
| [GAS-33](#GAS-33) | Functions guaranteed to revert when called by normal users can be marked `payable` | 14 | 294 |
| [GAS-34](#GAS-34) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 1 | 5 |
| [GAS-35](#GAS-35) | Using `private` rather than `public` for constants, saves gas | 12 | - |
| [GAS-36](#GAS-36) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 3 | 12 |
| [GAS-37](#GAS-37) | Using assembly to check for zero can save gas | 16 | 96 |
...
```
[#L94](https://github.com/code-423n4/2023-09-ondo/blob/623dd3c0ff3c4d8ce4ed563b96da50d08cd803c5/contracts/bridge/SourceBridge.sol#L94) [#L179](https://github.com/code-423n4/2023-09-ondo/blob/623dd3c0ff3c4d8ce4ed563b96da50d08cd803c5/contracts/bridge/SourceBridge.sol#L179) 
...
<a name="GAS-11"></a> 
### [GAS-11] Reduce gas usage by moving to Solidity 0.8.19 or later
...
<a name="GAS-24"></a> 
### [GAS-24] `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants)
...
<a name="GAS-36"></a> 
### [GAS-36] Use `!= 0` instead of `> 0` for unsigned integer comparison
...
<a name="GAS-37"></a> 
### [GAS-37] Using assembly to check for zero can save gas
