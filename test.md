...
*Total <b>449</b> instances over <b>53</b> issues:*
...
| [NC-9](#NC-9) | Constant redefined elsewhere | 3 |
| [NC-10](#NC-10) | Constants should be put on the left side of comparisons | 19 |
...
| [NC-15](#NC-15) | Events that mark critical parameter changes should contain both the old and the new value | 14 |
| [NC-16](#NC-16) | Custom errors has no error details | 30 |
| [NC-17](#NC-17) | Custom errors should be used rather than `revert()`/`require()` | 4 |
| [NC-18](#NC-18) | Polymorphic functions make security audits more time-consuming and error-prone | 3 |
| [NC-19](#NC-19) | Duplicated `require()`/`revert()` checks should be refactored | 3 |
| [NC-20](#NC-20) | Empty bytes check is missing | 17 |
| [NC-21](#NC-21) | Enable IR-based code generation | 1 |
| [NC-22](#NC-22) | Events are emitted without the sender information | 8 |
| [NC-23](#NC-23) | Events may be emitted out of order due to reentrancy | 19 |
| [NC-24](#NC-24) |  Function ordering does not follow the Solidity Style Guide | 2 |
| [NC-25](#NC-25) | Functions with array parameters should have length checks in place | 5 |
| [NC-26](#NC-26) | Import declarations should import specific identifiers, rather than the whole file | 3 |
| [NC-27](#NC-27) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-28](#NC-28) | Long functions should be refactored into multiple, smaller, functions | 1 |
| [NC-29](#NC-29) | Missing zero address check in functions with address parameters | 47 |
| [NC-30](#NC-30) | Consider moving `msg.sender` checks to `modifier`s | 1 |
| [NC-31](#NC-31) | Named mappings are recommended | 3 |
| [NC-32](#NC-32) | Event declarations should have NatSpec descriptions | 15 |
| [NC-33](#NC-33) | NatSpec documentation for function is missing | 13 |
| [NC-34](#NC-34) | Missing NatSpec `@param` | 14 |
| [NC-35](#NC-35) | NatSpec `@return` is missing | 4 |
| [NC-36](#NC-36) | There is no need to initialize variables with 0 | 2 |
| [NC-37](#NC-37) | Put all system-wide constants in one file | 37 |
| [NC-38](#NC-38) | Lines are too long | 7 |
| [NC-39](#NC-39) | Typos | 4 |
| [NC-40](#NC-40) | Unused `error` definition | 1 |
| [NC-41](#NC-41) | Unused `event` definition | 1 |
| [NC-42](#NC-42) | Unused named return | 2 |
| [NC-43](#NC-43) | Unused contract variables | 8 |
| [NC-44](#NC-44) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-45](#NC-45) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-46](#NC-46) | Use the latest solidity version for deployment | 16 |
| [NC-47](#NC-47) | Use of `override` is unnecessary | 10 |
| [NC-48](#NC-48) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-49](#NC-49) | Common functions should be refactored to a common base contract | 4 |
| [NC-50](#NC-50) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-51](#NC-51) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-52](#NC-52) | Event is missing `indexed` fields | 4 |
| [NC-53](#NC-53) | Functions not used internally could be marked `external` | 4 |
...
<a name="NC-28"></a> 
### [NC-28] Long functions should be refactored into multiple, smaller, functions
...
<a name="NC-29"></a> 
### [NC-29] Missing zero address check in functions with address parameters
...
<a name="NC-43"></a> 
### [NC-43] Unused contract variables
