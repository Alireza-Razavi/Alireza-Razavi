...
*Total <b>52</b> instances over <b>11</b> issues:*

|ID|Issue|Instances|
|-|:-|:-:|
| [L-1](#L-1) | Array is `push()`ed but not `pop()`ed | 1 |
| [L-2](#L-2) | Constructor / initialization function lacks parameter validation | 11 |
| [L-3](#L-3) | Enum values should be used instead of constant array indexes | 4 |
| [L-4](#L-4) | Missing zero address check in constructor | 11 |
| [L-5](#L-5) | Consider some checks for `address(0)` when setting address state variables | 4 |
| [L-6](#L-6) | Numbers downcast to `address`es may result in collisions | 2 |
| [L-7](#L-7) | Prevent re-setting a state variable with the same value | 2 |
| [L-8](#L-8) | Timestamp may be manipulation | 1 |
| [L-9](#L-9) | Unsafe downcast | 1 |
| [L-10](#L-10) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 2 |
| [L-11](#L-11) | Empty Function Body - Consider commenting why | 13 |

## Non Critical Issues


*Total <b>578</b> instances over <b>57</b> issues:*
...
| [NC-12](#NC-12) | Contract should expose an `interface` | 41 |
...
| [NC-18](#NC-18) | Custom errors has no error details | 30 |
| [NC-19](#NC-19) | Custom errors should be used rather than `revert()`/`require()` | 4 |
| [NC-20](#NC-20) | Polymorphic functions make security audits more time-consuming and error-prone | 3 |
| [NC-21](#NC-21) | Duplicated `require()`/`revert()` checks should be refactored | 3 |
| [NC-22](#NC-22) | Empty bytes check is missing | 17 |
| [NC-23](#NC-23) | Enable IR-based code generation | 1 |
| [NC-24](#NC-24) | Events are emitted without the sender information | 8 |
| [NC-25](#NC-25) | Events may be emitted out of order due to reentrancy | 19 |
| [NC-26](#NC-26) |  Function ordering does not follow the Solidity Style Guide | 2 |
| [NC-27](#NC-27) | Functions with array parameters should have length checks in place | 5 |
| [NC-28](#NC-28) | Import declarations should import specific identifiers, rather than the whole file | 3 |
| [NC-29](#NC-29) | Imports could be organized more systematically | 1 |
| [NC-30](#NC-30) | Inconsistent spacing in comments | 126 |
| [NC-31](#NC-31) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-32](#NC-32) | Long functions should be refactored into multiple, smaller, functions | 1 |
| [NC-33](#NC-33) | Missing zero address check in functions with address parameters | 47 |
| [NC-34](#NC-34) | Consider moving `msg.sender` checks to `modifier`s | 1 |
| [NC-35](#NC-35) | Named mappings are recommended | 3 |
| [NC-36](#NC-36) | Event declarations should have NatSpec descriptions | 15 |
| [NC-37](#NC-37) | NatSpec documentation for function is missing | 13 |
| [NC-38](#NC-38) | Missing NatSpec `@param` | 14 |
| [NC-39](#NC-39) | NatSpec `@return` is missing | 4 |
| [NC-40](#NC-40) | There is no need to initialize variables with 0 | 2 |
| [NC-41](#NC-41) | Put all system-wide constants in one file | 37 |
| [NC-42](#NC-42) | Lines are too long | 7 |
| [NC-43](#NC-43) | Typos | 4 |
| [NC-44](#NC-44) | Unused `error` definition | 1 |
| [NC-45](#NC-45) | Unused `event` definition | 1 |
| [NC-46](#NC-46) | Unused named return | 2 |
| [NC-47](#NC-47) | Unused contract variables | 8 |
| [NC-48](#NC-48) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-49](#NC-49) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-50](#NC-50) | Use the latest solidity version for deployment | 16 |
| [NC-51](#NC-51) | Use of `override` is unnecessary | 10 |
| [NC-52](#NC-52) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-53](#NC-53) | Common functions should be refactored to a common base contract | 4 |
| [NC-54](#NC-54) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-55](#NC-55) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-56](#NC-56) | Event is missing `indexed` fields | 4 |
| [NC-57](#NC-57) | Functions not used internally could be marked `external` | 4 |

## Gas Optimizations


*Total <b>196</b> instances over <b>29</b> issues:*
...
| [GAS-15](#GAS-15) | Use assembly to write address/contract type storage values | 3 | 150 |
...
/// @audit `_governance` not validated
...
/// @audit empty constructor/initializer, lack of parameter validation
...
/// @audit missing zero check for `_governance`
43:     constructor(address _governance) {
...
/// @audit missing zero check for `_addressProvider`
29:     constructor(address _addressProvider) AddressProviderService(_addressProvider) {}
...
<a name="L-5"></a> 
### [L-5] Consider some checks for `address(0)` when setting address state variables
...
<a name="L-6"></a> 
### [L-6] Numbers downcast to `address`es may result in collisions
...
<a name="L-8"></a> 
### [L-8] Timestamp may be manipulation
...
<a name="L-11"></a> 
### [L-11] Empty Function Body - Consider commenting why
...
<a name="NC-28"></a> 
### [NC-28] Import declarations should import specific identifiers, rather than the whole file
...
<details>
<summary>
There are <b>126</b> instances (click to show):
</summary>
...
```
*Github:* [[9](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L9), [31](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L31), [37](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L37), [48](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L48), [59](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L59), [71](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L71), [92](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L92), [107](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L107), [116](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L116), [125](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L125), [136](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L136), [143](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L143)]
...
```
*Github:* [[11](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L11), [32](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L32), [39](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L39), [49](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L49), [59](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L59), [68](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProviderService.sol#L68)]
...
```
*Github:* [[14](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L14), [21](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L21), [31](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L31), [73](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L73), [98](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L98)]
...
```
*Github:* [[18](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L18), [29](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L29), [62](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L62), [79](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L79), [100](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L100), [154](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ExecutorPlugin.sol#L154)]
...
```
*Github:* [[16](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L16), [25](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L25), [47](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L47), [73](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L73), [105](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L105), [162](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L162), [207](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L207), [247](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L247)]
...
```
*Github:* [[9](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeEnabler.sol#L9), [36](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeEnabler.sol#L36), [58](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeEnabler.sol#L58), [77](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeEnabler.sol#L77)]
...
```
*Github:* [[11](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L11), [19](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L19), [65](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L65), [75](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L75), [79](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L79), [87](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModerator.sol#L87)]
...
```
*Github:* [[11](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L11), [17](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L17), [25](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L25), [71](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L71), [81](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L81), [85](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L85), [93](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeModeratorOverridable.sol#L93)]
...
```
*Github:* [[13](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L13), [24](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L24), [56](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L56), [57](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L57), [58](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L58), [59](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L59), [76](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L76), [77](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L77), [85](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L85), [87](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L87), [88](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L88), [89](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L89), [90](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L90), [101](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L101), [109](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L109), [110](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L110), [111](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L111), [112](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L112), [128](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L128), [136](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L136), [137](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L137), [138](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L138), [139](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L139), [156](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L156), [176](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L176), [200](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L200), [227](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/TransactionValidator.sol#L227)]
...
```
*Github:* [[11](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/ExecutorRegistry.sol#L11), [31](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/ExecutorRegistry.sol#L31), [46](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/ExecutorRegistry.sol#L46), [61](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/ExecutorRegistry.sol#L61), [71](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/ExecutorRegistry.sol#L71)]
...
```
*Github:* [[9](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/WalletRegistry.sol#L9), [31](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/WalletRegistry.sol#L31), [42](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/WalletRegistry.sol#L42), [57](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/WalletRegistry.sol#L57), [67](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/registries/WalletRegistry.sol#L67)]
...
```
*Github:* [[10](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L10), [30](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L30), [40](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L40), [50](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L50), [80](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L80), [97](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L97), [137](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L137), [147](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L147), [157](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L157)]
...
```
*Github:* [[7](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L7), [13](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L13), [33](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L33), [45](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L45), [52](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L52), [59](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L59), [79](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/TypeHashHelper.sol#L79)]
...
<a name="NC-33"></a> 
### [NC-33] Missing zero address check in functions with address parameters
...
/// @audit missing zero check for `_newGovernance`
52:     function setGovernance(address _newGovernance) external {

/// @audit missing zero check for `_authorizedAddress`
77:     function setAuthorizedAddress(bytes32 _key, address _authorizedAddress, bool _overrideCheck) external {

/// @audit missing zero check for `_registry`
97:     function setRegistry(bytes32 _key, address _registry) external {

/// @audit missing zero check for `_newAddress`
...
/// @audit missing zero check for `_consoleAccount`
168:     function _setupSubAccount(address[] memory _owners, uint256 _threshold, address _consoleAccount)
             private
             view
             returns (bytes memory)
...
/// @audit missing zero check for `guard`
66:     function setGuard(address guard) public {
...
/// @audit missing zero check for `subAccount`
106:         _checkSubAccountSecurityConfig(subAccount);
         }
...
<a name="NC-40"></a> 
### [NC-40] There is no need to initialize variables with 0
...
<a name="NC-41"></a> 
### [NC-41] Put all system-wide constants in one file
...
<a name="NC-47"></a> 
### [NC-47] Unused contract variables
...
<a name="NC-48"></a> 
### [NC-48] Expressions for constant values should use `immutable` rather than `constant`
...
<a name="NC-49"></a> 
### [NC-49] Use `@inheritdoc` for overridden functions
...
<a name="NC-50"></a> 
### [NC-50] Use the latest solidity version for deployment
...
<a name="NC-51"></a> 
### [NC-51] Use of `override` is unnecessary
...
<a name="NC-52"></a> 
### [NC-52] Missing checks for `address(0)` when assigning values to address state variables
...
<a name="NC-56"></a> 
### [NC-56] Event is missing `indexed` fields
...
<a name="NC-57"></a> 
### [NC-57] Functions not used internally could be marked `external`
