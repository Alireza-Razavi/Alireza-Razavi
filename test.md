...
*Total <b>204</b> instances over <b>20</b> issues:*
...
| [L-14](#L-14) | Tokens may be minted to `address(0)` | 1 |
| [L-15](#L-15) | Unsafe downcast | 2 |
| [L-16](#L-16) | Consider using `ERC721A` instead of `ERC721` | 1 |
| [L-17](#L-17) | Using zero as a parameter | 3 |
| [L-18](#L-18) | Vulnerable version of OZ contarcts is used (`4.7.3`) | 1 |
| [L-19](#L-19) | Do not use deprecated library functions | 3 |
| [L-20](#L-20) | `tokenURI()` does not follow EIP-721 | 1 |

## Non Critical Issues


*Total <b>935</b> instances over <b>67</b> issues:*
...
| [NC-66](#NC-66) | Unspecific compiler version pragma | 8 |
| [NC-67](#NC-67) | Functions not used internally could be marked `external` | 25 |
...
<a name="L-14"></a> 
### [L-14] Tokens may be minted to `address(0)`
...
<a name="L-16"></a> 
### [L-16] Consider using `ERC721A` instead of `ERC721`
...
<a name="L-18"></a> 
### [L-18] Vulnerable version of OZ contarcts is used (`4.7.3`)
...
<a name="L-19"></a> 
### [L-19] Do not use deprecated library functions
...
<a name="NC-66"></a> 
### [NC-66] Unspecific compiler version pragma
