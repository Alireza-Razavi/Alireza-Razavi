...
Total <b>382</b> instances over <b>43</b> issues:
...
| [NC-15](#NC-15) | Magic numbers should be replaced with constants | 14 |
| [NC-16](#NC-16) | Missing zero address check in functions with address parameters | 23 |
| [NC-17](#NC-17) | Consider moving `msg.sender` checks to `modifier`s | 3 |
| [NC-18](#NC-18) | Named mappings are recommended | 9 |
| [NC-19](#NC-19) | NatSpec documentation for contract is missing | 3 |
| [NC-20](#NC-20) | NatSpec documentation for function is missing | 11 |
| [NC-21](#NC-21) | Modifier declarations should have NatSpec descriptions | 1 |
| [NC-22](#NC-22) | Missing NatSpec `@param` | 28 |
| [NC-23](#NC-23) | Public variable declarations should have NatSpec descriptions | 19 |
| [NC-24](#NC-24) | NatSpec `@return` is missing | 15 |
| [NC-25](#NC-25) | There is no need to initialize variables with 0 | 8 |
| [NC-26](#NC-26) | State variables should include comments | 11 |
| [NC-27](#NC-27) | Contract declarations should have NatSpec `@title` annotations | 3 |
| [NC-28](#NC-28) | Unused errors | 2 |
| [NC-29](#NC-29) | Unused named return | 3 |
| [NC-30](#NC-30) | Unused contract variables | 1 |
| [NC-31](#NC-31) | Consider using `delete` rather than assigning zero to clear values | 8 |
| [NC-32](#NC-32) | Expressions for constant values should use `immutable` rather than `constant` | 13 |
| [NC-33](#NC-33) | Use the latest solidity version for deployment | 6 |
| [NC-34](#NC-34) | Use of `override` is unnecessary | 6 |
| [NC-35](#NC-35) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-36](#NC-36) | Common functions should be refactored to a common base contract | 8 |
| [NC-37](#NC-37) | Names of `private`/`internal` functions should be prefixed with an underscore | 2 |
| [NC-38](#NC-38) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-39](#NC-39) |  `require()` / `revert()` statements should have descriptive reason strings | 1 |
| [NC-40](#NC-40) | Return values of `approve()` not checked | 6 |
| [NC-41](#NC-41) | Variables should be named in mixedCase style | 19 |
| [NC-42](#NC-42) | Event is missing `indexed` fields | 13 |
| [NC-43](#NC-43) | Functions not used internally could be marked external | 14 |
...
<a name="NC-15"></a> 
### [NC-15] Magic numbers should be replaced with constants
...
<a name="NC-25"></a> 
### [NC-25] There is no need to initialize variables with 0
...
<a name="NC-34"></a> 
### [NC-34] Use of `override` is unnecessary
...
<a name="NC-39"></a> 
### [NC-39]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-40"></a> 
### [NC-40] Return values of `approve()` not checked
...
<a name="NC-43"></a> 
### [NC-43] Functions not used internally could be marked external
