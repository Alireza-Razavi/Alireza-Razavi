...
Total <b>417</b> instances over <b>52</b> issues:
...
| [NC-3](#NC-3) | Consider adding a block/deny-list | 5 |
| [NC-4](#NC-4) | Consider adding formal verification proofs | 1 |
| [NC-5](#NC-5) | Consider bounding input array length | 2 |
| [NC-6](#NC-6) | Constants should be put on the left side of comparisons | 16 |
| [NC-7](#NC-7) | Contract name does not follow the Solidity Style Guide | 2 |
| [NC-8](#NC-8) | Contract uses both `require()`/`revert()` as well as custom errors | 3 |
| [NC-9](#NC-9) | Contracts should have full test coverage | 1 |
| [NC-10](#NC-10) | Events that mark critical parameter changes should contain both the old and the new value | 16 |
| [NC-11](#NC-11) | Custom errors has no error details | 15 |
| [NC-12](#NC-12) | Custom errors should be used rather than `revert()`/`require()` | 21 |
| [NC-13](#NC-13) | `else` block not required | 3 |
| [NC-14](#NC-14) | Empty bytes check is missing | 2 |
...
| [NC-17](#NC-17) | Events are emitted without the sender information | 14 |
| [NC-18](#NC-18) | Import declarations should import specific identifiers, rather than the whole file | 32 |
| [NC-19](#NC-19) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-20](#NC-20) | Large multiples of ten should use scientific notation | 1 |
| [NC-21](#NC-21) | Magic numbers should be replaced with constants | 14 |
| [NC-22](#NC-22) | Missing zero address check in functions with address parameters | 23 |
| [NC-23](#NC-23) | Consider moving `msg.sender` checks to `modifier`s | 3 |
| [NC-24](#NC-24) | Named mappings are recommended | 9 |
| [NC-25](#NC-25) | NatSpec documentation for contract is missing | 3 |
| [NC-26](#NC-26) | NatSpec documentation for function is missing | 11 |
| [NC-27](#NC-27) | Modifier declarations should have NatSpec descriptions | 1 |
| [NC-28](#NC-28) | Missing NatSpec `@param` | 28 |
| [NC-29](#NC-29) | Public variable declarations should have NatSpec descriptions | 19 |
| [NC-30](#NC-30) | NatSpec `@return` is missing | 15 |
| [NC-31](#NC-31) | There is no need to initialize variables with 0 | 8 |
| [NC-32](#NC-32) | Put all system-wide constants in one file | 13 |
| [NC-33](#NC-33) | SPDX identifier should be the in the first line of a solidity file | 6 |
| [NC-34](#NC-34) | State variables should include comments | 11 |
| [NC-35](#NC-35) | Contract declarations should have NatSpec `@title` annotations | 3 |
| [NC-36](#NC-36) | Unused errors | 2 |
| [NC-37](#NC-37) | Unused named return | 3 |
| [NC-38](#NC-38) | Unused contract variables | 1 |
| [NC-39](#NC-39) | Consider using `delete` rather than assigning zero to clear values | 8 |
| [NC-40](#NC-40) | Expressions for constant values should use `immutable` rather than `constant` | 13 |
| [NC-41](#NC-41) | Use the latest solidity version for deployment | 6 |
| [NC-42](#NC-42) | Use of `override` is unnecessary | 6 |
| [NC-43](#NC-43) | Use scientific notation (e.g. `1e18`) rather than exponentiation (e.g. `10**18`) | 1 |
| [NC-44](#NC-44) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
...
| [NC-47](#NC-47) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-48](#NC-48) |  `require()` / `revert()` statements should have descriptive reason strings | 1 |
| [NC-49](#NC-49) | Return values of `approve()` not checked | 6 |
| [NC-50](#NC-50) | Variables should be named in mixedCase style | 19 |
| [NC-51](#NC-51) | Event is missing `indexed` fields | 13 |
| [NC-52](#NC-52) | Functions not used internally could be marked external | 14 |
...
<a name="NC-7"></a> 
### [NC-7] Contract name does not follow the Solidity Style Guide
...
/// Missing empty check for `payload`
...
```
[#L85](https://github.com/code-423n4/2023-09-ondo/blob/623dd3c0ff3c4d8ce4ed563b96da50d08cd803c5/contracts/bridge/DestinationBridge.sol#L85) 

```solidity
File: contracts/bridge/SourceBridge.sol

/// Missing empty check for `payload`
106:   function _payGasAndCallContract(
...
```
[#L106](https://github.com/code-423n4/2023-09-ondo/blob/623dd3c0ff3c4d8ce4ed563b96da50d08cd803c5/contracts/bridge/SourceBridge.sol#L106) 
...
<a name="NC-20"></a> 
### [NC-20] Large multiples of ten should use scientific notation
...
<a name="NC-21"></a> 
### [NC-21] Magic numbers should be replaced with constants
...
<a name="NC-27"></a> 
### [NC-27] Modifier declarations should have NatSpec descriptions
...
<a name="NC-29"></a> 
### [NC-29] Public variable declarations should have NatSpec descriptions
...
<a name="NC-32"></a> 
### [NC-32] Put all system-wide constants in one file
...
<a name="NC-33"></a> 
### [NC-33] SPDX identifier should be the in the first line of a solidity file
...
<a name="NC-43"></a> 
### [NC-43] Use scientific notation (e.g. `1e18`) rather than exponentiation (e.g. `10**18`)
