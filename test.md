...
*Total <b>117</b> instances over <b>24</b> issues:*
...
| [L-10](#L-10) | Missing checks for state variable assignments | 4 |
| [L-11](#L-11) | Missing zero address check in constructor | 3 |
| [L-12](#L-12) | Consider some checks for `address(0)` when setting address state variables | 2 |
...
| [L-15](#L-15) | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 4 |
...
| [L-18](#L-18) | Unsafe downcast | 1 |
| [L-19](#L-19) | Consider using `ERC721A` instead of `ERC721` | 1 |
| [L-20](#L-20) | Using zero as a parameter | 17 |
| [L-21](#L-21) | Vulnerable versions of packages are being used | 1 |
...
| [L-23](#L-23) | `decimals()` is not a part of the ERC-20 standard | 8 |
...
132:      * @dev a = (x * 10**from) => b = (x * 10**to), where x is constant.

```
*Github:* [[132](https://github.com/code-423n4/2023-11-shellprotocol/blob/8139366f0f2eb32672efea621c5ae2590ffaf99f/src/adapters/OceanAdapter.sol#L132)]


```solidity
File: src/ocean/Ocean.sol

1115:      * @dev a = (x * 10**from) => b = (x * 10**to), where x is constant.

```
*Github:* [[1115](https://github.com/code-423n4/2023-11-shellprotocol/blob/8139366f0f2eb32672efea621c5ae2590ffaf99f/src/ocean/Ocean.sol#L1115)]
...
```
*Github:* [[836](https://github.com/code-423n4/2023-11-shellprotocol/blob/8139366f0f2eb32672efea621c5ae2590ffaf99f/src/ocean/Ocean.sol#L836), [875](https://github.com/code-423n4/2023-11-shellprotocol/blob/8139366f0f2eb32672efea621c5ae2590ffaf99f/src/ocean/Ocean.sol#L875), [1063](https://github.com/code-423n4/2023-11-shellprotocol/blob/8139366f0f2eb32672efea621c5ae2590ffaf99f/src/ocean/Ocean.sol#L1063)]
...
<a name="L-21"></a> 
### [L-21] Vulnerable versions of packages are being used
