...
Total <b>191</b> instances over <b>20</b> issues:
...
| [GAS-4](#GAS-4) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 34 | 102 |
| [GAS-5](#GAS-5) | Reduce gas usage by moving to Solidity 0.8.19 or later | 9 | 9000 |
| [GAS-6](#GAS-6) | Redundant state variable getters | 1 | - |
...
| [GAS-10](#GAS-10) | Using a double `if` statement instead of a logical AND (`&&`) | 9 | 270 |
| [GAS-11](#GAS-11) | Use a more recent version of solidity | 9 | - |
| [GAS-12](#GAS-12) | State variables should be cached in stack variables rather than re-reading them from storage | 5 | 485 |
| [GAS-13](#GAS-13) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 2 | - |
| [GAS-14](#GAS-14) | Use Custom Errors | 25 | 1250 |
| [GAS-15](#GAS-15) | Don't use `SafeMath` once the solidity version is 0.8.0 or greater | 2 | - |
...
<a name="GAS-6"></a> 
#### [GAS-6] Redundant state variable getters
...
<a name="GAS-7"></a> 
#### [GAS-7] Remove or replace unused state variables
...
<a name="GAS-8"></a> 
#### [GAS-8] `require()`/`revert()` strings longer than 32 bytes cost extra gas
...
<a name="GAS-9"></a> 
#### [GAS-9] Unused named return variables without optimizer waste gas
...
<a name="GAS-12"></a> 
#### [GAS-12] State variables should be cached in stack variables rather than re-reading them from storage
...
<a name="GAS-15"></a> 
#### [GAS-15] Don't use `SafeMath` once the solidity version is 0.8.0 or greater
