...
*Total <b>451</b> instances over <b>55</b> issues:*
...
| [NC-31](#NC-31) | Missing zero address check in functions with address parameters | 47 |
| [NC-32](#NC-32) | Consider moving `msg.sender` checks to `modifier`s | 1 |
| [NC-33](#NC-33) | Named mappings are recommended | 3 |
| [NC-34](#NC-34) | Event declarations should have NatSpec descriptions | 15 |
| [NC-35](#NC-35) | NatSpec documentation for function is missing | 13 |
| [NC-36](#NC-36) | Missing NatSpec `@param` | 14 |
| [NC-37](#NC-37) | NatSpec `@return` is missing | 4 |
| [NC-38](#NC-38) | There is no need to initialize variables with 0 | 2 |
| [NC-39](#NC-39) | Put all system-wide constants in one file | 37 |
| [NC-40](#NC-40) | Lines are too long | 7 |
| [NC-41](#NC-41) | Typos | 4 |
| [NC-42](#NC-42) | Unused `error` definition | 1 |
| [NC-43](#NC-43) | Unused `event` definition | 1 |
| [NC-44](#NC-44) | Unused named return | 2 |
| [NC-45](#NC-45) | Unused contract variables | 8 |
| [NC-46](#NC-46) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-47](#NC-47) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-48](#NC-48) | Use the latest solidity version for deployment | 16 |
| [NC-49](#NC-49) | Use of `override` is unnecessary | 10 |
| [NC-50](#NC-50) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-51](#NC-51) | Common functions should be refactored to a common base contract | 4 |
| [NC-52](#NC-52) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-53](#NC-53) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-54](#NC-54) | Event is missing `indexed` fields | 4 |
| [NC-55](#NC-55) | Functions not used internally could be marked `external` | 4 |
...
<a name="NC-31"></a> 
### [NC-31] Missing zero address check in functions with address parameters
...
<a name="NC-38"></a> 
### [NC-38] There is no need to initialize variables with 0
...
<a name="NC-39"></a> 
### [NC-39] Put all system-wide constants in one file
...
<a name="NC-45"></a> 
### [NC-45] Unused contract variables
...
<a name="NC-47"></a> 
### [NC-47] Use `@inheritdoc` for overridden functions
...
<a name="NC-48"></a> 
### [NC-48] Use the latest solidity version for deployment
...
<a name="NC-50"></a> 
### [NC-50] Missing checks for `address(0)` when assigning values to address state variables
...
<a name="NC-51"></a> 
### [NC-51] Common functions should be refactored to a common base contract
...
<a name="NC-52"></a> 
### [NC-52] Names of `private`/`internal` functions should be prefixed with an underscore
...
<a name="NC-53"></a> 
### [NC-53] Names of `private`/`internal` state variables should be prefixed with an underscore
It is recommended by the [Solidity Style Guide](https://docs.soliditylang.org/en/v0.8.20/style-guide.html#underscore-prefix-for-non-external-functions-and-variables)
