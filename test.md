...
*Total <b>12</b> instances over <b>2</b> issues:*
...
*Total <b>286</b> instances over <b>24</b> issues:*
...
| [L-12](#L-12) | Consider some checks for `address(0)` when setting address state variables | 109 |
| [L-13](#L-13) | Multiplication on the result of a division | 2 |
| [L-14](#L-14) | Owner can renounce Ownership | 6 |
| [L-15](#L-15) | Prevent re-setting a state variable with the same value | 30 |
| [L-16](#L-16) | `receive()`/`fallback()` function does not authorize requests | 1 |
| [L-17](#L-17) | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 8 |
| [L-18](#L-18) | Timestamp may be manipulation | 23 |
...
| [L-22](#L-22) | Missing zero address check in initializer | 1 |
| [L-23](#L-23) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 8 |
| [L-24](#L-24) | Empty body - Consider commenting why | 3 |

## Non Critical Issues


*Total <b>1312</b> instances over <b>59</b> issues:*
...
| [NC-4](#NC-4) | Consider bounding input array length | 3 |
| [NC-5](#NC-5) | Constants should be put on the left side of comparisons | 8 |
| [NC-6](#NC-6) | Contract does not follow the Solidity Style Guide's suggested layout ordering | 37 |
| [NC-7](#NC-7) | Contract name does not follow the Solidity Style Guide | 2 |
| [NC-8](#NC-8) | Contract should expose an `interface` | 104 |
| [NC-9](#NC-9) | Contracts should have full test coverage | 1 |
| [NC-10](#NC-10) | Convert simple `if` statements to ternary expressions | 3 |
| [NC-11](#NC-11) | Events that mark critical parameter changes should contain both the old and the new value | 12 |
| [NC-12](#NC-12) | Custom errors should be used rather than `revert()`/`require()` | 68 |
| [NC-13](#NC-13) | Duplicated `require()`/`revert()` checks should be refactored | 12 |
| [NC-14](#NC-14) | `else` block not required | 6 |
| [NC-15](#NC-15) | Enable IR-based code generation | 1 |
| [NC-16](#NC-16) | Names of structs, events, enums and errors should use CapWords style | 8 |
| [NC-17](#NC-17) | Events are emitted without the sender information | 6 |
| [NC-18](#NC-18) | Events may be emitted out of order due to reentrancy | 9 |
| [NC-19](#NC-19) |  Function ordering does not follow the Solidity Style Guide | 56 |
| [NC-20](#NC-20) | Functions and modifiers should be named in mixedCase style | 10 |
| [NC-21](#NC-21) | Functions with array parameters should have length checks in place | 9 |
| [NC-22](#NC-22) | High cyclomatic complexity | 2 |
| [NC-23](#NC-23) | Import declarations should import specific identifiers, rather than the whole file | 32 |
| [NC-24](#NC-24) | Imports could be organized more systematically | 12 |
...
| [NC-27](#NC-27) | Long functions should be refactored into multiple, smaller, functions | 1 |
| [NC-28](#NC-28) | Consider moving `msg.sender` checks to `modifier`s | 23 |
| [NC-29](#NC-29) | Named mappings are recommended | 8 |
| [NC-30](#NC-30) | Named imports of parent contracts are missing | 6 |
| [NC-31](#NC-31) | NatSpec documentation for contract is missing | 8 |
| [NC-32](#NC-32) | Event declarations should have NatSpec descriptions | 8 |
| [NC-33](#NC-33) | NatSpec documentation for function is missing | 117 |
| [NC-34](#NC-34) | Modifier declarations should have NatSpec descriptions | 10 |
| [NC-35](#NC-35) | Missing NatSpec `@param` | 106 |
| [NC-36](#NC-36) | Public variable declarations should have NatSpec descriptions | 33 |
| [NC-37](#NC-37) | NatSpec `@return` is missing | 46 |
| [NC-38](#NC-38) | Function declarations should have `@notice` tags | 117 |
| [NC-39](#NC-39) | There is no need to initialize variables with 0 | 11 |
| [NC-40](#NC-40) | State variables should include comments | 2 |
| [NC-41](#NC-41) | Strings should use double quotes rather than single quotes | 2 |
| [NC-42](#NC-42) | Lines are too long | 161 |
| [NC-43](#NC-43) | Typos | 7 |
| [NC-44](#NC-44) | Consider using `delete` rather than assigning zero/false to clear values | 6 |
| [NC-45](#NC-45) | Solidity compiler version is not fixed | 8 |
| [NC-46](#NC-46) | Use `@inheritdoc` for overridden functions | 3 |
| [NC-47](#NC-47) | Use the latest solidity version for deployment (`0.8.21`) | 8 |
| [NC-48](#NC-48) | Use of `override` is unnecessary | 3 |
| [NC-49](#NC-49) | Returning a struct instead of a bunch of variables is better | 6 |
| [NC-50](#NC-50) | Use a struct to encapsulate multiple function parameters | 9 |
| [NC-51](#NC-51) | Visibility of state variables is not explicitly defined | 6 |
| [NC-52](#NC-52) | Whitespace in Expressions | 11 |
| [NC-53](#NC-53) | Common functions should be refactored to a common base contract | 3 |
| [NC-54](#NC-54) | Names of `private`/`internal` functions should be prefixed with an underscore | 4 |
| [NC-55](#NC-55) | Names of `private`/`internal` state variables should be prefixed with an underscore | 34 |
| [NC-56](#NC-56) |  `require()` / `revert()` statements should have descriptive reason strings | 10 |
| [NC-57](#NC-57) | Variables should be named in mixedCase style | 25 |
| [NC-58](#NC-58) | Event is missing `indexed` fields | 5 |
| [NC-59](#NC-59) | Functions not used internally could be marked `external` | 75 |

## Gas Optimizations


*Total <b>571</b> instances over <b>39</b> issues:*
...
| [GAS-5](#GAS-5) | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function to save gas | 12 | - |
| [GAS-6](#GAS-6) | Events should be emitted outside of loops | 3 | 1125 |
| [GAS-7](#GAS-7) | Low level `call` can be optimized with assembly | 11 | 2728 |
| [GAS-8](#GAS-8) | Multiple accesses of the same mapping/array key/index should be cached | 133 | 5586 |
| [GAS-9](#GAS-9) | Newer versions of solidity are more gas efficient | 8 | - |
| [GAS-10](#GAS-10) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 16 | 48 |
| [GAS-11](#GAS-11) | Optimize names to save gas | 8 | 176 |
| [GAS-12](#GAS-12) | `require()`/`revert()` strings longer than 32 bytes cost extra gas | 7 | 21 |
| [GAS-13](#GAS-13) | The result of a function call should be cached rather than re-calling the function | 6 | 600 |
| [GAS-14](#GAS-14) | Unlimited gas consumption risk due to external call recipients | 6 | - |
| [GAS-15](#GAS-15) | Optimize External Calls with Assembly for Memory Efficiency | 8 | 1760 |
| [GAS-16](#GAS-16) | Use assembly to compute hashes to save gas | 8 | 640 |
| [GAS-17](#GAS-17) | Use assembly to emit events | 12 | 456 |
| [GAS-18](#GAS-18) | Use assembly to validate `msg.sender` | 15 | - |
| [GAS-19](#GAS-19) | Use assembly to write address/contract type storage values | 14 | 700 |
| [GAS-20](#GAS-20) | Using a double `if` statement instead of a logical AND (`&&`) | 28 | 840 |
| [GAS-21](#GAS-21) | Use a more recent version of solidity | 8 | - |
| [GAS-22](#GAS-22) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 13 | 111150 |
| [GAS-23](#GAS-23) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-24](#GAS-24) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-25](#GAS-25) | Use `selfbalance()` instead of `address(this).balance` | 2 | - |
| [GAS-26](#GAS-26) | `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants) | 8 | - |
| [GAS-27](#GAS-27) | Using bools for storage incurs overhead | 13 | 1300 |
| [GAS-28](#GAS-28) | Cache array length outside of loop | 9 | - |
| [GAS-29](#GAS-29) | State variables should be cached in stack variables rather than re-reading them from storage | 31 | 3007 |
| [GAS-30](#GAS-30) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 33 | - |
| [GAS-31](#GAS-31) | Use Custom Errors | 68 | 3400 |
| [GAS-32](#GAS-32) | Don't initialize variables with default value | 11 | - |
| [GAS-33](#GAS-33) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 13 | 715 |
| [GAS-34](#GAS-34) | Constructors can be marked as `payable` to save deployment gas | 7 | 147 |
| [GAS-35](#GAS-35) | Functions guaranteed to revert when called by normal users can be marked `payable` | 1 | 21 |
| [GAS-36](#GAS-36) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 9 | 45 |
| [GAS-37](#GAS-37) | Splitting require() statements that use && saves gas | 10 | - |
| [GAS-38](#GAS-38) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 6 | 24 |
| [GAS-39](#GAS-39) | Using assembly to check for zero can save gas | 5 | 30 |
<a name="M-1"></a> 
...
<details>
<summary>
There are <b>109</b> instances (click to show):
</summary>
...
```
*Github:* [[109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109), [109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109), [109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109), [109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109), [109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109), [109](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L109)]
...
```
*Github:* [[26](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L26), [28](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L28), [42](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L42), [50](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L50)]
...
<a name="L-23"></a> 
### [L-23]  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()`
...
<a name="NC-6"></a> 
### [NC-6] Contract does not follow the Solidity Style Guide's suggested layout ordering
...
```
*Github:* [[105](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L105), [105](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L105), [108](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L108), [112](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L112), [125](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L125), [135](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/AuctionDemo.sol#L135)]
...
```
*Github:* [[463](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L463)]
...
```
*Github:* [[81](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerRNG.sol#L81)]
...
<a name="NC-20"></a> 
### [NC-20] Functions and modifiers should be named in mixedCase style
...
<a name="NC-27"></a> 
### [NC-27] Long functions should be refactored into multiple, smaller, functions
...
<a name="NC-28"></a> 
### [NC-28] Consider moving `msg.sender` checks to `modifier`s
...
<a name="NC-29"></a> 
### [NC-29] Named mappings are recommended
...
<a name="NC-30"></a> 
### [NC-30] Named imports of parent contracts are missing
...
<a name="NC-31"></a> 
### [NC-31] NatSpec documentation for contract is missing
...
<a name="NC-32"></a> 
### [NC-32] Event declarations should have NatSpec descriptions
...
<a name="NC-33"></a> 
### [NC-33] NatSpec documentation for function is missing
...
<a name="NC-34"></a> 
### [NC-34] Modifier declarations should have NatSpec descriptions
...
<a name="NC-36"></a> 
### [NC-36] Public variable declarations should have NatSpec descriptions
...
<a name="NC-37"></a> 
### [NC-37] NatSpec `@return` is missing
...
<a name="NC-38"></a> 
### [NC-38] Function declarations should have `@notice` tags
...
<a name="NC-39"></a> 
### [NC-39] There is no need to initialize variables with 0
...
<a name="NC-40"></a> 
### [NC-40] State variables should include comments
...
<a name="NC-41"></a> 
### [NC-41] Strings should use double quotes rather than single quotes
...
<a name="NC-44"></a> 
### [NC-44] Consider using `delete` rather than assigning zero/false to clear values
...
<a name="NC-45"></a> 
### [NC-45] Solidity compiler version is not fixed
...
<a name="NC-46"></a> 
### [NC-46] Use `@inheritdoc` for overridden functions
...
<a name="NC-47"></a> 
### [NC-47] Use the latest solidity version for deployment (`0.8.21`)
...
<a name="NC-48"></a> 
### [NC-48] Use of `override` is unnecessary
...
<a name="NC-49"></a> 
### [NC-49] Returning a struct instead of a bunch of variables is better
...
<a name="NC-50"></a> 
### [NC-50] Use a struct to encapsulate multiple function parameters
...
<a name="NC-51"></a> 
### [NC-51] Visibility of state variables is not explicitly defined
...
<a name="NC-52"></a> 
### [NC-52] Whitespace in Expressions
...
<a name="NC-53"></a> 
### [NC-53] Common functions should be refactored to a common base contract
...
<a name="NC-54"></a> 
### [NC-54] Names of `private`/`internal` functions should be prefixed with an underscore
...
<a name="NC-55"></a> 
### [NC-55] Names of `private`/`internal` state variables should be prefixed with an underscore
It is recommended by the [Solidity Style Guide](https://docs.soliditylang.org/en/v0.8.20/style-guide.html#underscore-prefix-for-non-external-functions-and-variables)
...
<a name="NC-56"></a> 
### [NC-56]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-57"></a> 
### [NC-57] Variables should be named in mixedCase style
...
```
*Github:* [[181](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L181), [181](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L181), [196](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L196), [196](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L196), [258](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L258), [258](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L258), [276](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L276), [276](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L276), [326](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L326), [326](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L326)]
...
```
*Github:* [[178](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L178), [178](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L178), [189](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L189), [189](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L189), [213](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L213), [213](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L213), [227](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L227), [227](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L227)]
...
```
*Github:* [[55](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L55), [55](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerNXT.sol#L55)]
...
```
*Github:* [[53](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerRNG.sol#L53), [53](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerRNG.sol#L53)]
...
```
*Github:* [[22](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerVRF.sol#L22), [71](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerVRF.sol#L71), [71](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerVRF.sol#L71)]
...
<a name="NC-58"></a> 
### [NC-58] Event is missing `indexed` fields
...
<a name="NC-59"></a> 
### [NC-59] Functions not used internally could be marked `external`
...
<a name="GAS-7"></a> 
### [GAS-7] Low level `call` can be optimized with assembly
...
<a name="GAS-18"></a> 
### [GAS-18] Use assembly to validate `msg.sender`
...
<a name="GAS-25"></a> 
### [GAS-25] Use `selfbalance()` instead of `address(this).balance`
...
<a name="GAS-26"></a> 
### [GAS-26] `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants)
...
<a name="GAS-37"></a> 
### [GAS-37] Splitting require() statements that use && saves gas
