...
*Total <b>39</b> instances over <b>12</b> issues:*
...
| [L-7](#L-7) | Missing zero address check in constructor | 2 |
| [L-8](#L-8) | Consider some checks for `address(0)` when setting address state variables | 2 |
| [L-9](#L-9) | Potential Re-org Attack Vector | 1 |
| [L-10](#L-10) | Use of `tx.origin` is unsafe in almost every context | 2 |
| [L-11](#L-11) | `safeApprove()` is deprecated | 1 |
| [L-12](#L-12) | Unspecific compiler version pragma | 2 |

## Non Critical Issues


*Total <b>320</b> instances over <b>59</b> issues:*
...
| [NC-25](#NC-25) | Magic numbers should be replaced with constants | 17 |
| [NC-26](#NC-26) | Consider moving `msg.sender` checks to `modifier`s | 2 |
| [NC-27](#NC-27) | Named mappings are recommended | 8 |
| [NC-28](#NC-28) | Missing NatSpec from contract declarations | 4 |
| [NC-29](#NC-29) | Missing NatSpec `@author` from contract declaration | 4 |
| [NC-30](#NC-30) | Missing NatSpec `@dev` from contract declaration | 4 |
| [NC-31](#NC-31) | Missing NatSpec `@dev` from event declaration | 12 |
| [NC-32](#NC-32) | Missing NatSpec `@dev` from function declaration | 23 |
| [NC-33](#NC-33) | Missing NatSpec `@dev` from modifier declaration | 1 |
| [NC-34](#NC-34) | Event declarations should have NatSpec descriptions | 12 |
| [NC-35](#NC-35) | NatSpec documentation for function is missing | 5 |
| [NC-36](#NC-36) | Modifier declarations should have NatSpec descriptions | 1 |
| [NC-37](#NC-37) | Public variable declarations should have NatSpec descriptions | 6 |
| [NC-38](#NC-38) | Missing NatSpec `@notice` from contract declaration | 4 |
| [NC-39](#NC-39) | Missing NatSpec `@notice` from event declaration | 12 |
| [NC-40](#NC-40) | Missing NatSpec `@notice` from function declaration | 5 |
| [NC-41](#NC-41) | Missing NatSpec `@notice` from modifier declaration | 1 |
| [NC-42](#NC-42) | Missing NatSpec `@param` from event declaration | 12 |
| [NC-43](#NC-43) | Missing NatSpec `@param` from function declaration | 7 |
| [NC-44](#NC-44) | Missing NatSpec `@return` from function declaration | 9 |
| [NC-45](#NC-45) | Missing NatSpec `@title` from contract declaration | 4 |
| [NC-46](#NC-46) | Using `>` or `>=` without specifying an upper bound is unsafe | 2 |
| [NC-47](#NC-47) | State variables should include comments | 7 |
| [NC-48](#NC-48) | Lines are too long | 12 |
...
| [NC-52](#NC-52) | Solidity compiler version is not fixed | 2 |
...
| [NC-55](#NC-55) | Use the latest solidity version for deployment (`0.8.23`) | 4 |
...
| [NC-59](#NC-59) | Event is missing `indexed` fields | 11 |

## Gas Optimizations


*Total <b>153</b> instances over <b>33</b> issues:*
...
| [GAS-17](#GAS-17) | Optimize External Calls with Assembly for Memory Efficiency | 9 | 1980 |
...
<a name="L-9"></a> 
### [L-9] Potential Re-org Attack Vector
...
```
*Github:* [[34](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L34)]



<a name="L-10"></a> 
### [L-10] Use of `tx.origin` is unsafe in almost every context
...
```
*Github:* [[36](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L36)]
...
```
*Github:* [[11](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L11), [19](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L19)]
...
```
*Github:* [[26](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L26), [26](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L26), [28](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L28)]
...
```
*Github:* [[24](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L24), [33](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L33)]
...
5: import {Ownable2Step} from "/home/myubuntu/Desktop/2023-11-canto/asD/lib/openzeppelin-contracts/contracts/access/Ownable2Step.sol";

```
*Github:* [[5](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L5)]
...
```
*Github:* [[96](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/Market.sol#L96), [96](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/Market.sol#L96), [96](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/Market.sol#L96)]
...
```
*Github:* [[40](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L40), [40](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L40), [40](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L40)]
...
```
*Github:* [[29](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L29), [29](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L29), [29](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L29)]
...
```
*Github:* [[33](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L33), [33](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L33)]
