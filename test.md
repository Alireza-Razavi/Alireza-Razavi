...
Audit report for **2023-08-dopex** generated by *ubl4nk_bot*.
...
Total <b>666</b> instances over <b>51</b> issues:
...
| [NC-18](#NC-18) |  Function ordering does not follow the Solidity Style Guide | 55 |
...
/// @audit internal function `_sendTokensToRdpxV2Core` came earlier from this external function
...
/// @audit internal function `_sendTokensToRdpxV2Core` came earlier from this public function
...
/// @audit public function `liquidityInPool` came earlier from this external function
/// @audit public function `numPositions` came earlier from this external function
119:   function collectFees() external onlyRole(DEFAULT_ADMIN_ROLE) {

/// @audit public function `liquidityInPool` came earlier from this external function
/// @audit public function `numPositions` came earlier from this external function
/// @audit public function `approveTarget` came earlier from this external function
/// @audit public function `addLiquidity` came earlier from this external function
/// @audit public function `removeLiquidity` came earlier from this external function
/// @audit public function `swap` came earlier from this external function
...
/// @audit internal function `_purchaseOptions` came earlier from this external function
/// @audit internal function `_issueBond` came earlier from this external function
/// @audit internal function `_curveSwap` came earlier from this external function
/// @audit internal function `_stake` came earlier from this external function
/// @audit internal function `_calculateAmounts` came earlier from this external function
/// @audit internal function `_transfer` came earlier from this external function
/// @audit internal function `_bondWithDelegate` came earlier from this external function
/// @audit internal function `_validate` came earlier from this external function
764:   function settle(
...
/// @audit internal function `_purchaseOptions` came earlier from this public function
/// @audit internal function `_issueBond` came earlier from this public function
/// @audit internal function `_curveSwap` came earlier from this public function
/// @audit internal function `_stake` came earlier from this public function
/// @audit internal function `_calculateAmounts` came earlier from this public function
/// @audit internal function `_transfer` came earlier from this public function
/// @audit internal function `_bondWithDelegate` came earlier from this public function
/// @audit internal function `_validate` came earlier from this public function
...
/// @audit internal function `_bondWithDelegate` came earlier from this external function
/// @audit internal function `_validate` came earlier from this external function
/// @audit public function `bondWithDelegate` came earlier from this external function
/// @audit public function `bond` came earlier from this external function
...
/// @audit public function `bondWithDelegate` came earlier from this external function
/// @audit public function `bond` came earlier from this external function
/// @audit public function `getReserveTokenInfo` came earlier from this external function
/// @audit public function `calculateBondCost` came earlier from this external function
/// @audit public function `getLpPrice` came earlier from this external function
/// @audit public function `getDpxEthPrice` came earlier from this external function
/// @audit public function `getEthPrice` came earlier from this external function
/// @audit public function `getRdpxPrice` came earlier from this external function
...
/// @audit private function `_mintToken` came earlier from this public function
139:   function decreaseAmount(

/// @audit private function `_mintToken` came earlier from this external function
/// @audit public function `decreaseAmount` came earlier from this external function
151:   function getBondsOwned(

/// @audit private function `_mintToken` came earlier from this internal function
...
/// @audit public function `updateFunding` came earlier from this external function
243:   function setLpAllowance(bool increase) external onlyRole(DEFAULT_ADMIN_ROLE) {
...
/// @audit private function `_mintOptionToken` came earlier from this internal function
/// @audit private function `_updateFundingRate` came earlier from this internal function
/// @audit private function `_validate` came earlier from this internal function
635:   function _beforeTokenTransfer(

/// @audit private function `_mintOptionToken` came earlier from this public function
/// @audit private function `_updateFundingRate` came earlier from this public function
/// @audit private function `_validate` came earlier from this public function
/// @audit internal function `_beforeTokenTransfer` came earlier from this public function
...
/// @audit internal function `_convertToAssets` came earlier from this public function
/// @audit internal function `_beforeTokenTransfer` came earlier from this public function
