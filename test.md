...
Total <b>493</b> instances over <b>49</b> issues:
...
| [NC-6](#NC-6) | Convert simple `if` statements to ternary expressions | 1 |
| [NC-7](#NC-7) | Events that mark critical parameter changes should contain both the old and the new value | 23 |
| [NC-8](#NC-8) | Custom errors has no error details | 1 |
| [NC-9](#NC-9) | Custom errors should be used rather than `revert()`/`require()` | 25 |
| [NC-10](#NC-10) | Duplicated `require()`/`revert()` checks should be refactored | 1 |
| [NC-11](#NC-11) | `else` block not required | 2 |
| [NC-12](#NC-12) | Enable IR-based code generation | 1 |
| [NC-13](#NC-13) | Events are emitted without the sender information | 9 |
| [NC-14](#NC-14) | Functions and modifiers should be named in mixedCase style | 2 |
| [NC-15](#NC-15) | Functions with array parameters should have length checks in place | 3 |
| [NC-16](#NC-16) | Import declarations should import specific identifiers, rather than the whole file | 52 |
| [NC-17](#NC-17) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-18](#NC-18) | Missing zero address check in functions with address parameters | 63 |
| [NC-19](#NC-19) | Consider moving `msg.sender` checks to `modifier`s | 9 |
| [NC-20](#NC-20) | Named mappings are recommended | 9 |
| [NC-21](#NC-21) | NatSpec documentation for contract is missing | 3 |
| [NC-22](#NC-22) | Event declarations should have NatSpec descriptions | 13 |
| [NC-23](#NC-23) | NatSpec documentation for function is missing | 31 |
| [NC-24](#NC-24) | Modifier declarations should have NatSpec descriptions | 6 |
| [NC-25](#NC-25) | Missing NatSpec `@param` | 38 |
| [NC-26](#NC-26) | Public variable declarations should have NatSpec descriptions | 6 |
| [NC-27](#NC-27) | NatSpec `@return` is missing | 46 |
| [NC-28](#NC-28) | Redundant inheritance specifier | 1 |
| [NC-29](#NC-29) | Redundant `return` statement in a function with named return variables | 2 |
| [NC-30](#NC-30) | State variables should include comments | 1 |
| [NC-31](#NC-31) | Contract declarations should have NatSpec `@title` annotations | 2 |
| [NC-32](#NC-32) | Lines are too long | 2 |
| [NC-33](#NC-33) | Unused named return | 1 |
| [NC-34](#NC-34) | Unused contract variables | 1 |
| [NC-35](#NC-35) | Consider using `delete` rather than assigning zero to clear values | 5 |
| [NC-36](#NC-36) | Solidity compiler version is not fixed | 1 |
| [NC-37](#NC-37) | Expressions for constant values should use `immutable` rather than `constant` | 1 |
| [NC-38](#NC-38) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-39](#NC-39) | Use the latest solidity version for deployment | 9 |
| [NC-40](#NC-40) | Use `type(X).max` instead of constant formulas like `2**n` | 1 |
| [NC-41](#NC-41) | Visibility of state variables is not explicitly defined | 1 |
| [NC-42](#NC-42) | Whitespace in Expressions | 5 |
| [NC-43](#NC-43) | Common functions should be refactored to a common base contract | 2 |
| [NC-44](#NC-44) | Names of `private`/`internal` functions should be prefixed with an underscore | 32 |
| [NC-45](#NC-45) | Names of `private`/`internal` state variables should be prefixed with an underscore | 6 |
| [NC-46](#NC-46) | Variables should be named in mixedCase style | 1 |
| [NC-47](#NC-47) | `TODO`s left in the code | 1 |
| [NC-48](#NC-48) | Event is missing `indexed` fields | 12 |
| [NC-49](#NC-49) | Functions not used internally could be marked external | 17 |

## Gas Optimizations


Total <b>274</b> instances over <b>28</b> issues:

|ID|Issue|Instances|Gas|
|-|:-|:-:|:-:|
| [GAS-1](#GAS-1) | Consider activating via-ir for deploying | 1 | - |
| [GAS-2](#GAS-2) | Operator `+=` costs more gas than `<x> = <x> + <y>` for state variables | 7 | 791 |
| [GAS-3](#GAS-3) | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function to save gas | 1 | - |
| [GAS-4](#GAS-4) | `internal` functions only called once can be inlined to save gas | 15 | 450 |
| [GAS-5](#GAS-5) | `keccak256()` hash of literals should only be computed once | 13 | 546 |
| [GAS-6](#GAS-6) | Multiple accesses of the same mapping/array key/index should be cached | 3 | 126 |
| [GAS-7](#GAS-7) | Newer versions of solidity are more gas efficient | 9 | - |
| [GAS-8](#GAS-8) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 34 | 102 |
| [GAS-9](#GAS-9) | Reduce gas usage by moving to Solidity 0.8.19 or later | 9 | 9000 |
| [GAS-10](#GAS-10) | Redundant state variable getters | 1 | - |
| [GAS-11](#GAS-11) | Remove or replace unused state variables | 1 | - |
| [GAS-12](#GAS-12) | `require()`/`revert()` strings longer than 32 bytes cost extra gas | 9 | 27 |
| [GAS-13](#GAS-13) | The result of a function call should be cached rather than re-calling the function | 12 | 1200 |
| [GAS-14](#GAS-14) | Unused named return variables without optimizer waste gas | 1 | 9 |
| [GAS-15](#GAS-15) | Use assembly to compute hashes to save gas | 13 | 1040 |
| [GAS-16](#GAS-16) | Use assembly to emit events | 24 | 912 |
| [GAS-17](#GAS-17) | Using a double `if` statement instead of a logical AND (`&&`) | 9 | 270 |
| [GAS-18](#GAS-18) | Use a more recent version of solidity | 9 | - |
| [GAS-19](#GAS-19) | State variables should be cached in stack variables rather than re-reading them from storage | 5 | 485 |
| [GAS-20](#GAS-20) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 2 | - |
| [GAS-21](#GAS-21) | Use Custom Errors | 25 | 1250 |
| [GAS-22](#GAS-22) | Don't use `SafeMath` once the solidity version is 0.8.0 or greater | 2 | - |
...
<a name="NC-6"></a> 
#### [NC-6] Convert simple `if` statements to ternary expressions
...
```
[#L374](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L374) 
...
<a name="NC-7"></a> 
#### [NC-7] Events that mark critical parameter changes should contain both the old and the new value
...
<a name="NC-9"></a> 
#### [NC-9] Custom errors should be used rather than `revert()`/`require()`
...
<a name="NC-14"></a> 
#### [NC-14] Functions and modifiers should be named in mixedCase style
...
<a name="NC-15"></a> 
#### [NC-15] Functions with array parameters should have length checks in place
...
```
[#L132](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/LivepeerGovernor.sol#L132) [#L142](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/LivepeerGovernor.sol#L142) 
...
```
[#L43](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/LivepeerGovernor.sol#L43) 
...
<a name="NC-19"></a> 
#### [NC-19] Consider moving `msg.sender` checks to `modifier`s
...
```
[#L52](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L52) [#L56](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L56) 
...
<a name="NC-22"></a> 
#### [NC-22] Event declarations should have NatSpec descriptions
...
<a name="NC-23"></a> 
#### [NC-23] NatSpec documentation for function is missing
...
<a name="NC-24"></a> 
#### [NC-24] Modifier declarations should have NatSpec descriptions
...
<a name="NC-26"></a> 
#### [NC-26] Public variable declarations should have NatSpec descriptions
...
<a name="NC-28"></a> 
#### [NC-28] Redundant inheritance specifier
...
<a name="NC-29"></a> 
#### [NC-29] Redundant `return` statement in a function with named return variables
...
```
[#L85](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L85) 
...
<a name="NC-40"></a> 
#### [NC-40] Use `type(X).max` instead of constant formulas like `2**n`
...
```
[#L154](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L154) [#L156](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L156) [#L158](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L158) [#L193](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L193) [#L202](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L202) [#L204](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L204) [#L207](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/treasury/GovernorCountingOverridable.sol#L207) 
...
<a name="GAS-5"></a> 
#### [GAS-5] `keccak256()` hash of literals should only be computed once
...
```
[#L282](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L282) [#L829](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L829) [#L856](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L856) 
...
<a name="GAS-7"></a> 
#### [GAS-7] Newer versions of solidity are more gas efficient
...
```
[#L1136](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L1136) 
...
<a name="GAS-11"></a> 
#### [GAS-11] Remove or replace unused state variables
...
<a name="GAS-12"></a> 
#### [GAS-12] `require()`/`revert()` strings longer than 32 bytes cost extra gas
...
```
[#L254](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L254) [#L491](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L491) [#L499](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L499) [#L606](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L606) [#L754](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L754) [#L755](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L755) [#L850](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L850) [#L851](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L851) [#L1177](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L1177) 
...
/// `delegatorStatus` is called 2 times
537:     function bondForWithHint(
             uint256 _amount,
             address _owner,
             address _to,
...
```
[#L258](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L258) [#L303](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L303) [#L325](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L325) [#L422](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L422) [#L553](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingVotes.sol#L553) 
...
<a name="GAS-19"></a> 
#### [GAS-19] State variables should be cached in stack variables rather than re-reading them from storage
...
```
[#L466](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L466) [#L466](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L466) [#L690](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L690) [#L1430](https://github.com/code-423n4/2023-08-livepeer/blob/bcf493b98d0ef835e969e637f25ea51ab77fabb6/contracts/bonding/BondingManager.sol#L1430) 
...
<a name="GAS-22"></a> 
#### [GAS-22] Don't use `SafeMath` once the solidity version is 0.8.0 or greater
...
<a name="GAS-27"></a> 
#### [GAS-27] Using assembly to check for zero can save gas
...
<a name="GAS-28"></a> 
#### [GAS-28] `internal` functions not called by the contract should be removed
