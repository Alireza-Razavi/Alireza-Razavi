...
*Total <b>276</b> instances over <b>14</b> issues:*
...
| [L-6](#L-6) | Code does not follow the best practice of check-effects-interaction | 11 |
| [L-7](#L-7) | Governance functions should be controlled by time locks | 1 |
| [L-8](#L-8) | Loss of precision in divisions | 124 |
| [L-9](#L-9) | Check storage gap for upgradable contracts | 2 |
| [L-10](#L-10) | Multiplication on the result of a division | 1 |
| [L-11](#L-11) | Prevent re-setting a state variable with the same value | 1 |
| [L-12](#L-12) | Timestamp may be manipulation | 3 |
| [L-13](#L-13) | Missing zero address check in initializer | 2 |
| [L-14](#L-14) | Initializers could be front-run | 2 |

## Non Critical Issues


*Total <b>391</b> instances over <b>48</b> issues:*
...
| [NC-8](#NC-8) | Contract should expose an `interface` | 33 |
| [NC-9](#NC-9) | Contracts should have full test coverage | 1 |
| [NC-10](#NC-10) | Events that mark critical parameter changes should contain both the old and the new value | 15 |
| [NC-11](#NC-11) | Custom errors has no error details | 17 |
| [NC-12](#NC-12) | Polymorphic functions make security audits more time-consuming and error-prone | 1 |
| [NC-13](#NC-13) | Duplicated `require()`/`revert()` checks should be refactored | 1 |
| [NC-14](#NC-14) | `else` block not required | 3 |
| [NC-15](#NC-15) | Enable IR-based code generation | 1 |
| [NC-16](#NC-16) | Events are emitted without the sender information | 13 |
| [NC-17](#NC-17) | Events may be emitted out of order due to reentrancy | 8 |
| [NC-18](#NC-18) | Events should use parameters to convey information | 2 |
| [NC-19](#NC-19) | High cyclomatic complexity | 2 |
| [NC-20](#NC-20) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-21](#NC-21) | Long functions should be refactored into multiple, smaller, functions | 2 |
| [NC-22](#NC-22) | Magic numbers should be replaced with constants | 19 |
| [NC-23](#NC-23) | Missing zero address check in functions with address parameters | 42 |
| [NC-24](#NC-24) | Named mappings are recommended | 11 |
| [NC-25](#NC-25) | NatSpec documentation for contract is missing | 6 |
| [NC-26](#NC-26) | Missing NatSpec `@param` | 6 |
| [NC-27](#NC-27) | NatSpec `@return` is missing | 4 |
| [NC-28](#NC-28) | There is no need to initialize variables with 0 | 13 |
| [NC-29](#NC-29) | Put all system-wide constants in one file | 12 |
| [NC-30](#NC-30) | Redundant `return` statement in a function with named return variables | 5 |
| [NC-31](#NC-31) | State variables should include comments | 1 |
| [NC-32](#NC-32) | Contract declarations should have NatSpec `@title` annotations | 6 |
| [NC-33](#NC-33) | Lines are too long | 6 |
| [NC-34](#NC-34) | Typos | 10 |
| [NC-35](#NC-35) | Unused errors | 1 |
| [NC-36](#NC-36) | Unused `event` definition | 3 |
| [NC-37](#NC-37) | Unused named return | 4 |
| [NC-38](#NC-38) | Consider using `delete` rather than assigning zero/false to clear values | 12 |
| [NC-39](#NC-39) | Solidity compiler version is not fixed | 1 |
| [NC-40](#NC-40) | Expressions for constant values should use `immutable` rather than `constant` | 12 |
| [NC-41](#NC-41) | Use the latest solidity version for deployment | 6 |
| [NC-42](#NC-42) | Whitespace in Expressions | 1 |
| [NC-43](#NC-43) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-44](#NC-44) | Names of `private`/`internal` functions should be prefixed with an underscore | 9 |
| [NC-45](#NC-45) | Names of `private`/`internal` state variables should be prefixed with an underscore | 4 |
| [NC-46](#NC-46) | Variables should be named in mixedCase style | 16 |
| [NC-47](#NC-47) | Event is missing `indexed` fields | 8 |
| [NC-48](#NC-48) | Constants should be defined rather than using magic numbers | 20 |

## Gas Optimizations


*Total <b>401</b> instances over <b>34</b> issues:*
...
| [GAS-7](#GAS-7) | Increments can be `unchecked` to save gas | 3 | 180 |
| [GAS-8](#GAS-8) | Initializers can be marked as payable to save deployment gas | 2 | 42 |
| [GAS-9](#GAS-9) | `internal` functions only called once can be inlined to save gas | 6 | 180 |
| [GAS-10](#GAS-10) | Multiple accesses of the same mapping/array key/index should be cached | 5 | 210 |
| [GAS-11](#GAS-11) | Newer versions of solidity are more gas efficient | 6 | - |
| [GAS-12](#GAS-12) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 40 | 120 |
...
| [GAS-17](#GAS-17) | Use assembly to emit events | 16 | 608 |
| [GAS-18](#GAS-18) | Use assembly to write address/contract type storage values | 8 | 400 |
| [GAS-19](#GAS-19) | Using a double `if` statement instead of a logical AND (`&&`) | 9 | 270 |
| [GAS-20](#GAS-20) | Use a more recent version of solidity | 6 | - |
...
| [GAS-23](#GAS-23) | Using bools for storage incurs overhead | 1 | - |
| [GAS-24](#GAS-24) | Cache array length outside of loop | 10 | - |
| [GAS-25](#GAS-25) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 1 | - |
| [GAS-26](#GAS-26) | Don't initialize variables with default value | 13 | - |
| [GAS-27](#GAS-27) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 14 | 770 |
| [GAS-28](#GAS-28) | Constructors can be marked as `payable` to save deployment gas | 2 | 42 |
| [GAS-29](#GAS-29) | Functions guaranteed to revert when called by normal users can be marked `payable` | 3 | 63 |
| [GAS-30](#GAS-30) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 13 | 65 |
| [GAS-31](#GAS-31) | Using `private` rather than `public` for constants, saves gas | 4 | - |
| [GAS-32](#GAS-32) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 11 | 44 |
| [GAS-33](#GAS-33) | Using assembly to check for zero can save gas | 35 | 210 |
| [GAS-34](#GAS-34) | `internal` functions not called by the contract should be removed | 8 | - |
...
/// @audit `.markets(..)` is called earlier
...
/// @audit `.getUnreleasedFunds(..)` is called earlier
/// @audit `.accrueTokens(..)` is called earlier
/// @audit `.tokenAmountAccrued(..)` is called earlier
...
/// @audit `.balanceOf(..)` is called earlier
/// @audit `.releaseFunds(..)` is called earlier
/// @audit `.balanceOf(..)` is called earlier
/// @audit `.releaseFunds(..)` is called earlier
688:                 unreleasedPLPIncome[underlying] = 0;

```
*Github:* [[295](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L295), [296](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L296), [297](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L297), [298](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L298), [299](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L299), [301](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L301), [580](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L580), [581](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L581), [588](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L588), [688](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L688)]
...
```
*Github:* [[270](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L270)]
...
<a name="L-9"></a> 
### [L-9] Check storage gap for upgradable contracts
...
```
*Github:* [[90](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L90), [118](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L118), [132](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L132), [141](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L141), [153](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L153), [177](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L177), [192](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L192), [216](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L216), [232](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L232), [249](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L249), [276](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L276)]
...
```
*Github:* [[433](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L433)]
...
/// @audit `.markets(..)` is called before emit
...
/// @audit `.releaseFunds(..)` is called before emit
...
```
*Github:* [[292](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L292), [682](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L682), [685](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L685), [686](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L686), [687](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L687), [692](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L692)]
...
```
*Github:* [[217](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L217), [259](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L259)]
...
```
*Github:* [[174](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L174)]
...
```
*Github:* [[111](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L111)]
...
```
*Github:* [[47](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L47), [74](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L74)]
...
```
*Github:* [[42](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeStorage.sol#L42), [45](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeStorage.sol#L45), [72](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeStorage.sol#L72), [109](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeStorage.sol#L109), [113](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeStorage.sol#L113)]
...
```
*Github:* [[295](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L295), [298](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L298), [376](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L376), [401](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L401), [460](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L460), [677](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L677), [688](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L688), [736](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L736), [737](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L737), [750](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L750), [751](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L751)]
...
```
*Github:* [[200](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/PrimeLiquidityProvider.sol#L200)]
...
```
*Github:* [[153](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L153), [155](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L155), [157](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L157), [158](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L158), [159](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L159), [160](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L160), [559](https://github.com/code-423n4/2023-09-venus/blob/b11d9ef9db8237678567e66759003138f2368d23/contracts/Tokens/Prime/Prime.sol#L559)]
