...
*Total <b>478</b> instances over <b>54</b> issues:*
...
| [NC-9](#NC-9) | Consider using descriptive `constant`s when passing zero as a function argument | 29 |
...
| [NC-16](#NC-16) | Events that mark critical parameter changes should contain both the old and the new value | 14 |
| [NC-17](#NC-17) | Custom errors has no error details | 30 |
| [NC-18](#NC-18) | Custom errors should be used rather than `revert()`/`require()` | 4 |
| [NC-19](#NC-19) | Polymorphic functions make security audits more time-consuming and error-prone | 3 |
| [NC-20](#NC-20) | Duplicated `require()`/`revert()` checks should be refactored | 3 |
| [NC-21](#NC-21) | Empty bytes check is missing | 17 |
| [NC-22](#NC-22) | Enable IR-based code generation | 1 |
| [NC-23](#NC-23) | Events are emitted without the sender information | 8 |
| [NC-24](#NC-24) | Events may be emitted out of order due to reentrancy | 19 |
| [NC-25](#NC-25) |  Function ordering does not follow the Solidity Style Guide | 2 |
| [NC-26](#NC-26) | Functions with array parameters should have length checks in place | 5 |
| [NC-27](#NC-27) | Import declarations should import specific identifiers, rather than the whole file | 3 |
...
| [NC-30](#NC-30) | Missing zero address check in functions with address parameters | 47 |
| [NC-31](#NC-31) | Consider moving `msg.sender` checks to `modifier`s | 1 |
| [NC-32](#NC-32) | Named mappings are recommended | 3 |
| [NC-33](#NC-33) | Event declarations should have NatSpec descriptions | 15 |
| [NC-34](#NC-34) | NatSpec documentation for function is missing | 13 |
| [NC-35](#NC-35) | Missing NatSpec `@param` | 14 |
| [NC-36](#NC-36) | NatSpec `@return` is missing | 4 |
| [NC-37](#NC-37) | There is no need to initialize variables with 0 | 2 |
| [NC-38](#NC-38) | Put all system-wide constants in one file | 37 |
| [NC-39](#NC-39) | Lines are too long | 7 |
| [NC-40](#NC-40) | Typos | 4 |
| [NC-41](#NC-41) | Unused `error` definition | 1 |
| [NC-42](#NC-42) | Unused `event` definition | 1 |
| [NC-43](#NC-43) | Unused named return | 2 |
| [NC-44](#NC-44) | Unused contract variables | 8 |
| [NC-45](#NC-45) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-46](#NC-46) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-47](#NC-47) | Use the latest solidity version for deployment | 16 |
| [NC-48](#NC-48) | Use of `override` is unnecessary | 10 |
| [NC-49](#NC-49) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-50](#NC-50) | Common functions should be refactored to a common base contract | 4 |
| [NC-51](#NC-51) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-52](#NC-52) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-53](#NC-53) | Event is missing `indexed` fields | 4 |
| [NC-54](#NC-54) | Functions not used internally could be marked `external` | 4 |
...
```
*Github:* [[101](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L101), [148](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L148)]
...
```
*Github:* [[86](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/ConsoleFallbackHandler.sol#L86)]
...
```
*Github:* [[73](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/PolicyValidator.sol#L73), [108](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/PolicyValidator.sol#L108)]
...
```
*Github:* [[61](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L61), [88](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L88), [123](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L123), [140](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L140), [155](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L155), [157](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L157), [177](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L177), [185](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L185), [200](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L200), [202](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L202), [244](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeDeployer.sol#L244)]
...
```
*Github:* [[64](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L64), [72](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L72), [73](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L73), [89](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L89), [91](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/libraries/SafeHelper.sol#L91)]
...
<a name="NC-30"></a> 
### [NC-30] Missing zero address check in functions with address parameters
...
<a name="NC-33"></a> 
### [NC-33] Event declarations should have NatSpec descriptions
...
<a name="NC-34"></a> 
### [NC-34] NatSpec documentation for function is missing
...
<a name="NC-36"></a> 
### [NC-36] NatSpec `@return` is missing
...
<a name="NC-45"></a> 
### [NC-45] Expressions for constant values should use `immutable` rather than `constant`
...
<a name="NC-47"></a> 
### [NC-47] Use the latest solidity version for deployment
...
<a name="NC-49"></a> 
### [NC-49] Missing checks for `address(0)` when assigning values to address state variables
...
<a name="NC-50"></a> 
### [NC-50] Common functions should be refactored to a common base contract
...
<a name="NC-51"></a> 
### [NC-51] Names of `private`/`internal` functions should be prefixed with an underscore
