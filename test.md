...
*Total <b>146</b> instances over <b>27</b> issues:*
...
| [L-18](#L-18) | Unsafe downcast | 12 |
| [L-19](#L-19) | Unsafe solidity low-level call can cause gas grief attack | 6 |
| [L-20](#L-20) | Use of `ecrecover` is susceptible to signature malleability | 1 |
| [L-21](#L-21) | Use of `tx.origin` is unsafe in almost every context | 1 |
| [L-22](#L-22) | Consider using `ERC721A` instead of `ERC721` | 1 |
| [L-23](#L-23) | Using zero as a parameter | 18 |
| [L-24](#L-24) | Missing zero address check in initializer | 1 |
| [L-25](#L-25) | Empty body - Consider commenting why | 1 |
| [L-26](#L-26) | Initializers could be front-run | 2 |
...
*Total <b>571</b> instances over <b>50</b> issues:*
...
| [GAS-4](#GAS-4) | Don't caching global special variables | 1 | 12 |
| [GAS-5](#GAS-5) | Do not calculate constants | 1 | - |
| [GAS-6](#GAS-6) | Operator `+=` costs more gas than `<x> = <x> + <y>` for state variables | 17 | 1921 |
| [GAS-7](#GAS-7) | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function to save gas | 8 | - |
| [GAS-8](#GAS-8) | Events should be emitted outside of loops | 2 | 750 |
| [GAS-9](#GAS-9) | Increments can be `unchecked` to save gas | 13 | 780 |
| [GAS-10](#GAS-10) | Initializers can be marked as payable to save deployment gas | 2 | 42 |
| [GAS-11](#GAS-11) | Inline `modifier`s that are only used once, to save gas | 5 | - |
| [GAS-12](#GAS-12) | `internal` functions only called once can be inlined to save gas | 9 | 270 |
| [GAS-13](#GAS-13) | `keccak256()` hash of literals should only be computed once | 5 | 210 |
| [GAS-14](#GAS-14) | Low level `call` can be optimized with assembly | 3 | 744 |
| [GAS-15](#GAS-15) | Multiple accesses of the same mapping/array key/index should be cached | 7 | 294 |
| [GAS-16](#GAS-16) | Newer versions of solidity are more gas efficient | 10 | - |
| [GAS-17](#GAS-17) | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 45 | 135 |
| [GAS-18](#GAS-18) | Optimize Gas by splitting `if() revert` statements | 2 | - |
| [GAS-19](#GAS-19) | Optimize names to save gas | 5 | 110 |
| [GAS-20](#GAS-20) | Redundant state variable getters | 1 | - |
| [GAS-21](#GAS-21) | Remove or replace unused state variables | 3 | - |
| [GAS-22](#GAS-22) | The result of a function call should be cached rather than re-calling the function | 5 | 500 |
| [GAS-23](#GAS-23) | Unlimited gas consumption risk due to external call recipients | 3 | - |
| [GAS-24](#GAS-24) | Unused named return variables without optimizer waste gas | 14 | 126 |
| [GAS-25](#GAS-25) | Optimize External Calls with Assembly for Memory Efficiency | 2 | 440 |
| [GAS-26](#GAS-26) | Use assembly to compute hashes to save gas | 14 | 1120 |
| [GAS-27](#GAS-27) | Use assembly to emit events | 39 | 1482 |
| [GAS-28](#GAS-28) | Use assembly to validate `msg.sender` | 6 | - |
| [GAS-29](#GAS-29) | Use assembly to write address/contract type storage values | 10 | 500 |
| [GAS-30](#GAS-30) | Using a double `if` statement instead of a logical AND (`&&`) | 23 | 690 |
| [GAS-31](#GAS-31) | Use local variables for emitting | 1 | 97 |
| [GAS-32](#GAS-32) | Use a more recent version of solidity | 10 | - |
| [GAS-33](#GAS-33) | Use `storage` instead of `memory` for structs/arrays | 1 | 4200 |
| [GAS-34](#GAS-34) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 8 | 68400 |
| [GAS-35](#GAS-35) | Using bitmap to store bool states can save gas | 3 | - |
| [GAS-36](#GAS-36) | Using `constant`s directly, rather than caching the value, saves gas | 5 | - |
| [GAS-37](#GAS-37) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-38](#GAS-38) | Use `selfbalance()` instead of `address(this).balance` | 1 | - |
| [GAS-39](#GAS-39) | Using bools for storage incurs overhead | 8 | 800 |
| [GAS-40](#GAS-40) | Cache array length outside of loop | 7 | - |
| [GAS-41](#GAS-41) | State variables should be cached in stack variables rather than re-reading them from storage | 5 | 485 |
| [GAS-42](#GAS-42) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 15 | - |
| [GAS-43](#GAS-43) | Don't initialize variables with default value | 4 | - |
| [GAS-44](#GAS-44) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 140 | 7700 |
| [GAS-45](#GAS-45) | Constructors can be marked as `payable` to save deployment gas | 4 | 84 |
| [GAS-46](#GAS-46) | Functions guaranteed to revert when called by normal users can be marked `payable` | 3 | 63 |
| [GAS-47](#GAS-47) | Use shift Right/Left instead of division/multiplication if possible | 1 | - |
| [GAS-48](#GAS-48) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 10 | 40 |
| [GAS-49](#GAS-49) | Using assembly to check for zero can save gas | 62 | 372 |
| [GAS-50](#GAS-50) | `internal` functions not called by the contract should be removed | 1 | - |
...
```
*Github:* [[565](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L565), [651](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L651), [734](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L734), [737](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L737), [745](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L745), [813](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L813), [954](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L954), [988](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L988), [1011](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L1011), [1086](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L1086)]
...
```
*Github:* [[372](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernanceNFT.sol#L372)]
...
<a name="L-20"></a> 
### [L-20] Use of `ecrecover` is susceptible to signature malleability
...
<a name="L-21"></a> 
### [L-21] Use of `tx.origin` is unsafe in almost every context
...
<a name="GAS-4"></a> 
### [GAS-4] Don't caching global special variables
...
```
*Github:* [[210](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/crowdfund/InitialETHCrowdfund.sol#L210)]
...
```
*Github:* [[186](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/party/PartyGovernance.sol#L186)]
...
<a name="GAS-8"></a> 
### [GAS-8] Events should be emitted outside of loops
...
<a name="GAS-10"></a> 
### [GAS-10] Initializers can be marked as payable to save deployment gas
...
```
*Github:* [[29](https://github.com/code-423n4/2023-10-party/blob/053fb9345b0739b3c26d12e1eae1eefbfd70b223/contracts/utils/Implementation.sol#L29)]
...
<a name="GAS-16"></a> 
### [GAS-16] Newer versions of solidity are more gas efficient
...
<a name="GAS-17"></a> 
### [GAS-17] Operator `>=`/`<=` costs less gas than operator `>`/`<`
...
<a name="GAS-18"></a> 
### [GAS-18] Optimize Gas by splitting `if() revert` statements
...
<a name="GAS-21"></a> 
### [GAS-21] Remove or replace unused state variables
...
<a name="GAS-22"></a> 
### [GAS-22] The result of a function call should be cached rather than re-calling the function
...
<a name="GAS-23"></a> 
### [GAS-23] Unlimited gas consumption risk due to external call recipients
...
<a name="GAS-24"></a> 
### [GAS-24] Unused named return variables without optimizer waste gas
...
<a name="GAS-25"></a> 
### [GAS-25] Optimize External Calls with Assembly for Memory Efficiency
...
<a name="GAS-31"></a> 
### [GAS-31] Use local variables for emitting
...
<a name="GAS-33"></a> 
### [GAS-33] Use `storage` instead of `memory` for structs/arrays
...
<a name="GAS-34"></a> 
### [GAS-34] Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes
...
<a name="GAS-35"></a> 
### [GAS-35] Using bitmap to store bool states can save gas
...
<a name="GAS-36"></a> 
### [GAS-36] Using `constant`s directly, rather than caching the value, saves gas
...
<a name="GAS-37"></a> 
### [GAS-37] Using `this` to access functions results in an external call, wasting gas
...
<a name="GAS-39"></a> 
### [GAS-39] Using bools for storage incurs overhead
...
<a name="GAS-40"></a> 
### [GAS-40] Cache array length outside of loop
...
<a name="GAS-41"></a> 
### [GAS-41] State variables should be cached in stack variables rather than re-reading them from storage
...
<a name="GAS-42"></a> 
### [GAS-42] Use `calldata` instead of `memory` for function arguments that do not get mutated
...
<a name="GAS-46"></a> 
### [GAS-46] Functions guaranteed to revert when called by normal users can be marked `payable`
...
<a name="GAS-47"></a> 
### [GAS-47] Use shift Right/Left instead of division/multiplication if possible
...
<a name="GAS-48"></a> 
### [GAS-48] Use `!= 0` instead of `> 0` for unsigned integer comparison
...
<a name="GAS-49"></a> 
### [GAS-49] Using assembly to check for zero can save gas
...
<a name="GAS-50"></a> 
### [GAS-50] `internal` functions not called by the contract should be removed
