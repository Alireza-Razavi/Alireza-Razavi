...
*Total <b>448</b> instances over <b>52</b> issues:*
...
| [NC-4](#NC-4) | Multiple `address`/ID mappings can be combined into a single `mapping` of an `address`/ID to a `struct`, for readability | 1 |
| [NC-5](#NC-5) | Complex casting | 2 |
| [NC-6](#NC-6) | Consider adding a block/deny-list | 14 |
| [NC-7](#NC-7) | Consider adding formal verification proofs | 1 |
| [NC-8](#NC-8) | Constant redefined elsewhere | 3 |
| [NC-9](#NC-9) | Constants should be put on the left side of comparisons | 19 |
| [NC-10](#NC-10) | Contract should expose an `interface` | 41 |
| [NC-11](#NC-11) | Contract uses both `require()`/`revert()` as well as custom errors | 1 |
| [NC-12](#NC-12) | Contracts should have full test coverage | 1 |
| [NC-13](#NC-13) | Convert simple `if` statements to ternary expressions | 1 |
| [NC-14](#NC-14) | Events that mark critical parameter changes should contain both the old and the new value | 14 |
| [NC-15](#NC-15) | Custom errors has no error details | 30 |
| [NC-16](#NC-16) | Custom errors should be used rather than `revert()`/`require()` | 4 |
| [NC-17](#NC-17) | Polymorphic functions make security audits more time-consuming and error-prone | 3 |
| [NC-18](#NC-18) | Duplicated `require()`/`revert()` checks should be refactored | 3 |
| [NC-19](#NC-19) | Empty bytes check is missing | 17 |
| [NC-20](#NC-20) | Enable IR-based code generation | 1 |
| [NC-21](#NC-21) | Events are emitted without the sender information | 8 |
| [NC-22](#NC-22) | Events may be emitted out of order due to reentrancy | 19 |
| [NC-23](#NC-23) |  Function ordering does not follow the Solidity Style Guide | 2 |
| [NC-24](#NC-24) | Functions with array parameters should have length checks in place | 5 |
| [NC-25](#NC-25) | Import declarations should import specific identifiers, rather than the whole file | 3 |
...
| [NC-28](#NC-28) | Missing zero address check in functions with address parameters | 47 |
| [NC-29](#NC-29) | Consider moving `msg.sender` checks to `modifier`s | 1 |
| [NC-30](#NC-30) | Named mappings are recommended | 3 |
| [NC-31](#NC-31) | Event declarations should have NatSpec descriptions | 15 |
| [NC-32](#NC-32) | NatSpec documentation for function is missing | 13 |
| [NC-33](#NC-33) | Missing NatSpec `@param` | 14 |
| [NC-34](#NC-34) | NatSpec `@return` is missing | 4 |
| [NC-35](#NC-35) | There is no need to initialize variables with 0 | 2 |
| [NC-36](#NC-36) | Put all system-wide constants in one file | 37 |
| [NC-37](#NC-37) | Lines are too long | 7 |
| [NC-38](#NC-38) | Typos | 4 |
| [NC-39](#NC-39) | Unused `error` definition | 1 |
| [NC-40](#NC-40) | Unused `event` definition | 1 |
| [NC-41](#NC-41) | Unused named return | 2 |
| [NC-42](#NC-42) | Unused contract variables | 8 |
| [NC-43](#NC-43) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-44](#NC-44) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-45](#NC-45) | Use the latest solidity version for deployment | 16 |
| [NC-46](#NC-46) | Use of `override` is unnecessary | 10 |
| [NC-47](#NC-47) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-48](#NC-48) | Common functions should be refactored to a common base contract | 4 |
| [NC-49](#NC-49) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-50](#NC-50) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-51](#NC-51) | Event is missing `indexed` fields | 4 |
| [NC-52](#NC-52) | Functions not used internally could be marked `external` | 4 |
...
<a name="NC-11"></a> 
### [NC-11] Contract uses both `require()`/`revert()` as well as custom errors
...
<a name="NC-13"></a> 
### [NC-13] Convert simple `if` statements to ternary expressions
...
<a name="NC-28"></a> 
### [NC-28] Missing zero address check in functions with address parameters
...
<a name="NC-29"></a> 
### [NC-29] Consider moving `msg.sender` checks to `modifier`s
...
<a name="NC-31"></a> 
### [NC-31] Event declarations should have NatSpec descriptions
...
<a name="NC-32"></a> 
### [NC-32] NatSpec documentation for function is missing
