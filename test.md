...
*Total <b>41</b> instances over <b>10</b> issues:*

|ID|Issue|Instances|
|-|:-|:-:|
| [L-1](#L-1) | Array is `push()`ed but not `pop()`ed | 1 |
| [L-2](#L-2) | Enum values should be used instead of constant array indexes | 4 |
| [L-3](#L-3) | Missing zero address check in constructor | 11 |
| [L-4](#L-4) | Consider some checks for `address(0)` when setting address state variables | 4 |
| [L-5](#L-5) | Numbers downcast to `address`es may result in collisions | 2 |
| [L-6](#L-6) | Prevent re-setting a state variable with the same value | 2 |
| [L-7](#L-7) | Timestamp may be manipulation | 1 |
| [L-8](#L-8) | Unsafe downcast | 1 |
| [L-9](#L-9) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 2 |
| [L-10](#L-10) | Empty Function Body - Consider commenting why | 13 |
...
<a name="L-4"></a> 
### [L-4] Consider some checks for `address(0)` when setting address state variables
...
<a name="L-5"></a> 
### [L-5] Numbers downcast to `address`es may result in collisions
...
<a name="L-7"></a> 
### [L-7] Timestamp may be manipulation
...
<a name="L-9"></a> 
### [L-9]  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()`
