...
|ID|Issue|Instances|
|-|:-|:-:|
| [M-1](#M-1) | `transfer`/`transferFrom` may never return `true` for some tokens | 6 |

## Low Issues


*Total <b>225</b> instances over <b>23</b> issues:*
...
<a name="M-1"></a> 
### [M-1] `transfer`/`transferFrom` may never return `true` for some tokens
