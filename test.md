...
*Total <b>1590</b> instances over <b>78</b> issues:*

|ID|Issue|Instances|
|-|:-|:-:|
| [NC-1](#NC-1) | `abi.encodePacked()` should be replaced with `bytes.concat()` | 17 |
| [NC-2](#NC-2) | Addresses shouldn't be hard-coded | 4 |
...
| [NC-6](#NC-6) | Consider bounding input array length | 3 |
| [NC-7](#NC-7) | Constants should be put on the left side of comparisons | 8 |
| [NC-8](#NC-8) | Contract does not follow the Solidity Style Guide's suggested layout ordering | 37 |
| [NC-9](#NC-9) | Contract name does not follow the Solidity Style Guide | 2 |
| [NC-10](#NC-10) | Contract should expose an `interface` | 104 |
| [NC-11](#NC-11) | Contracts should have full test coverage | 1 |
| [NC-12](#NC-12) | Convert simple `if` statements to ternary expressions | 3 |
| [NC-13](#NC-13) | Events that mark critical parameter changes should contain both the old and the new value | 12 |
| [NC-14](#NC-14) | Custom errors should be used rather than `revert()`/`require()` | 68 |
| [NC-15](#NC-15) | `mapping` definitions do not comply with best practices | 40 |
| [NC-16](#NC-16) | Duplicated `require()`/`revert()` checks should be refactored | 12 |
| [NC-17](#NC-17) | `else` block not required | 6 |
| [NC-18](#NC-18) | Enable IR-based code generation | 1 |
| [NC-19](#NC-19) | Names of structs, events, enums and errors should use CapWords style | 8 |
| [NC-20](#NC-20) | Events are emitted without the sender information | 6 |
| [NC-21](#NC-21) | Events may be emitted out of order due to reentrancy | 9 |
| [NC-22](#NC-22) | Execution at deadlines should be allowed | 3 |
| [NC-23](#NC-23) |  Function ordering does not follow the Solidity Style Guide | 56 |
| [NC-24](#NC-24) | Functions and modifiers should be named in mixedCase style | 10 |
| [NC-25](#NC-25) | Functions with array parameters should have length checks in place | 9 |
| [NC-26](#NC-26) | High cyclomatic complexity | 2 |
| [NC-27](#NC-27) | Import declarations should import specific identifiers, rather than the whole file | 32 |
| [NC-28](#NC-28) | Imports could be organized more systematically | 12 |
| [NC-29](#NC-29) | Inconsistent spacing in comments | 2 |
...
| [NC-32](#NC-32) | Missing disallow list for `ERC721` | 1 |
| [NC-33](#NC-33) | Consider moving `msg.sender` checks to `modifier`s | 23 |
| [NC-34](#NC-34) | Named mappings are recommended | 8 |
| [NC-35](#NC-35) | Named imports of parent contracts are missing | 6 |
| [NC-36](#NC-36) | Missing NatSpec from contract declarations | 8 |
| [NC-37](#NC-37) | Missing NatSpec `@author` from contract declaration | 8 |
| [NC-38](#NC-38) | Missing NatSpec `@dev` from contract declaration | 8 |
| [NC-39](#NC-39) | Missing NatSpec `@dev` from event declaration | 8 |
| [NC-40](#NC-40) | Missing NatSpec `@dev` from function declaration | 117 |
| [NC-41](#NC-41) | Missing NatSpec `@dev` from modifier declaration | 10 |
| [NC-42](#NC-42) | Event declarations should have NatSpec descriptions | 8 |
| [NC-43](#NC-43) | NatSpec documentation for function is missing | 117 |
| [NC-44](#NC-44) | Modifier declarations should have NatSpec descriptions | 10 |
| [NC-45](#NC-45) | Public variable declarations should have NatSpec descriptions | 33 |
| [NC-46](#NC-46) | Missing NatSpec `@notice` from contract declaration | 8 |
| [NC-47](#NC-47) | Missing NatSpec `@notice` from event declaration | 8 |
| [NC-48](#NC-48) | Missing NatSpec `@notice` from function declaration | 117 |
| [NC-49](#NC-49) | Missing NatSpec `@notice` from modifier declaration | 10 |
| [NC-50](#NC-50) | Missing NatSpec `@param` from event declaration | 8 |
| [NC-51](#NC-51) | Missing NatSpec `@param` from function declaration | 106 |
| [NC-52](#NC-52) | Missing NatSpec `@param` from modifier declaration | 9 |
| [NC-53](#NC-53) | Missing NatSpec `@return` from function declaration | 46 |
| [NC-54](#NC-54) | Missing NatSpec `@title` from contract declaration | 8 |
| [NC-55](#NC-55) | There is no need to initialize variables with 0 | 11 |
| [NC-56](#NC-56) | State variables should include comments | 2 |
| [NC-57](#NC-57) | Strings should use double quotes rather than single quotes | 2 |
| [NC-58](#NC-58) | Timestamp may be manipulation | 23 |
| [NC-59](#NC-59) | Lines are too long | 161 |
| [NC-60](#NC-60) | Typos | 7 |
| [NC-61](#NC-61) | Unused arguments should be removed or implemented | 3 |
| [NC-62](#NC-62) | Consider using `delete` rather than assigning zero/false to clear values | 6 |
| [NC-63](#NC-63) | Solidity compiler version is not fixed | 8 |
| [NC-64](#NC-64) | Use `@inheritdoc` for overridden functions | 3 |
| [NC-65](#NC-65) | Use the latest solidity version for deployment (`0.8.23`) | 8 |
| [NC-66](#NC-66) | Use of `override` is unnecessary | 3 |
| [NC-67](#NC-67) | Returning a struct instead of a bunch of variables is better | 6 |
| [NC-68](#NC-68) | Use a struct to encapsulate multiple function parameters | 9 |
| [NC-69](#NC-69) | Visibility of state variables is not explicitly defined | 6 |
| [NC-70](#NC-70) | Whitespace in Expressions | 11 |
| [NC-71](#NC-71) | Common functions should be refactored to a common base contract | 3 |
| [NC-72](#NC-72) | Names of `private`/`internal` functions should be prefixed with an underscore | 4 |
| [NC-73](#NC-73) | Names of `private`/`internal` state variables should be prefixed with an underscore | 34 |
| [NC-74](#NC-74) | `onlyOwner` is not used anywhere | 6 |
| [NC-75](#NC-75) |  `require()` / `revert()` statements should have descriptive reason strings | 10 |
| [NC-76](#NC-76) | Variables should be named in mixedCase style | 13 |
| [NC-77](#NC-77) | Event is missing `indexed` fields | 5 |
| [NC-78](#NC-78) | Functions not used internally could be marked `external` | 75 |

## Gas Optimizations


*Total <b>594</b> instances over <b>45</b> issues:*
...
| [GAS-16](#GAS-16) | State variables access within a loop | 12 | 3180 |
| [GAS-17](#GAS-17) | State variables can be packed into fewer storage slots | 1 | 20000 |
| [GAS-18](#GAS-18) | State variables only set in the constructor should be declared immutable | 5 | 100000 |
| [GAS-19](#GAS-19) | Structs can be packed into fewer storage slots | 3 | 60000 |
| [GAS-20](#GAS-20) | Unlimited gas consumption risk due to external call recipients | 6 | - |
| [GAS-21](#GAS-21) | Optimize External Calls with Assembly for Memory Efficiency | 8 | 1760 |
| [GAS-22](#GAS-22) | Use assembly to compute hashes to save gas | 8 | 640 |
| [GAS-23](#GAS-23) | Use assembly to emit events | 12 | 456 |
| [GAS-24](#GAS-24) | Use assembly to validate `msg.sender` | 15 | - |
| [GAS-25](#GAS-25) | Use assembly to write address/contract type storage values | 14 | 700 |
| [GAS-26](#GAS-26) | Using a double `if` statement instead of a logical AND (`&&`) | 28 | 840 |
| [GAS-27](#GAS-27) | Use a more recent version of solidity | 8 | - |
| [GAS-28](#GAS-28) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 13 | 111150 |
| [GAS-29](#GAS-29) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-30](#GAS-30) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-31](#GAS-31) | Use `selfbalance()` instead of `address(this).balance` | 2 | - |
| [GAS-32](#GAS-32) | `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants) | 8 | - |
| [GAS-33](#GAS-33) | Using bools for storage incurs overhead | 13 | 1300 |
| [GAS-34](#GAS-34) | Cache array length outside of loop | 9 | - |
| [GAS-35](#GAS-35) | State variables should be cached in stack variables rather than re-reading them from storage | 31 | 3007 |
| [GAS-36](#GAS-36) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 33 | - |
| [GAS-37](#GAS-37) | Use Custom Errors | 68 | 3400 |
| [GAS-38](#GAS-38) | Don't initialize variables with default value | 11 | - |
| [GAS-39](#GAS-39) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 13 | 715 |
| [GAS-40](#GAS-40) | Constructors can be marked as `payable` to save deployment gas | 7 | 147 |
| [GAS-41](#GAS-41) | Functions guaranteed to revert when called by normal users can be marked `payable` | 1 | 21 |
| [GAS-42](#GAS-42) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 9 | 45 |
| [GAS-43](#GAS-43) | Splitting require() statements that use && saves gas | 10 | - |
| [GAS-44](#GAS-44) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 6 | 24 |
| [GAS-45](#GAS-45) | Using assembly to check for zero can save gas | 5 | 30 |
...
<a name="NC-2"></a> 
### [NC-2] Addresses shouldn't be hard-coded
...
```
*Github:* [[111](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/NextGenCore.sol#L111)]
...
<a name="NC-15"></a> 
### [NC-15] `mapping` definitions do not comply with best practices
...
<a name="NC-19"></a> 
### [NC-19] Names of structs, events, enums and errors should use CapWords style
...
<a name="NC-22"></a> 
### [NC-22] Execution at deadlines should be allowed
...
<a name="NC-24"></a> 
### [NC-24] Functions and modifiers should be named in mixedCase style
...
<a name="NC-25"></a> 
### [NC-25] Functions with array parameters should have length checks in place
...
<a name="NC-27"></a> 
### [NC-27] Import declarations should import specific identifiers, rather than the whole file
...
<a name="NC-32"></a> 
### [NC-32] Missing disallow list for `ERC721`
...
<a name="NC-33"></a> 
### [NC-33] Consider moving `msg.sender` checks to `modifier`s
...
<a name="NC-36"></a> 
### [NC-36] Missing NatSpec from contract declarations
...
<a name="NC-37"></a> 
### [NC-37] Missing NatSpec `@author` from contract declaration
...
<a name="NC-38"></a> 
### [NC-38] Missing NatSpec `@dev` from contract declaration
...
<a name="NC-39"></a> 
### [NC-39] Missing NatSpec `@dev` from event declaration
...
<a name="NC-40"></a> 
### [NC-40] Missing NatSpec `@dev` from function declaration
...
<a name="NC-41"></a> 
### [NC-41] Missing NatSpec `@dev` from modifier declaration
...
<a name="NC-42"></a> 
### [NC-42] Event declarations should have NatSpec descriptions
...
<a name="NC-43"></a> 
### [NC-43] NatSpec documentation for function is missing
...
<a name="NC-44"></a> 
### [NC-44] Modifier declarations should have NatSpec descriptions
...
<a name="NC-45"></a> 
### [NC-45] Public variable declarations should have NatSpec descriptions
...
<a name="NC-46"></a> 
### [NC-46] Missing NatSpec `@notice` from contract declaration
...
<a name="NC-47"></a> 
### [NC-47] Missing NatSpec `@notice` from event declaration
...
<a name="NC-48"></a> 
### [NC-48] Missing NatSpec `@notice` from function declaration
...
<a name="NC-49"></a> 
### [NC-49] Missing NatSpec `@notice` from modifier declaration
...
<a name="NC-50"></a> 
### [NC-50] Missing NatSpec `@param` from event declaration
...
<a name="NC-51"></a> 
### [NC-51] Missing NatSpec `@param` from function declaration
...
<a name="NC-52"></a> 
### [NC-52] Missing NatSpec `@param` from modifier declaration
...
<a name="NC-57"></a> 
### [NC-57] Strings should use double quotes rather than single quotes
...
<a name="NC-58"></a> 
### [NC-58] Timestamp may be manipulation
...
<a name="NC-64"></a> 
### [NC-64] Use `@inheritdoc` for overridden functions
...
<a name="NC-69"></a> 
### [NC-69] Visibility of state variables is not explicitly defined
...
<a name="NC-70"></a> 
### [NC-70] Whitespace in Expressions
...
<a name="NC-72"></a> 
### [NC-72] Names of `private`/`internal` functions should be prefixed with an underscore
...
<a name="NC-73"></a> 
### [NC-73] Names of `private`/`internal` state variables should be prefixed with an underscore
It is recommended by the [Solidity Style Guide](https://docs.soliditylang.org/en/v0.8.20/style-guide.html#underscore-prefix-for-non-external-functions-and-variables)
...
<a name="NC-74"></a> 
### [NC-74] `onlyOwner` is not used anywhere
...
<a name="GAS-17"></a> 
### [GAS-17] State variables can be packed into fewer storage slots
...
<a name="GAS-18"></a> 
### [GAS-18] State variables only set in the constructor should be declared immutable
...
```
*Github:* [[119](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/MinterContract.sol#L119)]
...
```
*Github:* [[22](https://github.com/code-423n4/2023-10-nextgen/blob/08a56bacd286ee52433670f3bb73a0e4a4525dd4/smart-contracts/RandomizerVRF.sol#L22)]



<a name="GAS-19"></a> 
### [GAS-19] Structs can be packed into fewer storage slots
...
<a name="GAS-26"></a> 
### [GAS-26] Using a double `if` statement instead of a logical AND (`&&`)
...
<a name="GAS-29"></a> 
### [GAS-29] Using bitmap to store bool states can save gas
...
<a name="GAS-30"></a> 
### [GAS-30] Using `this` to access functions results in an external call, wasting gas
...
<a name="GAS-31"></a> 
### [GAS-31] Use `selfbalance()` instead of `address(this).balance`
...
<a name="GAS-32"></a> 
### [GAS-32] `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants)
...
<a name="GAS-38"></a> 
### [GAS-38] Don't initialize variables with default value
...
<a name="GAS-39"></a> 
### [GAS-39] Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead
...
<a name="GAS-41"></a> 
### [GAS-41] Functions guaranteed to revert when called by normal users can be marked `payable`
...
<a name="GAS-42"></a> 
### [GAS-42] `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too)
...
<a name="GAS-43"></a> 
### [GAS-43] Splitting require() statements that use && saves gas
...
<a name="GAS-44"></a> 
### [GAS-44] Use `!= 0` instead of `> 0` for unsigned integer comparison
...
<a name="GAS-45"></a> 
### [GAS-45] Using assembly to check for zero can save gas
