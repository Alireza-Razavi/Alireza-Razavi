...
Total <b>412</b> instances over <b>51</b> issues:
...
| [NC-13](#NC-13) | Empty bytes check is missing | 2 |
| [NC-14](#NC-14) | Enable IR-based code generation | 1 |
| [NC-15](#NC-15) | Names of structs, events, enums and errors should use CapWords style | 1 |
| [NC-16](#NC-16) | Events are emitted without the sender information | 14 |
| [NC-17](#NC-17) | Import declarations should import specific identifiers, rather than the whole file | 32 |
| [NC-18](#NC-18) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-19](#NC-19) | Large multiples of ten should use scientific notation | 1 |
| [NC-20](#NC-20) | Magic numbers should be replaced with constants | 14 |
| [NC-21](#NC-21) | Missing zero address check in functions with address parameters | 23 |
| [NC-22](#NC-22) | Consider moving `msg.sender` checks to `modifier`s | 3 |
| [NC-23](#NC-23) | Named mappings are recommended | 9 |
| [NC-24](#NC-24) | NatSpec documentation for contract is missing | 3 |
| [NC-25](#NC-25) | NatSpec documentation for function is missing | 11 |
| [NC-26](#NC-26) | Modifier declarations should have NatSpec descriptions | 1 |
| [NC-27](#NC-27) | Missing NatSpec `@param` | 28 |
| [NC-28](#NC-28) | Public variable declarations should have NatSpec descriptions | 19 |
| [NC-29](#NC-29) | NatSpec `@return` is missing | 15 |
| [NC-30](#NC-30) | There is no need to initialize variables with 0 | 8 |
| [NC-31](#NC-31) | Put all system-wide constants in one file | 13 |
| [NC-32](#NC-32) | SPDX identifier should be the in the first line of a solidity file | 6 |
| [NC-33](#NC-33) | State variables should include comments | 11 |
| [NC-34](#NC-34) | Contract declarations should have NatSpec `@title` annotations | 3 |
| [NC-35](#NC-35) | Unused errors | 2 |
| [NC-36](#NC-36) | Unused named return | 3 |
| [NC-37](#NC-37) | Unused contract variables | 1 |
| [NC-38](#NC-38) | Consider using `delete` rather than assigning zero to clear values | 8 |
| [NC-39](#NC-39) | Expressions for constant values should use `immutable` rather than `constant` | 13 |
| [NC-40](#NC-40) | Use the latest solidity version for deployment | 6 |
| [NC-41](#NC-41) | Use of `override` is unnecessary | 6 |
| [NC-42](#NC-42) | Use scientific notation (e.g. `1e18`) rather than exponentiation (e.g. `10**18`) | 1 |
| [NC-43](#NC-43) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-44](#NC-44) | Common functions should be refactored to a common base contract | 8 |
| [NC-45](#NC-45) | Names of `private`/`internal` functions should be prefixed with an underscore | 2 |
| [NC-46](#NC-46) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-47](#NC-47) |  `require()` / `revert()` statements should have descriptive reason strings | 1 |
| [NC-48](#NC-48) | Return values of `approve()` not checked | 6 |
| [NC-49](#NC-49) | Variables should be named in mixedCase style | 19 |
| [NC-50](#NC-50) | Event is missing `indexed` fields | 13 |
| [NC-51](#NC-51) | Functions not used internally could be marked external | 14 |
...
<a name="NC-14"></a> 
### [NC-14] Enable IR-based code generation
...
<a name="NC-15"></a> 
### [NC-15] Names of structs, events, enums and errors should use CapWords style
...
<a name="NC-26"></a> 
### [NC-26] Modifier declarations should have NatSpec descriptions
...
<a name="NC-28"></a> 
### [NC-28] Public variable declarations should have NatSpec descriptions
...
<a name="NC-29"></a> 
### [NC-29] NatSpec `@return` is missing
...
<a name="NC-30"></a> 
### [NC-30] There is no need to initialize variables with 0
...
<a name="NC-32"></a> 
### [NC-32] SPDX identifier should be the in the first line of a solidity file
...
<a name="NC-33"></a> 
### [NC-33] State variables should include comments
...
<a name="NC-42"></a> 
### [NC-42] Use scientific notation (e.g. `1e18`) rather than exponentiation (e.g. `10**18`)
