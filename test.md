...
*Total <b>27</b> instances over <b>2</b> issues:*
...
*Total <b>44</b> instances over <b>13</b> issues:*
...
| [L-4](#L-4) | Check division by zero is prevented | 2 |
| [L-5](#L-5) | Consider implementing two-step procedure for updating protocol addresses | 2 |
| [L-6](#L-6) | Governance functions should be controlled by time locks | 1 |
| [L-7](#L-7) | Loss of precision in divisions | 2 |
| [L-8](#L-8) | Check storage gap for upgradable contracts | 5 |
| [L-9](#L-9) | Prevent re-setting a state variable with the same value | 3 |
| [L-10](#L-10) | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 9 |
| [L-11](#L-11) | Tokens may be minted to `address(0)` | 1 |
| [L-12](#L-12) | Unsafe use of ERC20 `transfer()`/`transferFrom()`/`approve()` | 4 |
| [L-13](#L-13) | Initializers could be front-run | 6 |

## Non Critical Issues


*Total <b>370</b> instances over <b>55</b> issues:*
...
| [NC-18](#NC-18) | Large multiples of ten should use scientific notation | 3 |
| [NC-19](#NC-19) | Missing NatSpec from contract declarations | 2 |
| [NC-20](#NC-20) | Missing NatSpec `@author` from contract declaration | 9 |
| [NC-21](#NC-21) | Missing NatSpec `@dev` from contract declaration | 10 |
| [NC-22](#NC-22) | Missing NatSpec `@dev` from event declaration | 1 |
| [NC-23](#NC-23) | Missing NatSpec `@dev` from function declaration | 20 |
| [NC-24](#NC-24) | Missing NatSpec `@dev` from modifier declaration | 4 |
| [NC-25](#NC-25) | Error declarations should have NatSpec descriptions | 1 |
| [NC-26](#NC-26) | Event declarations should have NatSpec descriptions | 1 |
| [NC-27](#NC-27) | NatSpec documentation for function is missing | 6 |
| [NC-28](#NC-28) | Modifier declarations should have NatSpec descriptions | 4 |
| [NC-29](#NC-29) | Public variable declarations should have NatSpec descriptions | 20 |
| [NC-30](#NC-30) | Missing NatSpec `@notice` from contract declaration | 2 |
| [NC-31](#NC-31) | Missing NatSpec `@notice` from event declaration | 1 |
| [NC-32](#NC-32) | Missing NatSpec `@notice` from function declaration | 39 |
| [NC-33](#NC-33) | Missing NatSpec `@notice` from modifier declaration | 4 |
| [NC-34](#NC-34) | Missing NatSpec `@param` from event declaration | 1 |
| [NC-35](#NC-35) | Missing NatSpec `@param` from function declaration | 5 |
| [NC-36](#NC-36) | Missing NatSpec `@param` from modifier declaration | 2 |
| [NC-37](#NC-37) | Missing NatSpec `@return` from function declaration | 4 |
| [NC-38](#NC-38) | Missing NatSpec `@title` from contract declaration | 2 |
| [NC-39](#NC-39) | There is no need to initialize variables with 0 | 1 |
| [NC-40](#NC-40) | Put all system-wide constants in one file | 9 |
| [NC-41](#NC-41) | Redundant `return` statement in a function with named return variables | 2 |
| [NC-42](#NC-42) | State variables should include comments | 2 |
| [NC-43](#NC-43) | The `nonReentrant` modifier should occur before all other modifiers | 3 |
| [NC-44](#NC-44) | Lines are too long | 13 |
| [NC-45](#NC-45) | Typos | 10 |
| [NC-46](#NC-46) | Unnecessary cast | 2 |
| [NC-47](#NC-47) | Unused named return | 2 |
| [NC-48](#NC-48) | Expressions for constant values should use `immutable` rather than `constant` | 9 |
| [NC-49](#NC-49) | Use `@inheritdoc` for overridden functions | 8 |
| [NC-50](#NC-50) | Use the latest solidity version for deployment (`0.8.23`) | 9 |
| [NC-51](#NC-51) | Use of `override` is unnecessary | 8 |
| [NC-52](#NC-52) | Common functions should be refactored to a common base contract | 8 |
| [NC-53](#NC-53) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-54](#NC-54) |  `require()` / `revert()` statements should have descriptive reason strings | 3 |
| [NC-55](#NC-55) | Variables should be named in mixedCase style | 1 |

## Gas Optimizations


*Total <b>157</b> instances over <b>31</b> issues:*
...
| [GAS-16](#GAS-16) | Optimize External Calls with Assembly for Memory Efficiency | 3 | 660 |
...
<a name="L-4"></a> 
### [L-4] Check division by zero is prevented
...
<a name="L-12"></a> 
### [L-12] Unsafe use of ERC20 `transfer()`/`transferFrom()`/`approve()`
...
<a name="NC-19"></a> 
### [NC-19] Missing NatSpec from contract declarations
...
<a name="NC-20"></a> 
### [NC-20] Missing NatSpec `@author` from contract declaration
...
<a name="NC-21"></a> 
### [NC-21] Missing NatSpec `@dev` from contract declaration
...
<a name="NC-22"></a> 
### [NC-22] Missing NatSpec `@dev` from event declaration
...
<a name="NC-23"></a> 
### [NC-23] Missing NatSpec `@dev` from function declaration
...
<a name="NC-24"></a> 
### [NC-24] Missing NatSpec `@dev` from modifier declaration
...
<a name="NC-25"></a> 
### [NC-25] Error declarations should have NatSpec descriptions
...
<a name="NC-26"></a> 
### [NC-26] Event declarations should have NatSpec descriptions
...
<a name="NC-27"></a> 
### [NC-27] NatSpec documentation for function is missing
...
<a name="NC-28"></a> 
### [NC-28] Modifier declarations should have NatSpec descriptions
...
<a name="NC-30"></a> 
### [NC-30] Missing NatSpec `@notice` from contract declaration
...
<a name="NC-31"></a> 
### [NC-31] Missing NatSpec `@notice` from event declaration
...
<a name="NC-32"></a> 
### [NC-32] Missing NatSpec `@notice` from function declaration
...
<a name="NC-33"></a> 
### [NC-33] Missing NatSpec `@notice` from modifier declaration
...
<a name="NC-34"></a> 
### [NC-34] Missing NatSpec `@param` from event declaration
...
<a name="NC-35"></a> 
### [NC-35] Missing NatSpec `@param` from function declaration
...
<a name="NC-36"></a> 
### [NC-36] Missing NatSpec `@param` from modifier declaration
...
<a name="NC-37"></a> 
### [NC-37] Missing NatSpec `@return` from function declaration
...
<a name="NC-38"></a> 
### [NC-38] Missing NatSpec `@title` from contract declaration
...
<a name="NC-40"></a> 
### [NC-40] Put all system-wide constants in one file
...
<a name="NC-41"></a> 
### [NC-41] Redundant `return` statement in a function with named return variables
...
<a name="NC-42"></a> 
### [NC-42] State variables should include comments
...
<a name="NC-43"></a> 
### [NC-43] The `nonReentrant` modifier should occur before all other modifiers
...
<a name="NC-50"></a> 
### [NC-50] Use the latest solidity version for deployment (`0.8.23`)
...
<a name="NC-52"></a> 
### [NC-52] Common functions should be refactored to a common base contract
...
<a name="NC-53"></a> 
### [NC-53] Names of `private`/`internal` functions should be prefixed with an underscore
...
<a name="NC-54"></a> 
### [NC-54]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-55"></a> 
### [NC-55] Variables should be named in mixedCase style
...
```
*Github:* [[156](https://github.com/code-423n4/2023-11-kelp/blob/4b34abc952205e2a34bff893a0de0c75b8052149/src/LRTDepositPool.sol#L156)]
...
```
*Github:* [[45](https://github.com/code-423n4/2023-11-kelp/blob/4b34abc952205e2a34bff893a0de0c75b8052149/src/NodeDelegator.sol#L45), [67](https://github.com/code-423n4/2023-11-kelp/blob/4b34abc952205e2a34bff893a0de0c75b8052149/src/NodeDelegator.sol#L67)]
