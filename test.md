...
*Total <b>401</b> instances over <b>47</b> issues:*
...
| [NC-7](#NC-7) | Contract should expose an `interface` | 33 |
...
| [NC-11](#NC-11) | Polymorphic functions make security audits more time-consuming and error-prone | 2 |
| [NC-12](#NC-12) | Duplicated `require()`/`revert()` checks should be refactored | 1 |
| [NC-13](#NC-13) | `else` block not required | 3 |
| [NC-14](#NC-14) | Enable IR-based code generation | 1 |
| [NC-15](#NC-15) | Events are emitted without the sender information | 13 |
| [NC-16](#NC-16) | Events should use parameters to convey information | 2 |
| [NC-17](#NC-17) |  Function ordering does not follow the Solidity Style Guide | 10 |
| [NC-18](#NC-18) | High cyclomatic complexity | 2 |
| [NC-19](#NC-19) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-20](#NC-20) | Long functions should be refactored into multiple, smaller, functions | 2 |
| [NC-21](#NC-21) | Magic numbers should be replaced with constants | 19 |
| [NC-22](#NC-22) | Missing zero address check in functions with address parameters | 42 |
| [NC-23](#NC-23) | Named mappings are recommended | 11 |
| [NC-24](#NC-24) | NatSpec documentation for contract is missing | 6 |
| [NC-25](#NC-25) | Missing NatSpec `@param` | 6 |
| [NC-26](#NC-26) | NatSpec `@return` is missing | 4 |
| [NC-27](#NC-27) | There is no need to initialize variables with 0 | 13 |
| [NC-28](#NC-28) | Put all system-wide constants in one file | 12 |
| [NC-29](#NC-29) | Redundant `return` statement in a function with named return variables | 5 |
| [NC-30](#NC-30) | State variables should include comments | 1 |
| [NC-31](#NC-31) | Contract declarations should have NatSpec `@title` annotations | 6 |
| [NC-32](#NC-32) | Lines are too long | 6 |
| [NC-33](#NC-33) | Typos | 10 |
| [NC-34](#NC-34) | Unused errors | 1 |
| [NC-35](#NC-35) | Unused `event` definition | 3 |
| [NC-36](#NC-36) | Unused named return | 4 |
| [NC-37](#NC-37) | Consider using `delete` rather than assigning zero/false to clear values | 12 |
| [NC-38](#NC-38) | Solidity compiler version is not fixed | 1 |
| [NC-39](#NC-39) | Expressions for constant values should use `immutable` rather than `constant` | 12 |
| [NC-40](#NC-40) | Use the latest solidity version for deployment | 6 |
| [NC-41](#NC-41) | Whitespace in Expressions | 1 |
| [NC-42](#NC-42) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-43](#NC-43) | Names of `private`/`internal` functions should be prefixed with an underscore | 9 |
| [NC-44](#NC-44) | Names of `private`/`internal` state variables should be prefixed with an underscore | 12 |
| [NC-45](#NC-45) | Variables should be named in mixedCase style | 16 |
| [NC-46](#NC-46) | Event is missing `indexed` fields | 8 |
| [NC-47](#NC-47) | Constants should be defined rather than using magic numbers | 20 |

## Gas Optimizations


*Total <b>400</b> instances over <b>33</b> issues:*
...
| [GAS-18](#GAS-18) | Using a double `if` statement instead of a logical AND (`&&`) | 9 | 270 |
| [GAS-19](#GAS-19) | Use a more recent version of solidity | 6 | - |
| [GAS-20](#GAS-20) | Use `unchecked` block for safe subtractions | 2 | 170 |
| [GAS-21](#GAS-21) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-22](#GAS-22) | Using bools for storage incurs overhead | 1 | - |
| [GAS-23](#GAS-23) | Cache array length outside of loop | 10 | - |
...
<a name="NC-11"></a> 
### [NC-11] Polymorphic functions make security audits more time-consuming and error-prone
...
<a name="NC-16"></a> 
### [NC-16] Events should use parameters to convey information
...
<a name="NC-17"></a> 
### [NC-17]  Function ordering does not follow the Solidity Style Guide
...
<a name="NC-18"></a> 
### [NC-18] High cyclomatic complexity
...
<a name="NC-47"></a> 
### [NC-47] Constants should be defined rather than using magic numbers
...
<a name="GAS-20"></a> 
### [GAS-20] Use `unchecked` block for safe subtractions
...
<a name="GAS-21"></a> 
### [GAS-21] Using bitmap to store bool states can save gas
