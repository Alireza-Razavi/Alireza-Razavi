...
*Total <b>1562</b> instances over <b>75</b> issues:*
...
| [NC-31](#NC-31) | Consider moving `msg.sender` checks to `modifier`s | 23 |
| [NC-32](#NC-32) | Named mappings are recommended | 8 |
| [NC-33](#NC-33) | Named imports of parent contracts are missing | 6 |
| [NC-34](#NC-34) | Missing NatSpec from contract declarations | 8 |
| [NC-35](#NC-35) | Missing NatSpec `@author` from contract declaration | 8 |
| [NC-36](#NC-36) | Missing NatSpec `@dev` from contract declaration | 8 |
| [NC-37](#NC-37) | Missing NatSpec `@dev` from event declaration | 8 |
| [NC-38](#NC-38) | Missing NatSpec `@dev` from function declaration | 117 |
| [NC-39](#NC-39) | Missing NatSpec `@dev` from modifier declaration | 10 |
| [NC-40](#NC-40) | Event declarations should have NatSpec descriptions | 8 |
| [NC-41](#NC-41) | NatSpec documentation for function is missing | 117 |
| [NC-42](#NC-42) | Modifier declarations should have NatSpec descriptions | 10 |
| [NC-43](#NC-43) | Public variable declarations should have NatSpec descriptions | 33 |
| [NC-44](#NC-44) | Missing NatSpec `@notice` from contract declaration | 8 |
| [NC-45](#NC-45) | Missing NatSpec `@notice` from event declaration | 8 |
| [NC-46](#NC-46) | Missing NatSpec `@notice` from function declaration | 117 |
| [NC-47](#NC-47) | Missing NatSpec `@notice` from modifier declaration | 10 |
| [NC-48](#NC-48) | Missing NatSpec `@param` from event declaration | 8 |
| [NC-49](#NC-49) | Missing NatSpec `@param` from function declaration | 106 |
| [NC-50](#NC-50) | Missing NatSpec `@param` from modifier declaration | 9 |
| [NC-51](#NC-51) | Missing NatSpec `@return` from function declaration | 46 |
| [NC-52](#NC-52) | Missing NatSpec `@title` from contract declaration | 8 |
| [NC-53](#NC-53) | There is no need to initialize variables with 0 | 11 |
| [NC-54](#NC-54) | State variables should include comments | 2 |
| [NC-55](#NC-55) | Strings should use double quotes rather than single quotes | 2 |
| [NC-56](#NC-56) | Lines are too long | 161 |
| [NC-57](#NC-57) | Typos | 7 |
| [NC-58](#NC-58) | Unused arguments should be removed or implemented | 3 |
| [NC-59](#NC-59) | Consider using `delete` rather than assigning zero/false to clear values | 6 |
| [NC-60](#NC-60) | Solidity compiler version is not fixed | 8 |
| [NC-61](#NC-61) | Use `@inheritdoc` for overridden functions | 3 |
| [NC-62](#NC-62) | Use the latest solidity version for deployment (`0.8.23`) | 8 |
| [NC-63](#NC-63) | Use of `override` is unnecessary | 3 |
| [NC-64](#NC-64) | Returning a struct instead of a bunch of variables is better | 6 |
| [NC-65](#NC-65) | Use a struct to encapsulate multiple function parameters | 9 |
| [NC-66](#NC-66) | Visibility of state variables is not explicitly defined | 6 |
| [NC-67](#NC-67) | Whitespace in Expressions | 11 |
| [NC-68](#NC-68) | Common functions should be refactored to a common base contract | 3 |
| [NC-69](#NC-69) | Names of `private`/`internal` functions should be prefixed with an underscore | 4 |
| [NC-70](#NC-70) | Names of `private`/`internal` state variables should be prefixed with an underscore | 34 |
| [NC-71](#NC-71) | `onlyOwner` is not used anywhere | 6 |
| [NC-72](#NC-72) |  `require()` / `revert()` statements should have descriptive reason strings | 10 |
| [NC-73](#NC-73) | Variables should be named in mixedCase style | 13 |
| [NC-74](#NC-74) | Event is missing `indexed` fields | 5 |
| [NC-75](#NC-75) | Functions not used internally could be marked `external` | 75 |
...
<a name="NC-31"></a> 
### [NC-31] Consider moving `msg.sender` checks to `modifier`s
...
<a name="NC-44"></a> 
### [NC-44] Missing NatSpec `@notice` from contract declaration
...
<a name="NC-45"></a> 
### [NC-45] Missing NatSpec `@notice` from event declaration
...
<a name="NC-46"></a> 
### [NC-46] Missing NatSpec `@notice` from function declaration
...
<a name="NC-47"></a> 
### [NC-47] Missing NatSpec `@notice` from modifier declaration
...
<a name="NC-48"></a> 
### [NC-48] Missing NatSpec `@param` from event declaration
...
<a name="NC-49"></a> 
### [NC-49] Missing NatSpec `@param` from function declaration
...
<a name="NC-50"></a> 
### [NC-50] Missing NatSpec `@param` from modifier declaration
...
<a name="NC-58"></a> 
### [NC-58] Unused arguments should be removed or implemented
...
<a name="NC-62"></a> 
### [NC-62] Use the latest solidity version for deployment (`0.8.23`)
...
<a name="NC-66"></a> 
### [NC-66] Visibility of state variables is not explicitly defined
...
<a name="NC-71"></a> 
### [NC-71] `onlyOwner` is not used anywhere
...
<a name="NC-73"></a> 
### [NC-73] Variables should be named in mixedCase style
