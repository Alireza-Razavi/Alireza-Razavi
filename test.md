...
*Total <b>455</b> instances over <b>58</b> issues:*
...
| [NC-36](#NC-36) | Named imports of parent contracts are missing | 1 |
| [NC-37](#NC-37) | Event declarations should have NatSpec descriptions | 15 |
| [NC-38](#NC-38) | NatSpec documentation for function is missing | 13 |
| [NC-39](#NC-39) | Missing NatSpec `@param` | 14 |
| [NC-40](#NC-40) | NatSpec `@return` is missing | 4 |
| [NC-41](#NC-41) | There is no need to initialize variables with 0 | 2 |
| [NC-42](#NC-42) | Put all system-wide constants in one file | 37 |
| [NC-43](#NC-43) | Lines are too long | 7 |
| [NC-44](#NC-44) | Typos | 4 |
| [NC-45](#NC-45) | Unused `error` definition | 1 |
| [NC-46](#NC-46) | Unused `event` definition | 1 |
| [NC-47](#NC-47) | Unused named return | 2 |
| [NC-48](#NC-48) | Unused contract variables | 8 |
| [NC-49](#NC-49) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-50](#NC-50) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-51](#NC-51) | Use the latest solidity version for deployment | 16 |
| [NC-52](#NC-52) | Use of `override` is unnecessary | 10 |
| [NC-53](#NC-53) | Missing checks for `address(0)` when assigning values to address state variables | 2 |
| [NC-54](#NC-54) | Common functions should be refactored to a common base contract | 4 |
| [NC-55](#NC-55) | Names of `private`/`internal` functions should be prefixed with an underscore | 1 |
| [NC-56](#NC-56) | Names of `private`/`internal` state variables should be prefixed with an underscore | 1 |
| [NC-57](#NC-57) | Event is missing `indexed` fields | 4 |
| [NC-58](#NC-58) | Functions not used internally could be marked `external` | 4 |
...
<a name="NC-48"></a> 
### [NC-48] Unused contract variables
...
<a name="NC-51"></a> 
### [NC-51] Use the latest solidity version for deployment
...
<a name="NC-52"></a> 
### [NC-52] Use of `override` is unnecessary
...
<a name="NC-53"></a> 
### [NC-53] Missing checks for `address(0)` when assigning values to address state variables
...
<a name="NC-56"></a> 
### [NC-56] Names of `private`/`internal` state variables should be prefixed with an underscore
It is recommended by the [Solidity Style Guide](https://docs.soliditylang.org/en/v0.8.20/style-guide.html#underscore-prefix-for-non-external-functions-and-variables)
...
<a name="NC-57"></a> 
### [NC-57] Event is missing `indexed` fields
...
<a name="NC-58"></a> 
### [NC-58] Functions not used internally could be marked `external`
