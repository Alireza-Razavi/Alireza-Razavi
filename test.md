...
*Total <b>201</b> instances over <b>30</b> issues:*
...
| [GAS-18](#GAS-18) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 1 | 8550 |
| [GAS-19](#GAS-19) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-20](#GAS-20) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-21](#GAS-21) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 14 | - |
| [GAS-22](#GAS-22) | Use Custom Errors | 4 | 200 |
| [GAS-23](#GAS-23) | Don't initialize variables with default value | 2 | - |
| [GAS-24](#GAS-24) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 17 | 935 |
| [GAS-25](#GAS-25) | Constructors can be marked as `payable` to save deployment gas | 13 | 273 |
| [GAS-26](#GAS-26) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-27](#GAS-27) | Using `private` rather than `public` for constants, saves gas | 4 | - |
| [GAS-28](#GAS-28) | Splitting require() statements that use && saves gas | 1 | - |
| [GAS-29](#GAS-29) | Using assembly to check for zero can save gas | 24 | 144 |
| [GAS-30](#GAS-30) | `internal` functions not called by the contract should be removed | 10 | - |
...
<a name="GAS-30"></a> 
### [GAS-30] `internal` functions not called by the contract should be removed
