...
*Total <b>569</b> instances over <b>48</b> issues:*
...
| [GAS-4](#GAS-4) | Operator `+=` costs more gas than `<x> = <x> + <y>` for state variables | 17 | 1921 |
| [GAS-5](#GAS-5) | Duplicated `require()`/`revert()` checks should be refactored to a modifier or function to save gas | 8 | - |
| [GAS-6](#GAS-6) | Events should be emitted outside of loops | 2 | 750 |
| [GAS-7](#GAS-7) | Increments can be `unchecked` to save gas | 13 | 780 |
| [GAS-8](#GAS-8) | Initializers can be marked as payable to save deployment gas | 2 | 42 |
| [GAS-9](#GAS-9) | Inline `modifier`s that are only used once, to save gas | 5 | - |
