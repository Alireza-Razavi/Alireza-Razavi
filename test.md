...
Total <b>368</b> instances over <b>42</b> issues:
...
| [NC-27](#NC-27) | Unused errors | 2 |
| [NC-28](#NC-28) | Unused named return | 3 |
| [NC-29](#NC-29) | Unused contract variables | 1 |
| [NC-30](#NC-30) | Consider using `delete` rather than assigning zero to clear values | 8 |
| [NC-31](#NC-31) | Expressions for constant values should use `immutable` rather than `constant` | 13 |
| [NC-32](#NC-32) | Use the latest solidity version for deployment | 6 |
| [NC-33](#NC-33) | Use of `override` is unnecessary | 6 |
| [NC-34](#NC-34) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-35](#NC-35) | Common functions should be refactored to a common base contract | 8 |
| [NC-36](#NC-36) | Names of `private`/`internal` functions should be prefixed with an underscore | 2 |
| [NC-37](#NC-37) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-38](#NC-38) |  `require()` / `revert()` statements should have descriptive reason strings | 1 |
| [NC-39](#NC-39) | Return values of `approve()` not checked | 6 |
| [NC-40](#NC-40) | Variables should be named in mixedCase style | 19 |
| [NC-41](#NC-41) | Event is missing `indexed` fields | 13 |
| [NC-42](#NC-42) | Functions not used internally could be marked external | 14 |
...
<a name="NC-33"></a> 
### [NC-33] Use of `override` is unnecessary
...
<a name="NC-35"></a> 
### [NC-35] Common functions should be refactored to a common base contract
...
<a name="NC-38"></a> 
### [NC-38]  `require()` / `revert()` statements should have descriptive reason strings
...
<a name="NC-39"></a> 
### [NC-39] Return values of `approve()` not checked
