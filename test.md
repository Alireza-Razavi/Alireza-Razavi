...
*Total <b>366</b> instances over <b>45</b> issues:*
...
| [NC-14](#NC-14) | Events should use parameters to convey information | 2 |
| [NC-15](#NC-15) |  Function ordering does not follow the Solidity Style Guide | 10 |
| [NC-16](#NC-16) | High cyclomatic complexity | 2 |
| [NC-17](#NC-17) | Large or complicated code bases should implement invariant tests | 1 |
| [NC-18](#NC-18) | Long functions should be refactored into multiple, smaller, functions | 2 |
| [NC-19](#NC-19) | Magic numbers should be replaced with constants | 19 |
| [NC-20](#NC-20) | Missing zero address check in functions with address parameters | 42 |
| [NC-21](#NC-21) | Named mappings are recommended | 11 |
| [NC-22](#NC-22) | NatSpec documentation for contract is missing | 6 |
| [NC-23](#NC-23) | Missing NatSpec `@param` | 6 |
| [NC-24](#NC-24) | NatSpec `@return` is missing | 4 |
| [NC-25](#NC-25) | There is no need to initialize variables with 0 | 13 |
| [NC-26](#NC-26) | Put all system-wide constants in one file | 12 |
| [NC-27](#NC-27) | Redundant `return` statement in a function with named return variables | 5 |
| [NC-28](#NC-28) | State variables should include comments | 1 |
| [NC-29](#NC-29) | Contract declarations should have NatSpec `@title` annotations | 6 |
| [NC-30](#NC-30) | Lines are too long | 6 |
| [NC-31](#NC-31) | Typos | 10 |
| [NC-32](#NC-32) | Unused errors | 1 |
| [NC-33](#NC-33) | Unused `event` definition | 3 |
| [NC-34](#NC-34) | Unused named return | 4 |
| [NC-35](#NC-35) | Consider using `delete` rather than assigning zero/false to clear values | 12 |
| [NC-36](#NC-36) | Solidity compiler version is not fixed | 1 |
| [NC-37](#NC-37) | Expressions for constant values should use `immutable` rather than `constant` | 12 |
| [NC-38](#NC-38) | Use the latest solidity version for deployment | 6 |
| [NC-39](#NC-39) | Whitespace in Expressions | 1 |
| [NC-40](#NC-40) | Missing checks for `address(0)` when assigning values to address state variables | 1 |
| [NC-41](#NC-41) | Names of `private`/`internal` functions should be prefixed with an underscore | 9 |
| [NC-42](#NC-42) | Names of `private`/`internal` state variables should be prefixed with an underscore | 12 |
| [NC-43](#NC-43) | Variables should be named in mixedCase style | 16 |
| [NC-44](#NC-44) | Event is missing `indexed` fields | 8 |
| [NC-45](#NC-45) | Constants should be defined rather than using magic numbers | 20 |
...
<a name="NC-14"></a> 
### [NC-14] Events should use parameters to convey information
...
<a name="NC-16"></a> 
### [NC-16] High cyclomatic complexity
...
<a name="NC-26"></a> 
### [NC-26] Put all system-wide constants in one file
...
<a name="NC-35"></a> 
### [NC-35] Consider using `delete` rather than assigning zero/false to clear values
...
<a name="NC-45"></a> 
### [NC-45] Constants should be defined rather than using magic numbers
