...
*Total <b>26</b> instances over <b>8</b> issues:*

|ID|Issue|Instances|
|-|:-|:-:|
| [L-1](#L-1) | Array is `push()`ed but not `pop()`ed | 1 |
| [L-2](#L-2) | Enum values should be used instead of constant array indexes | 4 |
| [L-3](#L-3) | Numbers downcast to `address`es may result in collisions | 2 |
| [L-4](#L-4) | Prevent re-setting a state variable with the same value | 2 |
| [L-5](#L-5) | Timestamp may be manipulation | 1 |
| [L-6](#L-6) | Unsafe downcast | 1 |
| [L-7](#L-7) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 2 |
| [L-8](#L-8) | Empty Function Body - Consider commenting why | 13 |
...
| [NC-37](#NC-37) | Error declarations should have NatSpec descriptions | 36 |
| [NC-38](#NC-38) | Event declarations should have NatSpec descriptions | 15 |
| [NC-39](#NC-39) | NatSpec documentation for function is missing | 13 |
| [NC-40](#NC-40) | Missing NatSpec `@param` | 14 |
| [NC-41](#NC-41) | NatSpec `@return` is missing | 4 |
| [NC-42](#NC-42) | Function declarations should have @notice tags | 20 |
| [NC-43](#NC-43) | There is no need to initialize variables with 0 | 2 |
| [NC-44](#NC-44) | Put all system-wide constants in one file | 37 |
| [NC-45](#NC-45) | Lines are too long | 7 |
| [NC-46](#NC-46) | Typos | 4 |
| [NC-47](#NC-47) | Unused `error` definition | 1 |
| [NC-48](#NC-48) | Unused `event` definition | 1 |
| [NC-49](#NC-49) | Unused named return | 2 |
| [NC-50](#NC-50) | Unused contract variables | 8 |
| [NC-51](#NC-51) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-52](#NC-52) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-53](#NC-53) | Use the latest solidity version for deployment | 16 |
| [NC-54](#NC-54) | Use of `override` is unnecessary | 10 |
| [NC-55](#NC-55) | Common functions should be refactored to a common base contract | 4 |
...
<a name="L-3"></a> 
### [L-3] Numbers downcast to `address`es may result in collisions
...
<a name="L-4"></a> 
### [L-4] Prevent re-setting a state variable with the same value
...
<a name="L-5"></a> 
### [L-5] Timestamp may be manipulation
...
<a name="L-8"></a> 
### [L-8] Empty Function Body - Consider commenting why
...
<a name="NC-53"></a> 
### [NC-53] Use the latest solidity version for deployment
...
<a name="NC-54"></a> 
### [NC-54] Use of `override` is unnecessary
...
<a name="NC-55"></a> 
### [NC-55] Common functions should be refactored to a common base contract
