...
*Total <b>210</b> instances over <b>44</b> issues:*
...
| [GAS-16](#GAS-16) | Optimize names to save gas | 5 | 110 |
| [GAS-17](#GAS-17) | Redundant state variable getters | 1 | - |
| [GAS-18](#GAS-18) | Remove or replace unused state variables | 3 | - |
| [GAS-19](#GAS-19) | The result of a function call should be cached rather than re-calling the function | 2 | 200 |
| [GAS-20](#GAS-20) | Unlimited gas consumption risk due to external call recipients | 2 | - |
| [GAS-21](#GAS-21) | Optimize External Calls with Assembly for Memory Efficiency | 5 | 1100 |
| [GAS-22](#GAS-22) | Use assembly to compute hashes to save gas | 15 | 1200 |
| [GAS-23](#GAS-23) | Use assembly to emit events | 19 | 722 |
| [GAS-24](#GAS-24) | Use assembly to write address/contract type storage values | 4 | 200 |
| [GAS-25](#GAS-25) | Using a double `if` statement instead of a logical AND (`&&`) | 3 | 90 |
| [GAS-26](#GAS-26) | Use local variables for emitting | 6 | 582 |
| [GAS-27](#GAS-27) | Use a more recent version of solidity | 6 | - |
| [GAS-28](#GAS-28) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 1 | 8550 |
| [GAS-29](#GAS-29) | Use `unchecked` block for safe subtractions | 1 | 85 |
| [GAS-30](#GAS-30) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-31](#GAS-31) | Using `constant`s directly, rather than caching the value, saves gas | 2 | - |
| [GAS-32](#GAS-32) | Using `this` to access functions results in an external call, wasting gas | 1 | 100 |
| [GAS-33](#GAS-33) | Use `selfbalance()` instead of `address(this).balance` | 1 | - |
| [GAS-34](#GAS-34) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-35](#GAS-35) | Cache array length outside of loop | 4 | - |
| [GAS-36](#GAS-36) | State variables should be cached in stack variables rather than re-reading them from storage | 3 | 291 |
| [GAS-37](#GAS-37) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 2 | - |
| [GAS-38](#GAS-38) | Don't initialize variables with default value | 6 | - |
| [GAS-39](#GAS-39) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 4 | 220 |
| [GAS-40](#GAS-40) | Constructors can be marked as `payable` to save deployment gas | 3 | 63 |
| [GAS-41](#GAS-41) | Functions guaranteed to revert when called by normal users can be marked `payable` | 20 | 420 |
| [GAS-42](#GAS-42) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-43](#GAS-43) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 3 | 12 |
| [GAS-44](#GAS-44) | Using assembly to check for zero can save gas | 23 | 138 |
<a name="M-1"></a> 
...
<a name="GAS-30"></a> 
### [GAS-30] Using bitmap to store bool states can save gas
...
<a name="GAS-31"></a> 
### [GAS-31] Using `constant`s directly, rather than caching the value, saves gas
...
<a name="GAS-32"></a> 
### [GAS-32] Using `this` to access functions results in an external call, wasting gas
...
<a name="GAS-33"></a> 
### [GAS-33] Use `selfbalance()` instead of `address(this).balance`
...
<a name="GAS-34"></a> 
### [GAS-34] Using bools for storage incurs overhead
...
<a name="GAS-35"></a> 
### [GAS-35] Cache array length outside of loop
...
<a name="GAS-36"></a> 
### [GAS-36] State variables should be cached in stack variables rather than re-reading them from storage
...
<a name="GAS-37"></a> 
### [GAS-37] Use `calldata` instead of `memory` for function arguments that do not get mutated
