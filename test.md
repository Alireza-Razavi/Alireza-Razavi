...
| [L-7](#L-7) | Functions calling contracts/addresses with transfer hooks are missing reentrancy guards | 5 |
| [L-8](#L-8) | Governance functions should be controlled by time locks | 3 |
| [L-9](#L-9) | Loss of precision in divisions | 5 |
| [L-10](#L-10) | Missing checks for state variable assignments | 8 |
| [L-11](#L-11) | Missing zero address check in constructor | 1 |
| [L-12](#L-12) | Consider some checks for `address(0)` when setting address state variables | 4 |
| [L-13](#L-13) | Owner can renounce Ownership | 1 |
| [L-14](#L-14) | `receive()`/`fallback()` function does not authorize requests | 1 |
| [L-15](#L-15) | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 5 |
| [L-16](#L-16) | Sending tokens in a for loop | 1 |
| [L-17](#L-17) | Tokens may be minted to `address(0)` | 2 |
| [L-18](#L-18) | Use Ownable2Step instead of Ownable | 1 |
| [L-19](#L-19) |  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()` | 9 |
| [L-20](#L-20) | Centralization Risk for trusted owners | 16 |
...
| [NC-8](#NC-8) | Constant decimal values | 1 |
| [NC-9](#NC-9) | Constants should be put on the left side of comparisons | 17 |
| [NC-10](#NC-10) | `Constructor` should emit an event | 4 |
| [NC-11](#NC-11) | Contract does not follow the Solidity Style Guide's suggested layout ordering | 22 |
...
| [NC-15](#NC-15) | Events that mark critical parameter changes should contain both the old and the new value | 5 |
| [NC-16](#NC-16) | Custom errors has no error details | 19 |
| [NC-17](#NC-17) | Enable IR-based code generation | 1 |
| [NC-18](#NC-18) | Events are emitted without the sender information | 2 |
| [NC-19](#NC-19) | Events may be emitted out of order due to reentrancy | 1 |
| [NC-20](#NC-20) | External call recipient can consume all remaining gas | 1 |
| [NC-21](#NC-21) |  Function ordering does not follow the Solidity Style Guide | 20 |
| [NC-22](#NC-22) | Functions with array parameters should have length checks in place | 3 |
| [NC-23](#NC-23) | High cyclomatic complexity | 1 |
| [NC-24](#NC-24) | Import declarations should import specific identifiers, rather than the whole file | 12 |
| [NC-25](#NC-25) | Imports could be organized more systematically | 1 |
| [NC-26](#NC-26) | Inconsistent spacing in comments | 2 |
| [NC-27](#NC-27) | Interfaces should have an `I` prefix in the contract name | 1 |
...
| [NC-30](#NC-30) | Large numeric literals should use underscores for readability | 1 |
| [NC-31](#NC-31) | Magic numbers should be replaced with constants | 5 |
| [NC-32](#NC-32) | Missing contract existence checks before low-level calls | 1 |
| [NC-33](#NC-33) | Named mappings are recommended | 14 |
| [NC-34](#NC-34) | Named imports of parent contracts are missing | 3 |
| [NC-35](#NC-35) | Missing NatSpec from contract declarations | 6 |
| [NC-36](#NC-36) | Missing NatSpec `@author` from contract declaration | 6 |
| [NC-37](#NC-37) | Missing NatSpec `@dev` from contract declaration | 6 |
| [NC-38](#NC-38) | Missing NatSpec `@dev` from event declaration | 5 |
| [NC-39](#NC-39) | Missing NatSpec `@dev` from function declaration | 53 |
| [NC-40](#NC-40) | Missing NatSpec `@dev` from modifier declaration | 3 |
| [NC-41](#NC-41) | Error declarations should have NatSpec descriptions | 19 |
| [NC-42](#NC-42) | Event declarations should have NatSpec descriptions | 5 |
| [NC-43](#NC-43) | NatSpec documentation for function is missing | 53 |
| [NC-44](#NC-44) | Modifier declarations should have NatSpec descriptions | 3 |
| [NC-45](#NC-45) | Public variable declarations should have NatSpec descriptions | 16 |
| [NC-46](#NC-46) | Missing NatSpec `@notice` from contract declaration | 6 |
| [NC-47](#NC-47) | Missing NatSpec `@notice` from event declaration | 5 |
| [NC-48](#NC-48) | Missing NatSpec `@notice` from function declaration | 53 |
| [NC-49](#NC-49) | Missing NatSpec `@notice` from modifier declaration | 3 |
| [NC-50](#NC-50) | Missing NatSpec `@param` from event declaration | 5 |
| [NC-51](#NC-51) | Missing NatSpec `@param` from function declaration | 50 |
| [NC-52](#NC-52) | Missing NatSpec `@param` from modifier declaration | 1 |
| [NC-53](#NC-53) | Missing NatSpec `@return` from function declaration | 13 |
| [NC-54](#NC-54) | Missing NatSpec `@title` from contract declaration | 6 |
| [NC-55](#NC-55) | There is no need to initialize variables with 0 | 6 |
| [NC-56](#NC-56) | Potential Re-org Attack Vector | 1 |
| [NC-57](#NC-57) | Put all system-wide constants in one file | 3 |
| [NC-58](#NC-58) | The remaining ETH may be locked in the contract after call | 1 |
| [NC-59](#NC-59) | Setters should prevent re-setting the same value | 4 |
| [NC-60](#NC-60) | State variables should include comments | 6 |
| [NC-61](#NC-61) | Unnecessary cast | 1 |
| [NC-62](#NC-62) | Unsafe solidity low-level call can cause gas grief attack | 1 |
| [NC-63](#NC-63) | Consider using `delete` rather than assigning zero/false to clear values | 2 |
| [NC-64](#NC-64) | Solidity compiler version is not fixed | 5 |
| [NC-65](#NC-65) | Expressions for constant values should use `immutable` rather than `constant` | 3 |
...
<a name="L-3"></a> 
### [L-3] Code injection via token name
...
<a name="L-16"></a> 
### [L-16] Sending tokens in a for loop
...
<a name="L-19"></a> 
### [L-19]  `abi.encodePacked()` should not be used with dynamic types when passing the result to a hash function such as `keccak256()`
...
<a name="NC-20"></a> 
### [NC-20] External call recipient can consume all remaining gas
There is no limit specified on the amount of gas used, so the recipient can use up all of the remaining gas (`gasleft()`), causing it to revert. Therefore, when calling an external contract, it is necessary to specify a limited amount of gas to forward.
...
<a name="NC-22"></a> 
### [NC-22] Functions with array parameters should have length checks in place
...
<a name="NC-23"></a> 
### [NC-23] High cyclomatic complexity
...
<a name="NC-24"></a> 
### [NC-24] Import declarations should import specific identifiers, rather than the whole file
...
<a name="NC-25"></a> 
### [NC-25] Imports could be organized more systematically
...
<a name="NC-31"></a> 
### [NC-31] Magic numbers should be replaced with constants
...
<a name="NC-32"></a> 
### [NC-32] Missing contract existence checks before low-level calls
...
<a name="NC-41"></a> 
### [NC-41] Error declarations should have NatSpec descriptions
...
<a name="NC-56"></a> 
### [NC-56] Potential Re-org Attack Vector
...
<a name="NC-58"></a> 
### [NC-58] The remaining ETH may be locked in the contract after call
...
<a name="NC-59"></a> 
### [NC-59] Setters should prevent re-setting the same value
...
<a name="NC-62"></a> 
### [NC-62] Unsafe solidity low-level call can cause gas grief attack
...
<a name="NC-63"></a> 
### [NC-63] Consider using `delete` rather than assigning zero/false to clear values
