...
*Total <b>217</b> instances over <b>32</b> issues:*
...
| [GAS-10](#GAS-10) | Optimize names to save gas | 13 | 286 |
...
| [GAS-22](#GAS-22) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-23](#GAS-23) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 14 | - |
| [GAS-24](#GAS-24) | Use Custom Errors | 4 | 200 |
| [GAS-25](#GAS-25) | Don't initialize variables with default value | 2 | - |
| [GAS-26](#GAS-26) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 17 | 935 |
| [GAS-27](#GAS-27) | Constructors can be marked as `payable` to save deployment gas | 13 | 273 |
| [GAS-28](#GAS-28) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-29](#GAS-29) | Using `private` rather than `public` for constants, saves gas | 4 | - |
| [GAS-30](#GAS-30) | Splitting require() statements that use && saves gas | 1 | - |
| [GAS-31](#GAS-31) | Using assembly to check for zero can save gas | 24 | 144 |
| [GAS-32](#GAS-32) | `internal` functions not called by the contract should be removed | 10 | - |
...
<a name="GAS-30"></a> 
### [GAS-30] Splitting require() statements that use && saves gas
