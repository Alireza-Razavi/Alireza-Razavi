...
*Total <b>493</b> instances over <b>60</b> issues:*
...
| [NC-52](#NC-52) | Unused contract variables | 8 |
| [NC-53](#NC-53) | Expressions for constant values should use `immutable` rather than `constant` | 37 |
| [NC-54](#NC-54) | Use `@inheritdoc` for overridden functions | 6 |
| [NC-55](#NC-55) | Use the latest solidity version for deployment | 16 |
| [NC-56](#NC-56) | Use of `override` is unnecessary | 10 |
| [NC-57](#NC-57) | Common functions should be refactored to a common base contract | 4 |
| [NC-58](#NC-58) | Names of `private`/`internal` state variables should be prefixed with an underscore | 5 |
| [NC-59](#NC-59) | Event is missing `indexed` fields | 4 |
| [NC-60](#NC-60) | Functions not used internally could be marked `external` | 4 |

## Gas Optimizations


*Total <b>217</b> instances over <b>33</b> issues:*
...
| [GAS-10](#GAS-10) | Optimize names to save gas | 12 | 264 |
| [GAS-11](#GAS-11) | Remove or replace unused state variables | 8 | - |
| [GAS-12](#GAS-12) | The result of a function call should be cached rather than re-calling the function | 5 | 500 |
| [GAS-13](#GAS-13) | Unused named return variables without optimizer waste gas | 2 | 18 |
| [GAS-14](#GAS-14) | Use assembly to compute hashes to save gas | 12 | 960 |
| [GAS-15](#GAS-15) | Use assembly to emit events | 14 | 532 |
| [GAS-16](#GAS-16) | Use assembly to write address/contract type storage values | 7 | 350 |
| [GAS-17](#GAS-17) | Using a double `if` statement instead of a logical AND (`&&`) | 7 | 210 |
| [GAS-18](#GAS-18) | Use local variables for emitting | 3 | 291 |
| [GAS-19](#GAS-19) | Use a more recent version of solidity | 16 | - |
...
| [GAS-22](#GAS-22) | Using `constant`s directly, rather than caching the value, saves gas | 1 | - |
| [GAS-23](#GAS-23) | Using bools for storage incurs overhead | 1 | 100 |
| [GAS-24](#GAS-24) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 14 | - |
| [GAS-25](#GAS-25) | Use Custom Errors | 4 | 200 |
| [GAS-26](#GAS-26) | Don't initialize variables with default value | 2 | - |
| [GAS-27](#GAS-27) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 17 | 935 |
| [GAS-28](#GAS-28) | Constructors can be marked as `payable` to save deployment gas | 13 | 273 |
| [GAS-29](#GAS-29) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 2 | 10 |
| [GAS-30](#GAS-30) | Using `private` rather than `public` for constants, saves gas | 4 | - |
| [GAS-31](#GAS-31) | Splitting require() statements that use && saves gas | 1 | - |
| [GAS-32](#GAS-32) | Using assembly to check for zero can save gas | 24 | 144 |
| [GAS-33](#GAS-33) | `internal` functions not called by the contract should be removed | 10 | - |
...
<a name="NC-57"></a> 
### [NC-57] Common functions should be refactored to a common base contract
...
<a name="NC-58"></a> 
### [NC-58] Names of `private`/`internal` state variables should be prefixed with an underscore
...
<a name="NC-60"></a> 
### [NC-60] Functions not used internally could be marked `external`
...
/// @audit `isValidSignature`, `getMessageHash`, `getMessageHashForSafe`, `isValidSignature`, `getModules`, `simulate`
20: contract ConsoleFallbackHandler is AddressProviderService, DefaultCallbackHandler, ISignatureValidator {
...
/// @audit `checkTransaction`, `checkAfterExecution`, `checkModuleTransaction`
16: contract SafeModerator is AddressProviderService, IGuard {
...
```
*Github:* [[55](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L55), [66](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/AddressProvider.sol#L66)]
...
<a name="GAS-22"></a> 
### [GAS-22] Using `constant`s directly, rather than caching the value, saves gas
...
```
*Github:* [[69](https://github.com/code-423n4/2023-10-brahma/blob/c217699448ffd7ec0253472bf0d156e52d45ca71/contracts/src/core/SafeEnabler.sol#L69)]
...
<a name="GAS-31"></a> 
### [GAS-31] Splitting require() statements that use && saves gas
