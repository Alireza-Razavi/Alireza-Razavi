...
### <a name="GAS-1"></a>
<details>
<summary>[GAS-1] Use calldata instead of memory for function arguments that do not get mutated</summary>
...
### <a name="GAS-2"></a>
<details>
<summary>[GAS-2] For Operations that will not overflow, you could use unchecked</summary>
...
### <a name="GAS-3"></a>
<details>
<summary>[GAS-3] Use Custom Errors</summary>
...
### <a name="GAS-4"></a>
<details>
<summary>[GAS-4] Don't use `SafeMath` once the solidity version is 0.8.0 or greater</summary>
...
### <a name="GAS-5"></a>
<details>
<summary>[GAS-5] Long revert strings</summary>
...
### <a name="GAS-6"></a>
<details>
<summary>[GAS-6] Functions guaranteed to revert when called by normal users can be marked `payable`</summary>
...
### <a name="GAS-7"></a>
<details>
<summary>[GAS-7] Use != 0 instead of > 0 for unsigned integer comparison</summary>
...
### <a name="GAS-8"></a>
<details>
<summary>[GAS-8] Using assembly to check for zero can save gas</summary>
...
### <a name="GAS-9"></a>
<details>
<summary>[GAS-9] `internal` functions not called by the contract should be removed</summary>
...
### <a name="NC-1"></a>
<details>
<summary>[NC-1] Event is missing `indexed` fields</summary>
...
### <a name="NC-2"></a>
<details>
<summary>[NC-2] Functions not used internally could be marked external</summary>
...
### <a name="L-1"></a>
<details>
<summary>[L-1] Empty Function Body - Consider commenting why</summary>
...
### <a name="L-2"></a>
<details>
<summary>[L-2] Initializers could be front-run</summary>
...
### <a name="L-3"></a>
<details>
<summary>[L-3] Unsafe ERC20 operation(s)</summary>
...
### <a name="M-1"></a>
<details>
<summary>[M-1] Centralization Risk for trusted owners</summary>
