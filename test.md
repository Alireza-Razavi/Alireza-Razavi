...
*Total <b>589</b> instances over <b>44</b> issues:*
...
| [GAS-18](#GAS-18) | Structs can be packed into fewer storage slots | 3 | 60000 |
| [GAS-19](#GAS-19) | Unlimited gas consumption risk due to external call recipients | 6 | - |
| [GAS-20](#GAS-20) | Optimize External Calls with Assembly for Memory Efficiency | 8 | 1760 |
| [GAS-21](#GAS-21) | Use assembly to compute hashes to save gas | 8 | 640 |
| [GAS-22](#GAS-22) | Use assembly to emit events | 12 | 456 |
| [GAS-23](#GAS-23) | Use assembly to validate `msg.sender` | 15 | - |
| [GAS-24](#GAS-24) | Use assembly to write address/contract type storage values | 14 | 700 |
| [GAS-25](#GAS-25) | Using a double `if` statement instead of a logical AND (`&&`) | 28 | 840 |
| [GAS-26](#GAS-26) | Use a more recent version of solidity | 8 | - |
| [GAS-27](#GAS-27) | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 13 | 111150 |
| [GAS-28](#GAS-28) | Using bitmap to store bool states can save gas | 1 | - |
| [GAS-29](#GAS-29) | Using `this` to access functions results in an external call, wasting gas | 2 | 200 |
| [GAS-30](#GAS-30) | Use `selfbalance()` instead of `address(this).balance` | 2 | - |
| [GAS-31](#GAS-31) | `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants) | 8 | - |
| [GAS-32](#GAS-32) | Using bools for storage incurs overhead | 13 | 1300 |
| [GAS-33](#GAS-33) | Cache array length outside of loop | 9 | - |
| [GAS-34](#GAS-34) | State variables should be cached in stack variables rather than re-reading them from storage | 31 | 3007 |
| [GAS-35](#GAS-35) | Use `calldata` instead of `memory` for function arguments that do not get mutated | 33 | - |
| [GAS-36](#GAS-36) | Use Custom Errors | 68 | 3400 |
| [GAS-37](#GAS-37) | Don't initialize variables with default value | 11 | - |
| [GAS-38](#GAS-38) | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 13 | 715 |
| [GAS-39](#GAS-39) | Constructors can be marked as `payable` to save deployment gas | 7 | 147 |
| [GAS-40](#GAS-40) | Functions guaranteed to revert when called by normal users can be marked `payable` | 1 | 21 |
| [GAS-41](#GAS-41) | `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too) | 9 | 45 |
| [GAS-42](#GAS-42) | Splitting require() statements that use && saves gas | 10 | - |
| [GAS-43](#GAS-43) | Use `!= 0` instead of `> 0` for unsigned integer comparison | 6 | 24 |
| [GAS-44](#GAS-44) | Using assembly to check for zero can save gas | 5 | 30 |
...
<a name="GAS-18"></a> 
### [GAS-18] Structs can be packed into fewer storage slots
...
<a name="GAS-19"></a> 
### [GAS-19] Unlimited gas consumption risk due to external call recipients
...
<a name="GAS-20"></a> 
### [GAS-20] Optimize External Calls with Assembly for Memory Efficiency
...
<a name="GAS-21"></a> 
### [GAS-21] Use assembly to compute hashes to save gas
...
<a name="GAS-22"></a> 
### [GAS-22] Use assembly to emit events
...
<a name="GAS-24"></a> 
### [GAS-24] Use assembly to write address/contract type storage values
...
<a name="GAS-26"></a> 
### [GAS-26] Use a more recent version of solidity
...
<a name="GAS-27"></a> 
### [GAS-27] Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes
...
<a name="GAS-28"></a> 
### [GAS-28] Using bitmap to store bool states can save gas
...
<a name="GAS-31"></a> 
### [GAS-31] `array[index] += amount` is cheaper than `array[index] = array[index] + amount` (or related variants)
...
<a name="GAS-32"></a> 
### [GAS-32] Using bools for storage incurs overhead
...
<a name="GAS-33"></a> 
### [GAS-33] Cache array length outside of loop
...
<a name="GAS-34"></a> 
### [GAS-34] State variables should be cached in stack variables rather than re-reading them from storage
...
<a name="GAS-35"></a> 
### [GAS-35] Use `calldata` instead of `memory` for function arguments that do not get mutated
...
<a name="GAS-41"></a> 
### [GAS-41] `++i` costs less gas than `i++`, especially when it's used in `for`-loops (`--i`/`i--` too)
...
<a name="GAS-43"></a> 
### [GAS-43] Use `!= 0` instead of `> 0` for unsigned integer comparison
...
<a name="GAS-44"></a> 
### [GAS-44] Using assembly to check for zero can save gas
